...
internal data class SubstanceSurrogate(
  ...
  public fun toModel(): Substance =
    Substance(
      ...
      implicitRules =
        Uri.ofNullable(
          this@SubstanceSurrogate.implicitRules,
          this@SubstanceSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@SubstanceSurrogate.language, this@SubstanceSurrogate._language),
      ...
      status =
        this@SubstanceSurrogate.status?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.Substance.FHIRSubstanceStatus.fromCode(it!!),
      ...
      description =
        R4bString.ofNullable(
          this@SubstanceSurrogate.description,
          this@SubstanceSurrogate._description,
        ),
