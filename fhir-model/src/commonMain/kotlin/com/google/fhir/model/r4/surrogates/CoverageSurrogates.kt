...
internal data class CoverageClassSurrogate(
  ...
  public fun toModel(): Coverage.Class =
    Coverage.Class(
      ...
      name =
        R4String.ofNullable(this@CoverageClassSurrogate.name, this@CoverageClassSurrogate._name),
    )
...
internal data class CoverageSurrogate(
  ...
  public fun toModel(): Coverage =
    Coverage(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Coverage.CoverageStatus.fromCode(
      ...
      subscriberId =
        R4String.ofNullable(
          this@CoverageSurrogate.subscriberId,
          this@CoverageSurrogate._subscriberId,
        ),
      beneficiary = this@CoverageSurrogate.beneficiary,
      dependent =
        R4String.ofNullable(this@CoverageSurrogate.dependent, this@CoverageSurrogate._dependent),
      ...
      network =
        R4String.ofNullable(this@CoverageSurrogate.network, this@CoverageSurrogate._network),
    ...
    public fun fromModel(model: Coverage): CoverageSurrogate =
      with(model) {
        CoverageSurrogate(
          ...
          period = this@with.period,
          payor = this@with.payor.takeUnless { it.isEmpty() },
