...
import com.google.fhir.model.r4b.surrogates.RegulatedAuthorizationCaseSurrogate
import com.google.fhir.model.r4b.surrogates.RegulatedAuthorizationSurrogate
...
public object RegulatedAuthorizationCaseSerializer : KSerializer<RegulatedAuthorization.Case> {
  ...
  override fun serialize(encoder: Encoder, `value`: RegulatedAuthorization.Case) {
    surrogateSerializer.serialize(encoder, RegulatedAuthorizationCaseSurrogate.fromModel(value))
  }
}
