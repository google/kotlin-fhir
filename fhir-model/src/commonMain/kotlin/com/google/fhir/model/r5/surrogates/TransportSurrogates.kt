    ...
    Transport.Input(
      ...
      `value` =
        Transport.Input.Value.from(
          ...
          Code.of(
            this@TransportInputSurrogate.valueCode!!,
            this@TransportInputSurrogate._valueCode,
          ),
          Date.of(
          ...
          Time.of(
            this@TransportInputSurrogate.valueTime!!,
            this@TransportInputSurrogate._valueTime,
          ),
          UnsignedInt.of(
          ...
          Uuid.of(
            this@TransportInputSurrogate.valueUuid!!,
            this@TransportInputSurrogate._valueUuid,
          ),
...
internal data class TransportSurrogate(
  ...
  public fun toModel(): Transport =
    Transport(
      ...
      implicitRules =
        Uri.ofNullable(
          this@TransportSurrogate.implicitRules,
          this@TransportSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@TransportSurrogate.language, this@TransportSurrogate._language),
      ...
      instantiatesUri =
        Uri.ofNullable(
          this@TransportSurrogate.instantiatesUri,
          this@TransportSurrogate._instantiatesUri,
        ),
      ...
      description =
        R5String.ofNullable(
          this@TransportSurrogate.description,
          this@TransportSurrogate._description,
        ),
