...
internal data class ConceptMapPropertySurrogate(
  ...
  public fun toModel(): ConceptMap.Property =
    ConceptMap.Property(
      ...
      uri =
        Uri.ofNullable(this@ConceptMapPropertySurrogate.uri, this@ConceptMapPropertySurrogate._uri),
      description =
        R5String.ofNullable(
...
internal data class ConceptMapGroupElementTargetDependsOnSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var attribute: KotlinString?,
  ...
  public fun toModel(): ConceptMap.Group.Element.Target.DependsOn =
    ConceptMap.Group.Element.Target.DependsOn(
      ...
      `value` =
        ConceptMap.Group.Element.Target.DependsOn.Value?.fromNullable(
          Code.ofNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ConceptMapGroupElementTargetSurrogate(
          ...
          dependsOn = this@with.dependsOn.takeUnless { it.isEmpty() },
          product = this@with.product.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ConceptMapGroupSurrogate(
  ...
  public fun toModel(): ConceptMap.Group =
    ConceptMap.Group(
      ...
      source =
        Canonical.ofNullable(
          this@ConceptMapGroupSurrogate.source,
          this@ConceptMapGroupSurrogate._source,
        ),
      target =
        Canonical.ofNullable(
          this@ConceptMapGroupSurrogate.target,
          this@ConceptMapGroupSurrogate._target,
        ),
    ...
    public fun fromModel(model: ConceptMap.Group): ConceptMapGroupSurrogate =
      with(model) {
        ConceptMapGroupSurrogate(
          ...
          element = this@with.element.takeUnless { it.isEmpty() },
...
internal data class ConceptMapSurrogate(
  ...
  public fun toModel(): ConceptMap =
    ConceptMap(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ConceptMapSurrogate.implicitRules,
          this@ConceptMapSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ConceptMapSurrogate.language, this@ConceptMapSurrogate._language),
      ...
      url = Uri.ofNullable(this@ConceptMapSurrogate.url, this@ConceptMapSurrogate._url),
      identifier = this@ConceptMapSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@ConceptMapSurrogate.version, this@ConceptMapSurrogate._version),
      versionAlgorithm =
        ConceptMap.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@ConceptMapSurrogate.name, this@ConceptMapSurrogate._name),
      title = R5String.ofNullable(this@ConceptMapSurrogate.title, this@ConceptMapSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R5String.ofNullable(
          this@ConceptMapSurrogate.publisher,
          this@ConceptMapSurrogate._publisher,
        ),
      contact = this@ConceptMapSurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(
          this@ConceptMapSurrogate.description,
          this@ConceptMapSurrogate._description,
        ),
      ...
      purpose =
        Markdown.ofNullable(this@ConceptMapSurrogate.purpose, this@ConceptMapSurrogate._purpose),
      copyright =
        Markdown.ofNullable(
          this@ConceptMapSurrogate.copyright,
          this@ConceptMapSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
      ...
      sourceScope =
        ConceptMap.SourceScope?.fromNullable(
          Uri.ofNullable(
            this@ConceptMapSurrogate.sourceScopeUri,
            this@ConceptMapSurrogate._sourceScopeUri,
          ),
          Canonical.ofNullable(
      ...
      targetScope =
        ConceptMap.TargetScope?.fromNullable(
          Uri.ofNullable(
            this@ConceptMapSurrogate.targetScopeUri,
            this@ConceptMapSurrogate._targetScopeUri,
          ),
          Canonical.ofNullable(
    ...
    public fun fromModel(model: ConceptMap): ConceptMapSurrogate =
      with(model) {
        ConceptMapSurrogate(
          ...
          `property` = this@with.`property`.takeUnless { it.isEmpty() },
          additionalAttribute = this@with.additionalAttribute.takeUnless { it.isEmpty() },
