...
internal data class ListEntrySurrogate(
  ...
  public fun toModel(): List.Entry =
    List.Entry(
      ...
      deleted =
        R5Boolean.ofNullable(this@ListEntrySurrogate.deleted, this@ListEntrySurrogate._deleted),
      date =
        DateTime.ofNullable(
...
internal data class ListSurrogate(
  ...
  public fun toModel(): List =
    List(
      ...
      title = R5String.ofNullable(this@ListSurrogate.title, this@ListSurrogate._title),
