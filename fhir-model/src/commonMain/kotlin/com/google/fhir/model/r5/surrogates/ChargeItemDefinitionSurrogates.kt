    ...
    public fun fromModel(
      ...
      with(model) {
        ChargeItemDefinitionPropertyGroupSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          applicability = this@with.applicability.takeUnless { it.isEmpty() },
...
internal data class ChargeItemDefinitionSurrogate(
  ...
  public fun toModel(): ChargeItemDefinition =
    ChargeItemDefinition(
      ...
      url =
        Uri.ofNullable(
          this@ChargeItemDefinitionSurrogate.url,
          this@ChargeItemDefinitionSurrogate._url,
        ),
      ...
      versionAlgorithm =
        ChargeItemDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
        ...
        ChargeItemDefinitionSurrogate(
          ...
          _derivedFromUri =
            this@with.derivedFromUri
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          partOf = this@with.partOf.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _partOf =
            this@with.partOf
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
          ...
          applicability = this@with.applicability.takeUnless { it.isEmpty() },
          propertyGroup = this@with.propertyGroup.takeUnless { it.isEmpty() },
        )
      }
  }
}
