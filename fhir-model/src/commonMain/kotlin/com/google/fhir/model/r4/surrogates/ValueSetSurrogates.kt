...
internal data class ValueSetSurrogate(
  ...
  public fun toModel(): ValueSet =
    ValueSet(
      ...
      version =
        R4String.ofNullable(this@ValueSetSurrogate.version, this@ValueSetSurrogate._version),
      name = R4String.ofNullable(this@ValueSetSurrogate.name, this@ValueSetSurrogate._name),
      title = R4String.ofNullable(this@ValueSetSurrogate.title, this@ValueSetSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R4String.ofNullable(this@ValueSetSurrogate.publisher, this@ValueSetSurrogate._publisher),
      ...
      immutable =
        R4Boolean.ofNullable(this@ValueSetSurrogate.immutable, this@ValueSetSurrogate._immutable),
      purpose =
