...
internal data class AdministrableProductDefinitionPropertySurrogate(
  ...
  public fun toModel(): AdministrableProductDefinition.Property =
    AdministrableProductDefinition.Property(
      ...
      `value` =
        AdministrableProductDefinition.Property.Value?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          code = this@with.code,
          withdrawalPeriod = this@with.withdrawalPeriod.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        AdministrableProductDefinitionRouteOfAdministrationSurrogate(
          ...
          targetSpecies = this@with.targetSpecies.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        AdministrableProductDefinitionSurrogate(
          ...
          formOf = this@with.formOf.takeUnless { it.isEmpty() },
          administrableDoseForm = this@with.administrableDoseForm,
          unitOfPresentation = this@with.unitOfPresentation,
          producedFrom = this@with.producedFrom.takeUnless { it.isEmpty() },
          ...
          routeOfAdministration = this@with.routeOfAdministration.takeUnless { it.isEmpty() },
        )
      }
  }
}
