...
public data class Timing(
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Timing.Repeat.Bounds"
          )
        }
  ...
  public enum class EventTiming(
    ...
    /**
     * Event occurs a single time (with no repetitions) as soon as possible after the scheduled or
     * actual start of the overall event.
     */
    Imd(
      "IMD",
      "http://hl7.org/fhir/event-timing",
