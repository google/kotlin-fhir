...
internal data class ClaimInsuranceSurrogate(
  ...
  public fun toModel(): Claim.Insurance =
    Claim.Insurance().apply {
      ...
      focal = R4Boolean.of(this@ClaimInsuranceSurrogate.focal, this@ClaimInsuranceSurrogate._focal)
...
internal data class ClaimSurrogate(
  ...
  public fun toModel(): Claim =
    Claim().apply {
      ...
      status =
        Enumeration.of(
          this@ClaimSurrogate.status?.let {
            com.google.fhir.model.r4.Claim.ClaimStatus.fromCode(it)
          },
      ...
      use =
        Enumeration.of(
          this@ClaimSurrogate.use?.let { com.google.fhir.model.r4.Claim.Use.fromCode(it) },
