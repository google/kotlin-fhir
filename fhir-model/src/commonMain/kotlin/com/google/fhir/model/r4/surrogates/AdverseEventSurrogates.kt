    ...
    public fun fromModel(model: AdverseEvent.SuspectEntity): AdverseEventSuspectEntitySurrogate =
      with(model) {
        AdverseEventSuspectEntitySurrogate(
          ...
          causality = this@with.causality.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class AdverseEventSurrogate(
  ...
  public var actuality: KotlinString?,
  ...
  public fun toModel(): AdverseEvent =
    AdverseEvent(
      ...
      actuality =
        Enumeration.of(
          com.google.fhir.model.r4.AdverseEvent.AdverseEventActuality.fromCode(
    ...
    public fun fromModel(model: AdverseEvent): AdverseEventSurrogate =
      with(model) {
        AdverseEventSurrogate(
          ...
          resultingCondition = this@with.resultingCondition.takeUnless { it.isEmpty() },
          ...
          subjectMedicalHistory = this@with.subjectMedicalHistory.takeUnless { it.isEmpty() },
          referenceDocument = this@with.referenceDocument.takeUnless { it.isEmpty() },
