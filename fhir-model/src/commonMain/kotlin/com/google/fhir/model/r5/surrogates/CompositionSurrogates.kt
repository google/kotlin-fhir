    ...
    public fun fromModel(model: Composition.Section): CompositionSectionSurrogate =
      with(model) {
        CompositionSectionSurrogate(
          ...
          section = this@with.section.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class CompositionSurrogate(
  ...
  public fun toModel(): Composition =
    Composition(
      ...
      implicitRules =
        Uri.ofNullable(
          this@CompositionSurrogate.implicitRules,
          this@CompositionSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@CompositionSurrogate.language, this@CompositionSurrogate._language),
      ...
      url = Uri.ofNullable(this@CompositionSurrogate.url, this@CompositionSurrogate._url),
      identifier = this@CompositionSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@CompositionSurrogate.version, this@CompositionSurrogate._version),
      status =
        Enumeration.of(
      ...
      name = R5String.ofNullable(this@CompositionSurrogate.name, this@CompositionSurrogate._name),
    ...
    public fun fromModel(model: Composition): CompositionSurrogate =
      with(model) {
        CompositionSurrogate(
          ...
          attester = this@with.attester.takeUnless { it.isEmpty() },
