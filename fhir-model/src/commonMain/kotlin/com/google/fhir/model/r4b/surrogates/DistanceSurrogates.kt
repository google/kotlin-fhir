...
internal data class DistanceSurrogate(
  ...
  public fun toModel(): Distance =
    Distance(
      ...
      `value` = Decimal.ofNullable(this@DistanceSurrogate.`value`, this@DistanceSurrogate._value),
      comparator =
      ...
      unit = R4bString.ofNullable(this@DistanceSurrogate.unit, this@DistanceSurrogate._unit),
      system = Uri.ofNullable(this@DistanceSurrogate.system, this@DistanceSurrogate._system),
      code = Code.ofNullable(this@DistanceSurrogate.code, this@DistanceSurrogate._code),
    )
