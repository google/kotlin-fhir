        ...
        public companion object {
          public fun from(
            ...
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.ServiceRequest.OrderDetail.Parameter.Value"
            )
          }
    ...
    public sealed interface Instruction {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.ServiceRequest.PatientInstruction.Instruction"
          )
        }
  ...
  public sealed interface Quantity {
    ...
    public companion object {
      public fun from(
        ...
        if (RangeValue != null) return Range(RangeValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ServiceRequest.Quantity"
        )
      }
  ...
  public sealed interface Occurrence {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ServiceRequest.Occurrence"
        )
      }
  ...
  public sealed interface AsNeeded {
    ...
    public companion object {
      public fun from(
        ...
        if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ServiceRequest.AsNeeded"
        )
      }
