...
internal data class MeasureSurrogate(
  ...
  public fun toModel(): Measure =
    Measure(
      ...
      version = R4String.ofNullable(this@MeasureSurrogate.version, this@MeasureSurrogate._version),
      name = R4String.ofNullable(this@MeasureSurrogate.name, this@MeasureSurrogate._name),
      title = R4String.ofNullable(this@MeasureSurrogate.title, this@MeasureSurrogate._title),
      subtitle =
        R4String.ofNullable(this@MeasureSurrogate.subtitle, this@MeasureSurrogate._subtitle),
      status =
        Enumeration.of(
          com.google.fhir.model.r4.PublicationStatus.fromCode(this@MeasureSurrogate.status!!),
      ...
      publisher =
        R4String.ofNullable(this@MeasureSurrogate.publisher, this@MeasureSurrogate._publisher),
      ...
      usage = R4String.ofNullable(this@MeasureSurrogate.usage, this@MeasureSurrogate._usage),
      copyright =
    ...
    public fun fromModel(model: Measure): MeasureSurrogate =
      with(model) {
        MeasureSurrogate(
          ...
          definition =
            this@with.definition.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _definition =
