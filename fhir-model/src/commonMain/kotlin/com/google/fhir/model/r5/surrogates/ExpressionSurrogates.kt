...
internal data class ExpressionSurrogate(
  ...
  public fun toModel(): Expression =
    Expression(
      ...
      name = Code.ofNullable(this@ExpressionSurrogate.name, this@ExpressionSurrogate._name),
      language =
        Code.ofNullable(this@ExpressionSurrogate.language, this@ExpressionSurrogate._language),
      expression =
        R5String.ofNullable(
