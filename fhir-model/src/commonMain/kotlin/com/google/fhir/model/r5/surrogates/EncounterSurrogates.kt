    ...
    public fun fromModel(model: Encounter.Reason): EncounterReasonSurrogate =
      with(model) {
        EncounterReasonSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          use = this@with.use.takeUnless { it.isEmpty() },
          `value` = this@with.`value`.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class EncounterSurrogate(
  ...
  public fun toModel(): Encounter =
    Encounter(
      ...
      implicitRules =
        Uri.ofNullable(
          this@EncounterSurrogate.implicitRules,
          this@EncounterSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@EncounterSurrogate.language, this@EncounterSurrogate._language),
    ...
    public fun fromModel(model: Encounter): EncounterSurrogate =
      with(model) {
        EncounterSurrogate(
          ...
          episodeOfCare = this@with.episodeOfCare.takeUnless { it.isEmpty() },
          ...
          appointment = this@with.appointment.takeUnless { it.isEmpty() },
          ...
          dietPreference = this@with.dietPreference.takeUnless { it.isEmpty() },
          specialArrangement = this@with.specialArrangement.takeUnless { it.isEmpty() },
          specialCourtesy = this@with.specialCourtesy.takeUnless { it.isEmpty() },
