...
internal data class CarePlanActivityDetailSurrogate(
  ...
  public fun toModel(): CarePlan.Activity.Detail =
    CarePlan.Activity.Detail(
      ...
      scheduled =
        CarePlan.Activity.Detail.Scheduled?.fromNullable(
      ...
      product =
        CarePlan.Activity.Detail.Product?.fromNullable(
    ...
    public fun fromModel(model: CarePlan.Activity): CarePlanActivitySurrogate =
      with(model) {
        CarePlanActivitySurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          outcomeCodeableConcept = this@with.outcomeCodeableConcept.takeUnless { it.isEmpty() },
          outcomeReference = this@with.outcomeReference.takeUnless { it.isEmpty() },
          progress = this@with.progress.takeUnless { it.isEmpty() },
...
internal data class CarePlanSurrogate(
  ...
  public fun toModel(): CarePlan =
    CarePlan(
      ...
      implicitRules =
        Uri.ofNullable(this@CarePlanSurrogate.implicitRules, this@CarePlanSurrogate._implicitRules),
      language = Code.ofNullable(this@CarePlanSurrogate.language, this@CarePlanSurrogate._language),
      ...
      title = R4bString.ofNullable(this@CarePlanSurrogate.title, this@CarePlanSurrogate._title),
      description =
        R4bString.ofNullable(
          this@CarePlanSurrogate.description,
          this@CarePlanSurrogate._description,
        ),
    ...
    public fun fromModel(model: CarePlan): CarePlanSurrogate =
      with(model) {
        CarePlanSurrogate(
          ...
          contributor = this@with.contributor.takeUnless { it.isEmpty() },
          ...
          goal = this@with.goal.takeUnless { it.isEmpty() },
          activity = this@with.activity.takeUnless { it.isEmpty() },
