 ...
 * activity.
 */
public enum class FamilyMemberHistoryParticipantFunction(
  ...
  public companion object {
    public fun fromCode(code: String): FamilyMemberHistoryParticipantFunction =
      when (code) {
        "enterer" -> Enterer
        "performer" -> Performer
        "author" -> Author
        ...
        "humanuser" -> Humanuser
          ...
          throw IllegalArgumentException(
            "Unknown code $code for enum FamilyMemberHistoryParticipantFunction"
          )
      }
  }
}
