...
internal data class NutritionIntakeSurrogate(
  ...
  public fun toModel(): NutritionIntake =
    NutritionIntake(
      ...
      language =
        Code.ofNullable(
          this@NutritionIntakeSurrogate.language,
          this@NutritionIntakeSurrogate._language,
        ),
      ...
      occurrence =
        NutritionIntake.Occurrence?.fromNullable(
          DateTime.ofNullable(
      ...
      reported =
        NutritionIntake.Reported?.fromNullable(
          R5Boolean.ofNullable(
    ...
    public fun fromModel(model: NutritionIntake): NutritionIntakeSurrogate =
      with(model) {
        NutritionIntakeSurrogate(
          ...
          consumedItem = this@with.consumedItem.takeUnless { it.isEmpty() },
          ingredientLabel = this@with.ingredientLabel.takeUnless { it.isEmpty() },
