    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsSurrogate(
          ...
          `value` =
            this@with.`value`.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _value =
            this@with.`value`
              .map { it.toElement() }
...
internal data class MedicationKnowledgeAdministrationGuidelinesSurrogate(
  ...
  public fun toModel(): MedicationKnowledge.AdministrationGuidelines =
    MedicationKnowledge.AdministrationGuidelines(
      ...
      indication =
        MedicationKnowledge.AdministrationGuidelines.Indication?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeAdministrationGuidelinesSurrogate(
          ...
          patientCharacteristics = this@with.patientCharacteristics.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class MedicationKnowledgeDrugCharacteristicSurrogate(
  ...
  public fun toModel(): MedicationKnowledge.DrugCharacteristic =
    MedicationKnowledge.DrugCharacteristic(
      ...
      `value` =
        MedicationKnowledge.DrugCharacteristic.Value?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeKineticsSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          areaUnderCurve = this@with.areaUnderCurve.takeUnless { it.isEmpty() },
          lethalDose50 = this@with.lethalDose50.takeUnless { it.isEmpty() },
    ...
    MedicationKnowledge(
      ...
      status =
        this@MedicationKnowledgeSurrogate.status?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.MedicationKnowledge.MedicationKnowledgeStatus.fromCode(it!!),
    ...
    public fun fromModel(model: MedicationKnowledge): MedicationKnowledgeSurrogate =
      with(model) {
        MedicationKnowledgeSurrogate(
          ...
          synonym =
            this@with.synonym.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _synonym =
            this@with.synonym
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
          ...
          administrationGuidelines = this@with.administrationGuidelines.takeUnless { it.isEmpty() },
          ...
          contraindication = this@with.contraindication.takeUnless { it.isEmpty() },
          regulatory = this@with.regulatory.takeUnless { it.isEmpty() },
          kinetics = this@with.kinetics.takeUnless { it.isEmpty() },
        )
      }
  }
}
