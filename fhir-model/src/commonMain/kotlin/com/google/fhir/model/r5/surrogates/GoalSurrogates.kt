...
internal data class GoalTargetSurrogate(
  ...
  public fun toModel(): Goal.Target =
    Goal.Target(
      ...
      detail =
        Goal.Target.Detail?.fromNullable(
...
internal data class GoalSurrogate(
  ...
  public var lifecycleStatus: KotlinString?,
  ...
  public fun toModel(): Goal =
    Goal(
      ...
      implicitRules =
        Uri.ofNullable(this@GoalSurrogate.implicitRules, this@GoalSurrogate._implicitRules),
      language = Code.ofNullable(this@GoalSurrogate.language, this@GoalSurrogate._language),
      ...
      continuous =
        R5Boolean.ofNullable(this@GoalSurrogate.continuous, this@GoalSurrogate._continuous),
      priority = this@GoalSurrogate.priority,
      description = this@GoalSurrogate.description,
      subject = this@GoalSurrogate.subject,
      start =
        Goal.Start?.fromNullable(
          Date.ofNullable(
            FhirDate.fromString(this@GoalSurrogate.startDate),
            this@GoalSurrogate._startDate,
          ),
      ...
      statusDate =
        Date.ofNullable(
          FhirDate.fromString(this@GoalSurrogate.statusDate),
          this@GoalSurrogate._statusDate,
        ),
      statusReason =
        R5String.ofNullable(this@GoalSurrogate.statusReason, this@GoalSurrogate._statusReason),
