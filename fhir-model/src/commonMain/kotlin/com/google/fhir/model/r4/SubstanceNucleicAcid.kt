...
public data class SubstanceNucleicAcid(
  ...
  public class Subunit(
    ...
    public class Linkage(
      ...
      public class Builder() {
         ...
         */
        public var connectivity: String.Builder? = null
    ...
    public class Builder() {
      ...
      /**
       * Index of linear sequences of nucleic acids in order of decreasing length. Sequences of the
       * same length will be ordered by molecular weight. Subunits that have identical sequences
       ...
       * would be redundant.
       */
      public var fivePrime: CodeableConcept.Builder? = null
       ...
       * would be redundant.
       */
      public var threePrime: CodeableConcept.Builder? = null

      /** The linkages between sugar residues will also be captured. */
      public var linkage: MutableList<Linkage.Builder> = mutableListOf()
  ...
  public class Builder() : DomainResource.Builder() {
     ...
     * The number associated with the subunit followed by the number associated to the residue shall
     * be specified in increasing order. The underscore “” shall be used as separator as follows:
     * “Subunitnumber Residue”.
     */
    public var areaOfHybridisation: String.Builder? = null

    /** (TBC). */
    public var oligoNucleotideType: CodeableConcept.Builder? = null

    /**
     * Subunits are listed in order of decreasing length; sequences of the same length will be
     * ordered by molecular weight; subunits that have identical sequences will be repeated multiple
     * times.
     */
    public var subunit: MutableList<Subunit.Builder> = mutableListOf()

    override fun build(): SubstanceNucleicAcid =
