...
internal data class TestScriptScopeSurrogate(
  ...
  public fun toModel(): TestScript.Scope =
    TestScript.Scope(
      ...
      extension = this@TestScriptScopeSurrogate.extension ?: listOf(),
      modifierExtension = this@TestScriptScopeSurrogate.modifierExtension ?: listOf(),
      artifact =
        Canonical.of(
...
internal data class TestScriptSetupActionAssertSurrogate(
  ...
  public fun toModel(): TestScript.Setup.Action.Assert =
    TestScript.Setup.Action.Assert(
      ...
      requirement = this@TestScriptSetupActionAssertSurrogate.requirement ?: listOf(),
    )
...
internal data class TestScriptSetupActionAssertRequirementSurrogate(
  ...
  public fun toModel(): TestScript.Setup.Action.Assert.Requirement =
    TestScript.Setup.Action.Assert.Requirement(
      ...
      extension = this@TestScriptSetupActionAssertRequirementSurrogate.extension ?: listOf(),
      modifierExtension =
        this@TestScriptSetupActionAssertRequirementSurrogate.modifierExtension ?: listOf(),
...
internal data class TestScriptSurrogate(
  ...
  public fun toModel(): TestScript =
    TestScript(
      ...
      identifier = this@TestScriptSurrogate.identifier ?: listOf(),
      ...
      scope = this@TestScriptSurrogate.scope ?: listOf(),
