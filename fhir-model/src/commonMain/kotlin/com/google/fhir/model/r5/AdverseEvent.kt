      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.AdverseEvent.SuspectEntity.Instance"
          )
        }
    ...
    public sealed interface Item {
      ...
      public companion object {
        public fun from(
          ...
          if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.AdverseEvent.ContributingFactor.Item"
          )
        }
    ...
    public sealed interface Item {
      ...
      public companion object {
        public fun from(
          ...
          if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.AdverseEvent.PreventiveAction.Item"
          )
        }
    ...
    public sealed interface Item {
      ...
      public companion object {
        public fun from(
          ...
          if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.AdverseEvent.MitigatingAction.Item"
          )
        }
    ...
    public sealed interface Item {
      ...
      public companion object {
        public fun from(
          ...
          if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.AdverseEvent.SupportingInfo.Item"
          )
        }
  ...
  public sealed interface Occurrence {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.AdverseEvent.Occurrence"
        )
      }
