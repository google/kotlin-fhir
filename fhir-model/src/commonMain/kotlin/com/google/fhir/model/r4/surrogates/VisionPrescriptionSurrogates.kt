      ...
      base =
        Enumeration.of(
          this@VisionPrescriptionLensSpecificationPrismSurrogate.base?.let {
            com.google.fhir.model.r4.VisionPrescription.VisionBase.fromCode(it)
          },
      ...
      eye =
        Enumeration.of(
          this@VisionPrescriptionLensSpecificationSurrogate.eye?.let {
            com.google.fhir.model.r4.VisionPrescription.VisionEyes.fromCode(it)
          },
      ...
      status =
        Enumeration.of(
          this@VisionPrescriptionSurrogate.status?.let {
            com.google.fhir.model.r4.VisionPrescription.VisionStatus.fromCode(it)
          },
