...
internal data class SlotSurrogate(
  ...
  public fun toModel(): Slot =
    Slot(
      ...
      overbooked =
        R4Boolean.ofNullable(this@SlotSurrogate.overbooked, this@SlotSurrogate._overbooked),
      comment = R4String.ofNullable(this@SlotSurrogate.comment, this@SlotSurrogate._comment),
    )
