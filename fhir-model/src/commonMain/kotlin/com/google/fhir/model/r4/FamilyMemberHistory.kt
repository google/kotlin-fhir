      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.FamilyMemberHistory.Condition.Onset"
          )
        }
  ...
  public sealed interface Born {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r4.FamilyMemberHistory.Born"
        )
      }
  ...
  public sealed interface Age {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r4.FamilyMemberHistory.Age"
        )
      }
  ...
  public sealed interface Deceased {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r4.FamilyMemberHistory.Deceased"
        )
      }
