    ...
    AllergyIntolerance.Reaction(
      ...
      severity =
        this@AllergyIntoleranceReactionSurrogate.severity?.let {
          Enumeration.of(
            com.google.fhir.model.r4.AllergyIntolerance.AllergyIntoleranceSeverity.fromCode(it!!),
    ...
    public fun fromModel(model: AllergyIntolerance.Reaction): AllergyIntoleranceReactionSurrogate =
      with(model) {
        AllergyIntoleranceReactionSurrogate(
          ...
          manifestation = this@with.manifestation.takeUnless { it.isEmpty() },
    ...
    AllergyIntolerance(
      ...
      type =
        this@AllergyIntoleranceSurrogate.type?.let {
          Enumeration.of(
            com.google.fhir.model.r4.AllergyIntolerance.AllergyIntoleranceType.fromCode(it!!),
        ...
        if (
          ...
          (this@AllergyIntoleranceSurrogate.category
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4.AllergyIntolerance.AllergyIntoleranceCategory.fromCode(
                    it!!
                  )
                },
                element,
      ...
      criticality =
        this@AllergyIntoleranceSurrogate.criticality?.let {
          Enumeration.of(
            com.google.fhir.model.r4.AllergyIntolerance.AllergyIntoleranceCriticality.fromCode(
              it!!
            ),
      ...
      onset =
        AllergyIntolerance.Onset?.fromNullable(
          DateTime.ofNullable(
