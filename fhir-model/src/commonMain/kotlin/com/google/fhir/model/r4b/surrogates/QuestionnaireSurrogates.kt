...
internal data class QuestionnaireSurrogate(
  ...
  public fun toModel(): Questionnaire =
    Questionnaire(
      ...
      name =
        R4bString.ofNullable(this@QuestionnaireSurrogate.name, this@QuestionnaireSurrogate._name),
      title =
        R4bString.ofNullable(this@QuestionnaireSurrogate.title, this@QuestionnaireSurrogate._title),
      derivedFrom =
        if (
