        ...
        ObservationDefinitionComponentSurrogate(
          ...
          _permittedDataType =
            this@with.permittedDataType
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          permittedUnit = this@with.permittedUnit.takeUnless { it.isEmpty() },
          qualifiedValue = this@with.qualifiedValue.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ObservationDefinitionSurrogate(
  ...
  public fun toModel(): ObservationDefinition =
    ObservationDefinition(
      ...
      url =
        Uri.ofNullable(
          this@ObservationDefinitionSurrogate.url,
          this@ObservationDefinitionSurrogate._url,
        ),
      ...
      versionAlgorithm =
        ObservationDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
