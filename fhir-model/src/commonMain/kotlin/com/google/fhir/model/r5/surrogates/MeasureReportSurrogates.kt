    ...
    public fun fromModel(
      ...
      with(model) {
        MeasureReportGroupPopulationSurrogate(
          ...
          subjectReport = this@with.subjectReport.takeUnless { it.isEmpty() },
...
internal data class MeasureReportGroupStratifierStratumSurrogate(
  ...
  public fun toModel(): MeasureReport.Group.Stratifier.Stratum =
    MeasureReport.Group.Stratifier.Stratum(
      ...
      `value` =
        MeasureReport.Group.Stratifier.Stratum.Value?.fromNullable(
      ...
      measureScore =
        MeasureReport.Group.Stratifier.Stratum.MeasureScore?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        MeasureReportGroupStratifierSurrogate(
          ...
          _linkId = this@with.linkId?.toElement(),
          code = this@with.code,
          stratum = this@with.stratum.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class MeasureReportGroupSurrogate(
  ...
  public fun toModel(): MeasureReport.Group =
    MeasureReport.Group(
      ...
      measureScore =
        MeasureReport.Group.MeasureScore?.fromNullable(
...
internal data class MeasureReportSurrogate(
  ...
  public fun toModel(): MeasureReport =
    MeasureReport(
      ...
      language =
        Code.ofNullable(
          this@MeasureReportSurrogate.language,
          this@MeasureReportSurrogate._language,
        ),
      ...
      measure =
        Canonical.ofNullable(
          this@MeasureReportSurrogate.measure,
          this@MeasureReportSurrogate._measure,
        ),
    ...
    public fun fromModel(model: MeasureReport): MeasureReportSurrogate =
      with(model) {
        MeasureReportSurrogate(
          ...
          evaluatedResource = this@with.evaluatedResource.takeUnless { it.isEmpty() },
        )
      }
  }
}
