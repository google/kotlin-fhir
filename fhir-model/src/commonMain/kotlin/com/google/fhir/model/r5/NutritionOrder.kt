...
public data class NutritionOrder(
  ...
  public var performer: MutableList<CodeableReference> = mutableListOf(),
  /**
  ...
  public class OralDiet(
    ...
    public class Schedule(
       ...
       */
      public var timing: MutableList<Timing> = mutableListOf(),
      /**
  ...
  public class EnteralFormula(
     ...
     */
    public var deliveryDevice: MutableList<CodeableReference> = mutableListOf(),
        ...
        public companion object {
          public fun from(
            ...
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.NutritionOrder.EnteralFormula.Administration.Rate"
            )
          }
