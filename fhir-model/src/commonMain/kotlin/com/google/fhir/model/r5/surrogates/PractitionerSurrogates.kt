...
internal data class PractitionerSurrogate(
  ...
  public fun toModel(): Practitioner =
    Practitioner(
      ...
      implicitRules =
        Uri.ofNullable(
          this@PractitionerSurrogate.implicitRules,
          this@PractitionerSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@PractitionerSurrogate.language, this@PractitionerSurrogate._language),
      ...
      active =
        R5Boolean.ofNullable(this@PractitionerSurrogate.active, this@PractitionerSurrogate._active),
      ...
      deceased =
        Practitioner.Deceased?.fromNullable(
          R5Boolean.ofNullable(
    ...
    public fun fromModel(model: Practitioner): PractitionerSurrogate =
      with(model) {
        PractitionerSurrogate(
          ...
          qualification = this@with.qualification.takeUnless { it.isEmpty() },
