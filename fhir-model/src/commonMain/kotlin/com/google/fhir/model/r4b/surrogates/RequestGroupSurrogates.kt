...
internal data class RequestGroupActionRelatedActionSurrogate(
  ...
  public fun toModel(): RequestGroup.Action.RelatedAction =
    RequestGroup.Action.RelatedAction(
      ...
      offset =
        RequestGroup.Action.RelatedAction.Offset?.fromNullable(
...
internal data class RequestGroupActionSurrogate(
  ...
  public fun toModel(): RequestGroup.Action =
    RequestGroup.Action(
      ...
      timing =
        RequestGroup.Action.Timing?.fromNullable(
          DateTime.ofNullable(
...
internal data class RequestGroupSurrogate(
  ...
  public fun toModel(): RequestGroup =
    RequestGroup(
      ...
      implicitRules =
        Uri.ofNullable(
          this@RequestGroupSurrogate.implicitRules,
          this@RequestGroupSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@RequestGroupSurrogate.language, this@RequestGroupSurrogate._language),
