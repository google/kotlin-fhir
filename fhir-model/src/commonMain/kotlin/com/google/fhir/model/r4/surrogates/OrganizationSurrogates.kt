...
internal data class OrganizationSurrogate(
  ...
  public fun toModel(): Organization =
    Organization(
      ...
      active =
        R4Boolean.ofNullable(this@OrganizationSurrogate.active, this@OrganizationSurrogate._active),
      type = this@OrganizationSurrogate.type ?: mutableListOf(),
      name = R4String.ofNullable(this@OrganizationSurrogate.name, this@OrganizationSurrogate._name),
      alias =
