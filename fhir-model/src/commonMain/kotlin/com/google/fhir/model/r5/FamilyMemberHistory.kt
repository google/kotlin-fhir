      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.FamilyMemberHistory.Condition.Onset"
          )
        }
    ...
    public sealed interface Performed {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.FamilyMemberHistory.Procedure.Performed"
          )
        }
  ...
  public sealed interface Born {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.FamilyMemberHistory.Born"
        )
      }
  ...
  public sealed interface Age {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.FamilyMemberHistory.Age"
        )
      }
  ...
  public sealed interface Deceased {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.FamilyMemberHistory.Deceased"
        )
      }
