...
internal data class ServiceRequestSurrogate(
  ...
  public fun toModel(): ServiceRequest =
    ServiceRequest(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.ServiceRequest.RequestStatus.fromCode(
      ...
      intent =
        Enumeration.of(
          com.google.fhir.model.r4b.ServiceRequest.RequestIntent.fromCode(
      ...
      priority =
        this@ServiceRequestSurrogate.priority?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.ServiceRequest.RequestPriority.fromCode(it!!),
