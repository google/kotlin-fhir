...
import com.google.fhir.model.r4.Account
...
internal data class AccountSurrogate(
  ...
  public fun toModel(): Account =
    Account(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Account.AccountStatus.fromCode(this@AccountSurrogate.status!!),
          this@AccountSurrogate._status,
        ),
      type = this@AccountSurrogate.type,
      name = R4String.ofNullable(this@AccountSurrogate.name, this@AccountSurrogate._name),
      ...
      description =
        R4String.ofNullable(this@AccountSurrogate.description, this@AccountSurrogate._description),
