    ...
    ContactPoint(
      ...
      system =
        this@ContactPointSurrogate.system?.let {
          Enumeration.of(
            com.google.fhir.model.r5.ContactPoint.ContactPointSystem.fromCode(it!!),
            this@ContactPointSurrogate._system,
          )
        },
      `value` =
        R5String.ofNullable(this@ContactPointSurrogate.`value`, this@ContactPointSurrogate._value),
      use =
        this@ContactPointSurrogate.use?.let {
          Enumeration.of(
            com.google.fhir.model.r5.ContactPoint.ContactPointUse.fromCode(it!!),
            this@ContactPointSurrogate._use,
          )
        },
      rank =
        PositiveInt.ofNullable(this@ContactPointSurrogate.rank, this@ContactPointSurrogate._rank),
