...
internal data class ReferenceSurrogate(
  ...
  public fun toModel(): Reference =
    Reference(
      ...
      reference =
        R5String.ofNullable(this@ReferenceSurrogate.reference, this@ReferenceSurrogate._reference),
      ...
      display =
        R5String.ofNullable(this@ReferenceSurrogate.display, this@ReferenceSurrogate._display),
    )
