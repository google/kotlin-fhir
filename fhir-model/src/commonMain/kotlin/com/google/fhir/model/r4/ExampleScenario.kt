...
public data class ExampleScenario(
  ...
  public var workflow: List<Canonical?>? = null,
) : DomainResource() {
  /** Actor participating in the resource. */
  ...
  public class Instance(
    ...
    public var resourceType: Enumeration<FHIRResourceType>? = null,
  ...
  public enum class ExampleScenarioActorType(
    ...
    /** A person. */
    Person("person", "http://hl7.org/fhir/examplescenario-actor-type", "Person", "A person."),
    /** A system. */
    Entity("entity", "http://hl7.org/fhir/examplescenario-actor-type", "System", "A system.");
  ...
  public enum class FHIRResourceType(
     ...
     * particular version of FHIR that may be used as a statement of actual server functionality or
     ...
     * and realm, therefore this resource gives only a rough structure and requires profiling for
     ...
     * that has clinical attestation with regard to who is making the statement. A Composition
     * defines the structure and narrative content necessary for a document. However, a Composition
     * alone does not constitute a document. Rather, the Composition must be the first entry in a
     * Bundle where Bundle.type=document, and any other resources referenced from Composition must
     * be included as subsequent entries in the Bundle (for example Patient, Practitioner,
     * Encounter, etc.).
     */
    Composition(
      "Composition",
    ...
    /**
     * A record of a healthcare consumer’s choices, which permits or denies identified recipient(s)
    ...
    /**
     * A reference to a document of any kind for any purpose. Provides metadata about the document
     ...
     * typically through the use of FHIR resources. This resource is used to gather all the parts of
     * an implementation guide into a logical whole and to publish a computable definition of all
     * the parts.
     */
    ImplementationGuide(
      "ImplementationGuide",
     ...
     * the instructions for administering the medication. The medication dispense is the result of a
     ...
     * past or will be taking the medication in the future. The source of this information can be
     * the patient, significant other (such as a family member or spouse), or a clinician. A common
     ...
     * corporations, departments, community groups, healthcare practice groups, payer/insurer, etc.
     */
    Organization(
      "Organization",
      "http://hl7.org/fhir/resource-types",
    ...
    /**
     * Defines an affiliation/assotiation/relationship between 2 distinct oganizations, that is not
     * a part-of relationship/sub-division relationship.
     */
     ...
     * therapies and other interventional and investigative techniques. A ResearchStudy involves the
     * gathering of information about human or animal subjects.
     */
    ResearchStudy(
      "ResearchStudy",
      "http://hl7.org/fhir/resource-types",
    ...
    /**
     * A physical entity which is the primary unit of operational and/or administrative interest in
     * a study.
     */
    ResearchSubject(
      "ResearchSubject",
     ...
     * a message on the defined "channel" so that another system can take an appropriate action.
     */
    Subscription(
      "Subscription",
      "http://hl7.org/fhir/resource-types",
     ...
     * SubstanceProteins of defined sequence, whether the use is therapeutic or prophylactic. This
     * set of elements will be used to describe albumins, coagulation factors, cytokines, growth
     * factors, peptide/SubstanceProtein hormones, enzymes, toxins, toxoids, recombinant vaccines,
     ...
     * the fraction of a material that can result in or can be modified to form a substance. This
     * set of data elements shall be used to define polymer substances isolated from biological
     * matrices. Taxonomic and anatomical origins shall be described using a controlled vocabulary
     * as required. This information is captured for naturally derived polymers ( . starch) and
     * structurally diverse substances. For Organisms belonging to the Kingdom Plantae the Substance
     * level defines the fresh material of a single species or infraspecies, the Herbal Drug and the
     * Herbal preparation. For Herbal preparations, the fraction information will be captured at the
     * Substance information level and additional information for herbal extracts will be captured
     * at the Specified Substance Group 1 information level. See for further explanation the
     ...
     * intended for use in a particular context. Value sets link between [[[CodeSystem]]]
