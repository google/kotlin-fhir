    ...
    TestScript.Setup.Action.Operation(
      ...
      method =
        this@TestScriptSetupActionOperationSurrogate.method?.let {
          Enumeration.of(
            com.google.fhir.model.r4.TestScript.TestScriptRequestMethodCode.fromCode(it!!),
    ...
    TestScript.Setup.Action.Assert(
      ...
      direction =
        this@TestScriptSetupActionAssertSurrogate.direction?.let {
          Enumeration.of(
            com.google.fhir.model.r4.TestScript.AssertionDirectionType.fromCode(it!!),
      ...
      `operator` =
        this@TestScriptSetupActionAssertSurrogate.`operator`?.let {
          Enumeration.of(
            com.google.fhir.model.r4.TestScript.AssertionOperatorType.fromCode(it!!),
      ...
      response =
        this@TestScriptSetupActionAssertSurrogate.response?.let {
          Enumeration.of(
            com.google.fhir.model.r4.TestScript.AssertionResponseTypes.fromCode(it!!),
...
internal data class TestScriptTestSurrogate(
  ...
  public fun toModel(): TestScript.Test =
    TestScript.Test(
      ...
      name =
        R4String.ofNullable(this@TestScriptTestSurrogate.name, this@TestScriptTestSurrogate._name),
      description =
        R4String.ofNullable(
...
internal data class TestScriptSurrogate(
  ...
  public var profile: MutableList<Reference>? = null,
  ...
  public fun toModel(): TestScript =
    TestScript(
      ...
      version =
        R4String.ofNullable(this@TestScriptSurrogate.version, this@TestScriptSurrogate._version),
      name = R4String.of(this@TestScriptSurrogate.name!!, this@TestScriptSurrogate._name),
      title = R4String.ofNullable(this@TestScriptSurrogate.title, this@TestScriptSurrogate._title),
      status =
        Enumeration.of(
      ...
      profile = this@TestScriptSurrogate.profile ?: mutableListOf(),
    ...
    public fun fromModel(model: TestScript): TestScriptSurrogate =
      with(model) {
        TestScriptSurrogate(
          ...
          profile = this@with.profile.takeUnless { it.isEmpty() },
