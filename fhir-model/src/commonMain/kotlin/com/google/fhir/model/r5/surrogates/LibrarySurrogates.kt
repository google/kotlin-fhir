...
internal data class LibrarySurrogate(
  ...
  public fun toModel(): Library =
    Library(
      ...
      implicitRules =
        Uri.ofNullable(this@LibrarySurrogate.implicitRules, this@LibrarySurrogate._implicitRules),
      language = Code.ofNullable(this@LibrarySurrogate.language, this@LibrarySurrogate._language),
      ...
      url = Uri.ofNullable(this@LibrarySurrogate.url, this@LibrarySurrogate._url),
      identifier = this@LibrarySurrogate.identifier ?: mutableListOf(),
      version = R5String.ofNullable(this@LibrarySurrogate.version, this@LibrarySurrogate._version),
      versionAlgorithm =
        Library.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@LibrarySurrogate.name, this@LibrarySurrogate._name),
      title = R5String.ofNullable(this@LibrarySurrogate.title, this@LibrarySurrogate._title),
      subtitle =
        R5String.ofNullable(this@LibrarySurrogate.subtitle, this@LibrarySurrogate._subtitle),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@LibrarySurrogate.experimental,
          this@LibrarySurrogate._experimental,
        ),
      type = this@LibrarySurrogate.type,
      subject =
        Library.Subject?.fromNullable(
      ...
      publisher =
        R5String.ofNullable(this@LibrarySurrogate.publisher, this@LibrarySurrogate._publisher),
      contact = this@LibrarySurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(this@LibrarySurrogate.description, this@LibrarySurrogate._description),
      useContext = this@LibrarySurrogate.useContext ?: mutableListOf(),
      jurisdiction = this@LibrarySurrogate.jurisdiction ?: mutableListOf(),
      purpose = Markdown.ofNullable(this@LibrarySurrogate.purpose, this@LibrarySurrogate._purpose),
      usage = Markdown.ofNullable(this@LibrarySurrogate.usage, this@LibrarySurrogate._usage),
      copyright =
        Markdown.ofNullable(this@LibrarySurrogate.copyright, this@LibrarySurrogate._copyright),
      copyrightLabel =
        R5String.ofNullable(
          this@LibrarySurrogate.copyrightLabel,
          this@LibrarySurrogate._copyrightLabel,
        ),
      approvalDate =
        Date.ofNullable(
    ...
    public fun fromModel(model: Library): LibrarySurrogate =
      with(model) {
        LibrarySurrogate(
          ...
          dataRequirement = this@with.dataRequirement.takeUnless { it.isEmpty() },
          content = this@with.content.takeUnless { it.isEmpty() },
        )
      }
  }
}
