...
internal data class SubscriptionFilterBySurrogate(
  ...
  public var filterParameter: KotlinString?,
...
internal data class SubscriptionSurrogate(
  ...
  public fun toModel(): Subscription =
    Subscription(
      ...
      implicitRules =
        Uri.ofNullable(
          this@SubscriptionSurrogate.implicitRules,
          this@SubscriptionSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@SubscriptionSurrogate.language, this@SubscriptionSurrogate._language),
      ...
      name = R5String.ofNullable(this@SubscriptionSurrogate.name, this@SubscriptionSurrogate._name),
      status =
        Enumeration.of(
      ...
      reason =
        R5String.ofNullable(this@SubscriptionSurrogate.reason, this@SubscriptionSurrogate._reason),
      filterBy = this@SubscriptionSurrogate.filterBy ?: mutableListOf(),
      channelType = this@SubscriptionSurrogate.channelType,
      endpoint =
        Url.ofNullable(this@SubscriptionSurrogate.endpoint, this@SubscriptionSurrogate._endpoint),
      ...
      timeout =
        UnsignedInt.ofNullable(
          this@SubscriptionSurrogate.timeout,
          this@SubscriptionSurrogate._timeout,
        ),
      contentType =
        Code.ofNullable(
          this@SubscriptionSurrogate.contentType,
          this@SubscriptionSurrogate._contentType,
        ),
      content =
      ...
      maxCount =
        PositiveInt.ofNullable(
          this@SubscriptionSurrogate.maxCount,
          this@SubscriptionSurrogate._maxCount,
        ),
    )
    ...
    public fun fromModel(model: Subscription): SubscriptionSurrogate =
      with(model) {
        SubscriptionSurrogate(
          ...
          filterBy = this@with.filterBy.takeUnless { it.isEmpty() },
