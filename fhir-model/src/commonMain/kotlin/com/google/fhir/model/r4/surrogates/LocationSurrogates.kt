      ...
      daysOfWeek =
        if (
          ...
          (this@LocationHoursOfOperationSurrogate.daysOfWeek
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let { com.google.fhir.model.r4.Location.DaysOfWeek.fromCode(it!!) },
                element,
              )
            }
            .toMutableList()
...
internal data class LocationSurrogate(
  ...
  public fun toModel(): Location =
    Location(
      ...
      implicitRules =
        Uri.ofNullable(this@LocationSurrogate.implicitRules, this@LocationSurrogate._implicitRules),
      language = Code.ofNullable(this@LocationSurrogate.language, this@LocationSurrogate._language),
      ...
      status =
        this@LocationSurrogate.status?.let {
          Enumeration.of(
            com.google.fhir.model.r4.Location.LocationStatus.fromCode(it!!),
            this@LocationSurrogate._status,
          )
        },
      operationalStatus = this@LocationSurrogate.operationalStatus,
      name = R4String.ofNullable(this@LocationSurrogate.name, this@LocationSurrogate._name),
      alias =
      ...
      description =
        R4String.ofNullable(
          this@LocationSurrogate.description,
          this@LocationSurrogate._description,
        ),
      mode =
        this@LocationSurrogate.mode?.let {
          Enumeration.of(
            com.google.fhir.model.r4.Location.LocationMode.fromCode(it!!),
    ...
    public fun fromModel(model: Location): LocationSurrogate =
      with(model) {
        LocationSurrogate(
          ...
          hoursOfOperation = this@with.hoursOfOperation.takeUnless { it.isEmpty() },
