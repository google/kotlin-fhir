...
internal data class PersonSurrogate(
  ...
  public fun toModel(): Person =
    Person(
      ...
      implicitRules =
        Uri.ofNullable(this@PersonSurrogate.implicitRules, this@PersonSurrogate._implicitRules),
      language = Code.ofNullable(this@PersonSurrogate.language, this@PersonSurrogate._language),
      ...
      active = R5Boolean.ofNullable(this@PersonSurrogate.active, this@PersonSurrogate._active),
      ...
      deceased =
        Person.Deceased?.fromNullable(
          R5Boolean.ofNullable(
            this@PersonSurrogate.deceasedBoolean,
            this@PersonSurrogate._deceasedBoolean,
          ),
          DateTime.ofNullable(
