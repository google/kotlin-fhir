    ...
    Appointment.Participant(
      ...
      required =
        this@AppointmentParticipantSurrogate.required?.let {
          Enumeration.of(
            com.google.fhir.model.r4.Appointment.ParticipantRequired.fromCode(it!!),
            this@AppointmentParticipantSurrogate._required,
          )
        },
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Appointment.ParticipationStatus.fromCode(
...
internal data class AppointmentSurrogate(
  ...
  public fun toModel(): Appointment =
    Appointment(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Appointment.AppointmentStatus.fromCode(
      ...
      priority =
        UnsignedInt.ofNullable(
          this@AppointmentSurrogate.priority,
          this@AppointmentSurrogate._priority,
        ),
      description =
        R4String.ofNullable(
      ...
      comment =
        R4String.ofNullable(this@AppointmentSurrogate.comment, this@AppointmentSurrogate._comment),
      patientInstruction =
        R4String.ofNullable(
