...
internal data class AdverseEventSurrogate(
  ...
  public fun toModel(): AdverseEvent =
    AdverseEvent(
      ...
      implicitRules =
        Uri.ofNullable(
          this@AdverseEventSurrogate.implicitRules,
          this@AdverseEventSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@AdverseEventSurrogate.language, this@AdverseEventSurrogate._language),
      ...
      occurrence =
        AdverseEvent.Occurrence?.fromNullable(
          DateTime.ofNullable(
    ...
    public fun fromModel(model: AdverseEvent): AdverseEventSurrogate =
      with(model) {
        AdverseEventSurrogate(
          ...
          resultingEffect = this@with.resultingEffect.takeUnless { it.isEmpty() },
          ...
          study = this@with.study.takeUnless { it.isEmpty() },
          ...
          suspectEntity = this@with.suspectEntity.takeUnless { it.isEmpty() },
          contributingFactor = this@with.contributingFactor.takeUnless { it.isEmpty() },
          preventiveAction = this@with.preventiveAction.takeUnless { it.isEmpty() },
          mitigatingAction = this@with.mitigatingAction.takeUnless { it.isEmpty() },
