 ...
 * activity.
 */
public enum class ConditionParticipantFunction(
  ...
  public companion object {
    public fun fromCode(code: String): ConditionParticipantFunction =
      when (code) {
        "enterer" -> Enterer
        "performer" -> Performer
        "author" -> Author
        ...
        "humanuser" -> Humanuser
          ...
          throw IllegalArgumentException("Unknown code $code for enum ConditionParticipantFunction")
      }
  }
}
