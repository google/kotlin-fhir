    ...
    public fun fromModel(
      ...
      with(model) {
        OperationDefinitionParameterSurrogate(
          ...
          scope =
            this@with.scope.map { it.value.getCode() }.toMutableList().takeUnless { it.isEmpty() },
          _scope =
            this@with.scope
              .map { it.toElement() }
          ...
          referencedFrom = this@with.referencedFrom.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        OperationDefinitionOverloadSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          parameterName =
            this@with.parameterName.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _parameterName =
...
internal data class OperationDefinitionSurrogate(
  ...
  public var system: KotlinBoolean?,
  public var _system: Element? = null,
  public var type: KotlinBoolean?,
  public var _type: Element? = null,
  public var instance: KotlinBoolean?,
  ...
  public fun toModel(): OperationDefinition =
    OperationDefinition(
      ...
      url =
        Uri.ofNullable(
          this@OperationDefinitionSurrogate.url,
          this@OperationDefinitionSurrogate._url,
        ),
      ...
      versionAlgorithm =
        OperationDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
    ...
    public fun fromModel(model: OperationDefinition): OperationDefinitionSurrogate =
      with(model) {
        OperationDefinitionSurrogate(
          ...
          resource =
            this@with.resource.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _resource =
            this@with.resource
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
          ...
          overload = this@with.overload.takeUnless { it.isEmpty() },
        )
      }
  }
}
