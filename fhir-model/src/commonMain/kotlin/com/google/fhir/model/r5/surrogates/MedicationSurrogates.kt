...
internal data class MedicationIngredientSurrogate(
  ...
  public fun toModel(): Medication.Ingredient =
    Medication.Ingredient(
      ...
      strength =
        Medication.Ingredient.Strength?.fromNullable(
...
internal data class MedicationSurrogate(
  ...
  public fun toModel(): Medication =
    Medication(
      ...
      implicitRules =
        Uri.ofNullable(
          this@MedicationSurrogate.implicitRules,
          this@MedicationSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@MedicationSurrogate.language, this@MedicationSurrogate._language),
