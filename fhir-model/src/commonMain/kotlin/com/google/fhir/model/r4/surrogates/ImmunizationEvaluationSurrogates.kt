...
internal data class ImmunizationEvaluationSurrogate(
  ...
  public fun toModel(): ImmunizationEvaluation =
    ImmunizationEvaluation(
      ...
      doseNumber =
        ImmunizationEvaluation.DoseNumber?.fromNullable(
      ...
      seriesDoses =
        ImmunizationEvaluation.SeriesDoses?.fromNullable(
          PositiveInt.ofNullable(
    ...
    public fun fromModel(model: ImmunizationEvaluation): ImmunizationEvaluationSurrogate =
      with(model) {
        ImmunizationEvaluationSurrogate(
          ...
          doseStatusReason = this@with.doseStatusReason.takeUnless { it.isEmpty() },
