...
internal data class SupplyDeliverySuppliedItemSurrogate(
  ...
  public fun toModel(): SupplyDelivery.SuppliedItem =
    SupplyDelivery.SuppliedItem(
      ...
      item =
        SupplyDelivery.SuppliedItem.Item?.fromNullable(
...
internal data class SupplyDeliverySurrogate(
  ...
  public fun toModel(): SupplyDelivery =
    SupplyDelivery(
      ...
      language =
        Code.ofNullable(
          this@SupplyDeliverySurrogate.language,
          this@SupplyDeliverySurrogate._language,
        ),
      ...
      occurrence =
        SupplyDelivery.Occurrence?.fromNullable(
          DateTime.ofNullable(
    ...
    public fun fromModel(model: SupplyDelivery): SupplyDeliverySurrogate =
      with(model) {
        SupplyDeliverySurrogate(
          ...
          type = this@with.type,
          suppliedItem = this@with.suppliedItem.takeUnless { it.isEmpty() },
