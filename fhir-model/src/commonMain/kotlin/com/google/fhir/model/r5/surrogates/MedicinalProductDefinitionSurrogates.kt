    ...
    public fun fromModel(
      ...
      with(model) {
        MedicinalProductDefinitionNameSurrogate(
          ...
          type = this@with.type,
          part = this@with.part.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicinalProductDefinitionOperationSurrogate(
          ...
          organization = this@with.organization.takeUnless { it.isEmpty() },
...
internal data class MedicinalProductDefinitionCharacteristicSurrogate(
  ...
  public fun toModel(): MedicinalProductDefinition.Characteristic =
    MedicinalProductDefinition.Characteristic(
      ...
      `value` =
        MedicinalProductDefinition.Characteristic.Value?.fromNullable(
    ...
    public fun fromModel(model: MedicinalProductDefinition): MedicinalProductDefinitionSurrogate =
      with(model) {
        MedicinalProductDefinitionSurrogate(
          ...
          route = this@with.route.takeUnless { it.isEmpty() },
          ...
          specialMeasures = this@with.specialMeasures.takeUnless { it.isEmpty() },
          ...
          comprisedOf = this@with.comprisedOf.takeUnless { it.isEmpty() },
          ingredient = this@with.ingredient.takeUnless { it.isEmpty() },
          impurity = this@with.impurity.takeUnless { it.isEmpty() },
