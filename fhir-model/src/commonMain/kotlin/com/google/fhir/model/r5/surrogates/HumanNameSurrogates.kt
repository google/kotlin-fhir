...
internal data class HumanNameSurrogate(
  ...
  public fun toModel(): HumanName =
    HumanName(
      ...
      text = R5String.ofNullable(this@HumanNameSurrogate.text, this@HumanNameSurrogate._text),
      family = R5String.ofNullable(this@HumanNameSurrogate.family, this@HumanNameSurrogate._family),
      given =
