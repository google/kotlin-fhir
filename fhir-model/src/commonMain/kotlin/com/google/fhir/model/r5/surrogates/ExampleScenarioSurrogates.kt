...
internal data class ExampleScenarioInstanceContainedInstanceSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var instanceReference: KotlinString?,
...
internal data class ExampleScenarioInstanceSurrogate(
  ...
  public fun toModel(): ExampleScenario.Instance =
    ExampleScenario.Instance(
      ...
      structureProfile =
        ExampleScenario.Instance.StructureProfile?.fromNullable(
      ...
      with(model) {
        ExampleScenarioInstanceSurrogate(
          ...
          _structureProfileCanonical =
            this@with.structureProfile?.asCanonical()?.value?.toElement(),
          ...
          containedInstance = this@with.containedInstance.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        ExampleScenarioProcessStepAlternativeSurrogate(
          ...
          description = this@with.description?.value,
          _description = this@with.description?.toElement(),
          step = this@with.step.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: ExampleScenario.Process.Step): ExampleScenarioProcessStepSurrogate =
      with(model) {
        ExampleScenarioProcessStepSurrogate(
          ...
          alternative = this@with.alternative.takeUnless { it.isEmpty() },
...
internal data class ExampleScenarioSurrogate(
  ...
  public fun toModel(): ExampleScenario =
    ExampleScenario(
      ...
      language =
        Code.ofNullable(
          this@ExampleScenarioSurrogate.language,
          this@ExampleScenarioSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@ExampleScenarioSurrogate.url, this@ExampleScenarioSurrogate._url),
      identifier = this@ExampleScenarioSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@ExampleScenarioSurrogate.version,
          this@ExampleScenarioSurrogate._version,
        ),
      versionAlgorithm =
        ExampleScenario.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name =
        R5String.ofNullable(
          this@ExampleScenarioSurrogate.name,
          this@ExampleScenarioSurrogate._name,
        ),
      title =
        R5String.ofNullable(
          this@ExampleScenarioSurrogate.title,
          this@ExampleScenarioSurrogate._title,
        ),
      status =
        Enumeration.of(
      ...
      purpose =
        Markdown.ofNullable(
          this@ExampleScenarioSurrogate.purpose,
          this@ExampleScenarioSurrogate._purpose,
        ),
      copyright =
        Markdown.ofNullable(
    ...
    public fun fromModel(model: ExampleScenario): ExampleScenarioSurrogate =
      with(model) {
        ExampleScenarioSurrogate(
          ...
          instance = this@with.instance.takeUnless { it.isEmpty() },
          process = this@with.process.takeUnless { it.isEmpty() },
        )
      }
  }
}
