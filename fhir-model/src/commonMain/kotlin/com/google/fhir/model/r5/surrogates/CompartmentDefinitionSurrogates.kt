    ...
    public fun fromModel(
      ...
      with(model) {
        CompartmentDefinitionResourceSurrogate(
          ...
          `param` =
            this@with.`param`.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _param =
            this@with.`param`
              .map { it.toElement() }
...
internal data class CompartmentDefinitionSurrogate(
  ...
  public var code: KotlinString?,
  public var _code: Element? = null,
  public var search: KotlinBoolean?,
  ...
  public fun toModel(): CompartmentDefinition =
    CompartmentDefinition(
      ...
      versionAlgorithm =
        CompartmentDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      code =
        Enumeration.of(
          com.google.fhir.model.r5.CompartmentDefinition.CompartmentType.fromCode(
