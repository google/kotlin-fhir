...
internal data class StructureMapGroupRuleSourceSurrogate(
  ...
  public fun toModel(): StructureMap.Group.Rule.Source =
    StructureMap.Group.Rule.Source(
      ...
      defaultValue =
        StructureMap.Group.Rule.Source.DefaultValue?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        StructureMapGroupRuleDependentSurrogate(
          ...
          _name = this@with.name.toElement(),
          variable =
            this@with.variable.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _variable =
            this@with.variable
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
...
internal data class StructureMapGroupSurrogate(
  ...
  public var typeMode: KotlinString?,
...
internal data class StructureMapSurrogate(
  ...
  public fun toModel(): StructureMap =
    StructureMap(
      ...
      title =
        R4bString.ofNullable(this@StructureMapSurrogate.title, this@StructureMapSurrogate._title),
      status =
        Enumeration.of(
