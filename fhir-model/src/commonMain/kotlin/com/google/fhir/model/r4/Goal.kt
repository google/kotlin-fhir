      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Goal.Target.Detail"
          )
        }
    ...
    public sealed interface Due {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Goal.Target.Due"
          )
        }
  ...
  public sealed interface Start {
    ...
    public companion object {
      public fun from(
        ...
        if (dateValue != null) return Date(dateValue)
        if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
        throw IllegalArgumentException("Missing value for com.google.fhir.model.r4.Goal.Start")
      }
