...
internal data class AgeSurrogate(
  ...
  public fun toModel(): Age =
    Age(
      ...
      `value` = Decimal.ofNullable(this@AgeSurrogate.`value`, this@AgeSurrogate._value),
      comparator =
      ...
      unit = R4bString.ofNullable(this@AgeSurrogate.unit, this@AgeSurrogate._unit),
      system = Uri.ofNullable(this@AgeSurrogate.system, this@AgeSurrogate._system),
      code = Code.ofNullable(this@AgeSurrogate.code, this@AgeSurrogate._code),
    )
