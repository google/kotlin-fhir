...
internal data class TestScriptTestSurrogate(
  ...
  public fun toModel(): TestScript.Test =
    TestScript.Test(
      ...
      name =
        R4bString.ofNullable(this@TestScriptTestSurrogate.name, this@TestScriptTestSurrogate._name),
      description =
        R4bString.ofNullable(
...
internal data class TestScriptSurrogate(
  ...
  public fun toModel(): TestScript =
    TestScript(
      ...
      version =
        R4bString.ofNullable(this@TestScriptSurrogate.version, this@TestScriptSurrogate._version),
      name = R4bString.of(this@TestScriptSurrogate.name!!, this@TestScriptSurrogate._name),
      title = R4bString.ofNullable(this@TestScriptSurrogate.title, this@TestScriptSurrogate._title),
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.PublicationStatus.fromCode(this@TestScriptSurrogate.status!!),
