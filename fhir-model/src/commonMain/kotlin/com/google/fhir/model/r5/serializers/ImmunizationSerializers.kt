...
public object ImmunizationProgramEligibilitySerializer :
  KSerializer<Immunization.ProgramEligibility> {
  internal val surrogateSerializer: KSerializer<ImmunizationProgramEligibilitySurrogate> by lazy {
    ImmunizationProgramEligibilitySurrogate.serializer()
  }

  override val descriptor: SerialDescriptor by lazy {
    SerialDescriptor("ProgramEligibility", surrogateSerializer.descriptor)
  }
