...
internal data class MediaSurrogate(
  ...
  public fun toModel(): Media =
    Media(
      ...
      implicitRules =
        Uri.ofNullable(this@MediaSurrogate.implicitRules, this@MediaSurrogate._implicitRules),
      language = Code.ofNullable(this@MediaSurrogate.language, this@MediaSurrogate._language),
      ...
      deviceName =
        R4bString.ofNullable(this@MediaSurrogate.deviceName, this@MediaSurrogate._deviceName),
      device = this@MediaSurrogate.device,
      height = PositiveInt.ofNullable(this@MediaSurrogate.height, this@MediaSurrogate._height),
      width = PositiveInt.ofNullable(this@MediaSurrogate.width, this@MediaSurrogate._width),
      frames = PositiveInt.ofNullable(this@MediaSurrogate.frames, this@MediaSurrogate._frames),
      duration = Decimal.ofNullable(this@MediaSurrogate.duration, this@MediaSurrogate._duration),
