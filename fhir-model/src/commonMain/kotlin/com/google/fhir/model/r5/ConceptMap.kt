...
public data class ConceptMap(
   ...
   */
  public var additionalAttribute: MutableList<AdditionalAttribute> = mutableListOf(),
  /**
            ...
            public companion object {
              public fun from(
                ...
                throw IllegalArgumentException(
                  "Missing value for com.google.fhir.model.r5.ConceptMap.Group.Element.Target.Property.Value"
                )
              }
          ...
          public sealed interface Value {
            ...
            public companion object {
              public fun from(
                ...
                throw IllegalArgumentException(
                  "Missing value for com.google.fhir.model.r5.ConceptMap.Group.Element.Target.DependsOn.Value"
                )
              }
  ...
  public sealed interface VersionAlgorithm {
    ...
    public companion object {
      public fun from(
        ...
        if (CodingValue != null) return Coding(CodingValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ConceptMap.VersionAlgorithm"
        )
      }
  ...
  public sealed interface SourceScope {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ConceptMap.SourceScope"
        )
      }
  ...
  public sealed interface TargetScope {
    ...
    public companion object {
      public fun from(
        ...
        if (canonicalValue != null) return Canonical(canonicalValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.ConceptMap.TargetScope"
        )
      }
