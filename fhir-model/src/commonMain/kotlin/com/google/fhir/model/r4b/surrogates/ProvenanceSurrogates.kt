...
internal data class ProvenanceEntitySurrogate(
  ...
  public fun toModel(): Provenance.Entity =
    Provenance.Entity(
      ...
      role =
        Enumeration.of(
          com.google.fhir.model.r4b.Provenance.ProvenanceEntityRole.fromCode(
...
internal data class ProvenanceSurrogate(
  ...
  public fun toModel(): Provenance =
    Provenance(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ProvenanceSurrogate.implicitRules,
          this@ProvenanceSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ProvenanceSurrogate.language, this@ProvenanceSurrogate._language),
      ...
      occurred =
        Provenance.Occurred?.fromNullable(
