...
import com.google.fhir.model.r4.surrogates.MedicinalProductIndicationOtherTherapyMedicationSurrogate
import com.google.fhir.model.r4.surrogates.MedicinalProductIndicationOtherTherapySurrogate
import com.google.fhir.model.r4.surrogates.MedicinalProductIndicationSurrogate
...
public object MedicinalProductIndicationOtherTherapySerializer :
  ...
  internal val surrogateSerializer:
    KSerializer<MedicinalProductIndicationOtherTherapySurrogate> by lazy {
    MedicinalProductIndicationOtherTherapySurrogate.serializer()
  }
  ...
  override fun serialize(encoder: Encoder, `value`: MedicinalProductIndication.OtherTherapy) {
    ...
    val surrogate = MedicinalProductIndicationOtherTherapySurrogate.fromModel(value)
    val oldJsonObject =
...
public object MedicinalProductIndicationSerializer : KSerializer<MedicinalProductIndication> {
  internal val surrogateSerializer: KSerializer<MedicinalProductIndicationSurrogate> by lazy {
    MedicinalProductIndicationSurrogate.serializer()
  }

  override val descriptor: SerialDescriptor by lazy {
    SerialDescriptor("MedicinalProductIndication", surrogateSerializer.descriptor)
  }
  ...
  override fun serialize(encoder: Encoder, `value`: MedicinalProductIndication) {
    surrogateSerializer.serialize(encoder, MedicinalProductIndicationSurrogate.fromModel(value))
  }
}
