...
internal data class ConceptMapGroupElementTargetSurrogate(
  ...
  public var display: KotlinString? = null,
  public var _display: Element? = null,
  public var equivalence: KotlinString?,
  ...
  public fun toModel(): ConceptMap.Group.Element.Target =
    ConceptMap.Group.Element.Target(
      ...
      equivalence =
        Enumeration.of(
          com.google.fhir.model.r4.ConceptMapEquivalence.fromCode(
...
internal data class ConceptMapGroupUnmappedSurrogate(
  ...
  public fun toModel(): ConceptMap.Group.Unmapped =
    ConceptMap.Group.Unmapped(
      ...
      mode =
        Enumeration.of(
          com.google.fhir.model.r4.ConceptMap.ConceptMapGroupUnmappedMode.fromCode(
...
internal data class ConceptMapGroupSurrogate(
  ...
  public fun toModel(): ConceptMap.Group =
    ConceptMap.Group(
      ...
      source =
        Uri.ofNullable(this@ConceptMapGroupSurrogate.source, this@ConceptMapGroupSurrogate._source),
      sourceVersion =
        R4String.ofNullable(
      ...
      target =
        Uri.ofNullable(this@ConceptMapGroupSurrogate.target, this@ConceptMapGroupSurrogate._target),
      targetVersion =
        R4String.ofNullable(
...
internal data class ConceptMapSurrogate(
  ...
  public fun toModel(): ConceptMap =
    ConceptMap(
      ...
      version =
        R4String.ofNullable(this@ConceptMapSurrogate.version, this@ConceptMapSurrogate._version),
      name = R4String.ofNullable(this@ConceptMapSurrogate.name, this@ConceptMapSurrogate._name),
      title = R4String.ofNullable(this@ConceptMapSurrogate.title, this@ConceptMapSurrogate._title),
      status =
        Enumeration.of(
          com.google.fhir.model.r4.PublicationStatus.fromCode(this@ConceptMapSurrogate.status!!),
      ...
      source =
        ConceptMap.Source?.fromNullable(
          Uri.ofNullable(this@ConceptMapSurrogate.sourceUri, this@ConceptMapSurrogate._sourceUri),
          Canonical.ofNullable(
      ...
      target =
        ConceptMap.Target?.fromNullable(
          Uri.ofNullable(this@ConceptMapSurrogate.targetUri, this@ConceptMapSurrogate._targetUri),
          Canonical.ofNullable(
