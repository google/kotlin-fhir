 ...
 * activity.
 */
public enum class AllergyIntoleranceParticipantFunction(
  ...
  public companion object {
    public fun fromCode(code: String): AllergyIntoleranceParticipantFunction =
      when (code) {
        "enterer" -> Enterer
        "performer" -> Performer
        "author" -> Author
        ...
        "humanuser" -> Humanuser
          ...
          throw IllegalArgumentException(
            "Unknown code $code for enum AllergyIntoleranceParticipantFunction"
          )
      }
  }
}
