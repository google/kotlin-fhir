...
import com.google.fhir.model.r5.surrogates.CareTeamParticipantCoverageSurrogate
import com.google.fhir.model.r5.surrogates.CareTeamParticipantSurrogate
import com.google.fhir.model.r5.surrogates.CareTeamSurrogate
...
public object CareTeamParticipantSerializer : KSerializer<CareTeam.Participant> {
  ...
  private val multiChoiceProperties: List<String> = listOf("coverage")
  ...
  override fun serialize(encoder: Encoder, `value`: CareTeam.Participant) {
    ...
    val surrogate = CareTeamParticipantSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
