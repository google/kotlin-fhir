...
internal data class QuantitySurrogate(
  ...
  public fun toModel(): Quantity =
    Quantity(
      ...
      `value` = Decimal.ofNullable(this@QuantitySurrogate.`value`, this@QuantitySurrogate._value),
      comparator =
      ...
      unit = R4bString.ofNullable(this@QuantitySurrogate.unit, this@QuantitySurrogate._unit),
      system = Uri.ofNullable(this@QuantitySurrogate.system, this@QuantitySurrogate._system),
      code = Code.ofNullable(this@QuantitySurrogate.code, this@QuantitySurrogate._code),
    )
