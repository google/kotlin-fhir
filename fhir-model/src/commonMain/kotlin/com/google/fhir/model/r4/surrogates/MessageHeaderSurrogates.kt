...
internal data class MessageHeaderSourceSurrogate(
  ...
  public fun toModel(): MessageHeader.Source =
    MessageHeader.Source().apply {
      ...
      name =
        R4String.of(this@MessageHeaderSourceSurrogate.name, this@MessageHeaderSourceSurrogate._name)
      software =
        R4String.of(
      ...
      code =
        Enumeration.of(
          this@MessageHeaderResponseSurrogate.code?.let {
            com.google.fhir.model.r4.MessageHeader.ResponseType.fromCode(it)
          },
