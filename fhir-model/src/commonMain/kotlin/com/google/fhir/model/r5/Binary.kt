...
import com.google.fhir.model.r5.serializers.BinarySerializer
...
public data class Binary(
   ...
   * (e.g. DocumentReference), or may be some non-related Resource purely as a security proxy. E.g.
   * to identify that the binary resource relates to a patient, and access should only be granted to
  ...
  public class Builder(
    /** MimeType of the binary content represented as a standard MimeType (BCP 13). */
    public var contentType: Code.Builder
  ) : Resource.Builder() {
    /**
     ...
     * sensitivity to use when deciding and enforcing access control rules for the Binary resource.
     * Given that the Binary resource contains very few elements that can be used to determine the
     * sensitivity of the data and relationships to individuals, the referenced resource stands in
     * as a proxy equivalent for this purpose. This referenced resource may be related to the Binary
     * (e.g. DocumentReference), or may be some non-related Resource purely as a security proxy.
     * E.g. to identify that the binary resource relates to a patient, and access should only be
     ...
     * than any of the resources that reference it.
     */
    public var securityContext: Reference.Builder? = null

    /**
     * The actual content, base64 encoded.
     *
     * If the content type is itself base64 encoding, then this will be base64 encoded twice - what
     * is created by un-base64ing the content must be the specified content type.
     */
    public var `data`: Base64Binary.Builder? = null

    override fun build(): Binary =
      Binary(
        id = id,
        meta = meta?.build(),
