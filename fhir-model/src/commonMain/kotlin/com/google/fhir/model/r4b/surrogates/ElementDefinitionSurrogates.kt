...
internal data class ElementDefinitionSlicingDiscriminatorSurrogate(
  ...
  public fun toModel(): ElementDefinition.Slicing.Discriminator =
    ElementDefinition.Slicing.Discriminator(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4b.ElementDefinition.DiscriminatorType.fromCode(
...
internal data class ElementDefinitionSlicingSurrogate(
  ...
  public fun toModel(): ElementDefinition.Slicing =
    ElementDefinition.Slicing(
      ...
      rules =
        Enumeration.of(
          com.google.fhir.model.r4b.ElementDefinition.SlicingRules.fromCode(
    ...
    public fun fromModel(model: ElementDefinition.Slicing): ElementDefinitionSlicingSurrogate =
      with(model) {
        ElementDefinitionSlicingSurrogate(
          id = this@with.id,
          extension = this@with.extension.takeUnless { it.isEmpty() },
          discriminator = this@with.discriminator.takeUnless { it.isEmpty() },
    ...
    ElementDefinition.Type(
        ...
        if (
          ...
          (this@ElementDefinitionTypeSurrogate.aggregation
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4b.ElementDefinition.AggregationMode.fromCode(it!!)
                },
                element,
              )
            }
      ...
      versioning =
        this@ElementDefinitionTypeSurrogate.versioning?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.ElementDefinition.ReferenceVersionRules.fromCode(it!!),
        ...
        ElementDefinitionTypeSurrogate(
          ...
          _profile =
            this@with.profile
              ...
              ?.toMutableList(),
          targetProfile =
            this@with.targetProfile.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _targetProfile =
    ...
    ElementDefinition.Example(
      ...
      `value` =
        ElementDefinition.Example.Value.from(
          ...
          this@ElementDefinitionExampleSurrogate.valueContributor,
...
internal data class ElementDefinitionConstraintSurrogate(
  ...
  public fun toModel(): ElementDefinition.Constraint =
    ElementDefinition.Constraint(
      ...
      severity =
        Enumeration.of(
          com.google.fhir.model.r4b.ElementDefinition.ConstraintSeverity.fromCode(
...
internal data class ElementDefinitionBindingSurrogate(
  public var id: KotlinString? = null,
  public var extension: MutableList<Extension>? = null,
  public var strength: KotlinString?,
...
internal data class ElementDefinitionMappingSurrogate(
  public var id: KotlinString? = null,
  public var extension: MutableList<Extension>? = null,
  public var identity: KotlinString?,
  public var _identity: Element? = null,
  public var language: KotlinString? = null,
  public var _language: Element? = null,
  public var map: KotlinString?,
...
internal data class ElementDefinitionSurrogate(
  ...
  public fun toModel(): ElementDefinition =
    ElementDefinition(
      ...
      path =
        R4bString.of(this@ElementDefinitionSurrogate.path!!, this@ElementDefinitionSurrogate._path),
      representation =
        if (
          ...
          (this@ElementDefinitionSurrogate.representation
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4b.ElementDefinition.PropertyRepresentation.fromCode(it!!)
                },
                element,
              )
            }
      ...
      label =
        R4bString.ofNullable(
          this@ElementDefinitionSurrogate.label,
          this@ElementDefinitionSurrogate._label,
        ),
      code = this@ElementDefinitionSurrogate.code ?: mutableListOf(),
      slicing = this@ElementDefinitionSurrogate.slicing,
      short =
        R4bString.ofNullable(
          this@ElementDefinitionSurrogate.short,
          this@ElementDefinitionSurrogate._short,
        ),
      definition =
        Markdown.ofNullable(
      ...
      min =
        UnsignedInt.ofNullable(
          this@ElementDefinitionSurrogate.min,
          this@ElementDefinitionSurrogate._min,
        ),
      max =
        R4bString.ofNullable(
          this@ElementDefinitionSurrogate.max,
          this@ElementDefinitionSurrogate._max,
        ),
      ...
      defaultValue =
        ElementDefinition.DefaultValue?.fromNullable(
          ...
          this@ElementDefinitionSurrogate.defaultValueContributor,
      ...
      fixed =
        ElementDefinition.Fixed?.fromNullable(
          Base64Binary.ofNullable(
          ...
          Id.ofNullable(
            this@ElementDefinitionSurrogate.fixedId,
            this@ElementDefinitionSurrogate._fixedId,
          ),
          Instant.ofNullable(
          ...
          this@ElementDefinitionSurrogate.fixedContributor,
      ...
      minValue =
        ElementDefinition.MinValue?.fromNullable(
          Date.ofNullable(
      ...
      maxValue =
        ElementDefinition.MaxValue?.fromNullable(
          Date.ofNullable(
    ...
    public fun fromModel(model: ElementDefinition): ElementDefinitionSurrogate =
      with(model) {
        ElementDefinitionSurrogate(
          ...
          fixedContributor = this@with.fixed?.asContributor()?.value,
          ...
          example = this@with.example.takeUnless { it.isEmpty() },
          ...
          condition =
            this@with.condition.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _condition =
            this@with.condition
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ?.map { it ?: Element() }
              ?.toMutableList(),
          constraint = this@with.constraint.takeUnless { it.isEmpty() },
          ...
          mapping = this@with.mapping.takeUnless { it.isEmpty() },
        )
      }
  }
}
