      ...
      type =
        Enumeration.of(
          this@ElementDefinitionSlicingDiscriminatorSurrogate.type?.let {
            com.google.fhir.model.r4b.ElementDefinition.DiscriminatorType.fromCode(it)
          },
      ...
      rules =
        Enumeration.of(
          this@ElementDefinitionSlicingSurrogate.rules?.let {
            com.google.fhir.model.r4b.ElementDefinition.SlicingRules.fromCode(it)
          },
      ...
      severity =
        Enumeration.of(
          this@ElementDefinitionConstraintSurrogate.severity?.let {
            com.google.fhir.model.r4b.ElementDefinition.ConstraintSeverity.fromCode(it)
          },
...
internal data class ElementDefinitionSurrogate(
  ...
  public fun toModel(): ElementDefinition =
    ElementDefinition().apply {
      ...
      label =
        R4bString.of(this@ElementDefinitionSurrogate.label, this@ElementDefinitionSurrogate._label)
      code = this@ElementDefinitionSurrogate.code
      slicing = this@ElementDefinitionSurrogate.slicing
      short =
        R4bString.of(this@ElementDefinitionSurrogate.short, this@ElementDefinitionSurrogate._short)
      definition =
        Markdown.of(
      ...
      max = R4bString.of(this@ElementDefinitionSurrogate.max, this@ElementDefinitionSurrogate._max)
