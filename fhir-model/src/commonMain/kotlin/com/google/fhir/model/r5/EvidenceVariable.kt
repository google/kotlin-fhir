        ...
        public companion object {
          public fun from(
            ...
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value"
            )
          }
      ...
      public sealed interface Event {
        ...
        public companion object {
          public fun from(
            ...
            if (idValue != null) return Id(idValue)
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.EvidenceVariable.Characteristic.TimeFromEvent.Event"
            )
          }
    ...
    public sealed interface Instances {
      ...
      public companion object {
        public fun from(
          ...
          if (RangeValue != null) return Range(RangeValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.EvidenceVariable.Characteristic.Instances"
          )
        }
    ...
    public sealed interface Duration {
      ...
      public companion object {
        public fun from(
          ...
          if (RangeValue != null) return Range(RangeValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.EvidenceVariable.Characteristic.Duration"
          )
        }
    ...
    public sealed interface Value {
      ...
      public companion object {
        public fun from(
          ...
          if (RangeValue != null) return Range(RangeValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.EvidenceVariable.Category.Value"
          )
        }
  ...
  public sealed interface VersionAlgorithm {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.EvidenceVariable.VersionAlgorithm"
        )
      }
