...
internal data class PlanDefinitionGoalTargetSurrogate(
  ...
  public fun toModel(): PlanDefinition.Goal.Target =
    PlanDefinition.Goal.Target(
      ...
      detail =
        PlanDefinition.Goal.Target.Detail?.fromNullable(
    ...
    public fun fromModel(model: PlanDefinition.Goal): PlanDefinitionGoalSurrogate =
      with(model) {
        PlanDefinitionGoalSurrogate(
          ...
          addresses = this@with.addresses.takeUnless { it.isEmpty() },
          documentation = this@with.documentation.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(model: PlanDefinition.Actor): PlanDefinitionActorSurrogate =
      with(model) {
        PlanDefinitionActorSurrogate(
          ...
          option = this@with.option.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class PlanDefinitionActionRelatedActionSurrogate(
  ...
  public var relationship: KotlinString?,
  ...
  public fun toModel(): PlanDefinition.Action.RelatedAction =
    PlanDefinition.Action.RelatedAction(
      ...
      offset =
        PlanDefinition.Action.RelatedAction.Offset?.fromNullable(
...
internal data class PlanDefinitionActionSurrogate(
  ...
  public fun toModel(): PlanDefinition.Action =
    PlanDefinition.Action(
      ...
      subject =
        PlanDefinition.Action.Subject?.fromNullable(
      ...
      timing =
        PlanDefinition.Action.Timing?.fromNullable(
      ...
      definition =
        PlanDefinition.Action.Definition?.fromNullable(
          Canonical.ofNullable(
    ...
    public fun fromModel(model: PlanDefinition.Action): PlanDefinitionActionSurrogate =
      with(model) {
        PlanDefinitionActionSurrogate(
          ...
          documentation = this@with.documentation.takeUnless { it.isEmpty() },
          goalId = this@with.goalId.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _goalId =
            this@with.goalId
              .map { it.toElement() }
          ...
          trigger = this@with.trigger.takeUnless { it.isEmpty() },
          condition = this@with.condition.takeUnless { it.isEmpty() },
          input = this@with.input.takeUnless { it.isEmpty() },
          output = this@with.output.takeUnless { it.isEmpty() },
          relatedAction = this@with.relatedAction.takeUnless { it.isEmpty() },
          ...
          participant = this@with.participant.takeUnless { it.isEmpty() },
          type = this@with.type,
          ...
          dynamicValue = this@with.dynamicValue.takeUnless { it.isEmpty() },
...
internal data class PlanDefinitionSurrogate(
  ...
  public fun toModel(): PlanDefinition =
    PlanDefinition(
      ...
      language =
        Code.ofNullable(
          this@PlanDefinitionSurrogate.language,
          this@PlanDefinitionSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@PlanDefinitionSurrogate.url, this@PlanDefinitionSurrogate._url),
      identifier = this@PlanDefinitionSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@PlanDefinitionSurrogate.version,
          this@PlanDefinitionSurrogate._version,
        ),
      versionAlgorithm =
        PlanDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name =
        R5String.ofNullable(this@PlanDefinitionSurrogate.name, this@PlanDefinitionSurrogate._name),
      title =
        R5String.ofNullable(
          this@PlanDefinitionSurrogate.title,
          this@PlanDefinitionSurrogate._title,
        ),
      subtitle =
        R5String.ofNullable(
          this@PlanDefinitionSurrogate.subtitle,
          this@PlanDefinitionSurrogate._subtitle,
        ),
      ...
      subject =
        PlanDefinition.Subject?.fromNullable(
      ...
      purpose =
        Markdown.ofNullable(
          this@PlanDefinitionSurrogate.purpose,
          this@PlanDefinitionSurrogate._purpose,
        ),
      usage =
        Markdown.ofNullable(
          this@PlanDefinitionSurrogate.usage,
          this@PlanDefinitionSurrogate._usage,
        ),
      copyright =
        Markdown.ofNullable(
      ...
      asNeeded =
        PlanDefinition.AsNeeded?.fromNullable(
          R5Boolean.ofNullable(
        ...
        PlanDefinitionSurrogate(
          ...
          _library =
            this@with.library
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          goal = this@with.goal.takeUnless { it.isEmpty() },
          actor = this@with.actor.takeUnless { it.isEmpty() },
          action = this@with.action.takeUnless { it.isEmpty() },
