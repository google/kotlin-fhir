...
import com.google.fhir.model.r4.surrogates.ClinicalImpressionFindingSurrogate
import com.google.fhir.model.r4.surrogates.ClinicalImpressionInvestigationSurrogate
import com.google.fhir.model.r4.surrogates.ClinicalImpressionSurrogate
...
public object ClinicalImpressionSerializer : KSerializer<ClinicalImpression> {
  ...
  override fun serialize(encoder: Encoder, `value`: ClinicalImpression) {
    surrogateSerializer.serialize(encoder, ClinicalImpressionSurrogate.fromModel(value))
  }
}
