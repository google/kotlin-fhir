...
internal data class QuestionnaireItemEnableWhenSurrogate(
  ...
  public var question: KotlinString?,
  public var _question: Element? = null,
  public var `operator`: KotlinString?,
  ...
  public fun toModel(): Questionnaire.Item.EnableWhen =
    Questionnaire.Item.EnableWhen(
      ...
      `operator` =
        Enumeration.of(
          com.google.fhir.model.r5.Questionnaire.QuestionnaireItemOperator.fromCode(
...
internal data class QuestionnaireItemSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var linkId: KotlinString?,
  ...
  public fun toModel(): Questionnaire.Item =
    Questionnaire.Item(
      ...
      text =
        R5String.ofNullable(
          this@QuestionnaireItemSurrogate.text,
          this@QuestionnaireItemSurrogate._text,
        ),
      type =
        Enumeration.of(
          com.google.fhir.model.r5.Questionnaire.QuestionnaireItemType.fromCode(
    ...
    public fun fromModel(model: Questionnaire.Item): QuestionnaireItemSurrogate =
      with(model) {
        QuestionnaireItemSurrogate(
          ...
          enableWhen = this@with.enableWhen.takeUnless { it.isEmpty() },
          ...
          answerOption = this@with.answerOption.takeUnless { it.isEmpty() },
          initial = this@with.initial.takeUnless { it.isEmpty() },
...
internal data class QuestionnaireSurrogate(
  ...
  public fun toModel(): Questionnaire =
    Questionnaire(
      ...
      language =
        Code.ofNullable(
          this@QuestionnaireSurrogate.language,
          this@QuestionnaireSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@QuestionnaireSurrogate.url, this@QuestionnaireSurrogate._url),
      identifier = this@QuestionnaireSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@QuestionnaireSurrogate.version,
          this@QuestionnaireSurrogate._version,
        ),
      versionAlgorithm =
        Questionnaire.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name =
        R5String.ofNullable(this@QuestionnaireSurrogate.name, this@QuestionnaireSurrogate._name),
      title =
        R5String.ofNullable(this@QuestionnaireSurrogate.title, this@QuestionnaireSurrogate._title),
      derivedFrom =
        if (
      ...
      publisher =
        R5String.ofNullable(
          this@QuestionnaireSurrogate.publisher,
          this@QuestionnaireSurrogate._publisher,
        ),
      ...
      purpose =
        Markdown.ofNullable(
          this@QuestionnaireSurrogate.purpose,
          this@QuestionnaireSurrogate._purpose,
        ),
      copyright =
        Markdown.ofNullable(
          this@QuestionnaireSurrogate.copyright,
          this@QuestionnaireSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
