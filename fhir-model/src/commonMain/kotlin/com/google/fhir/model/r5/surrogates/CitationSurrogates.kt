    ...
    public fun fromModel(model: Citation.Classification): CitationClassificationSurrogate =
      with(model) {
        CitationClassificationSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          type = this@with.type,
          classifier = this@with.classifier.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        CitationCitedArtifactPublicationFormSurrogate(
          ...
          language = this@with.language.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        CitationCitedArtifactClassificationSurrogate(
          ...
          type = this@with.type,
          classifier = this@with.classifier.takeUnless { it.isEmpty() },
          artifactAssessment = this@with.artifactAssessment.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        CitationCitedArtifactContributorshipEntrySurrogate(
          ...
          affiliation = this@with.affiliation.takeUnless { it.isEmpty() },
          contributionType = this@with.contributionType.takeUnless { it.isEmpty() },
          role = this@with.role,
          contributionInstance = this@with.contributionInstance.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        CitationCitedArtifactContributorshipSurrogate(
          ...
          entry = this@with.entry.takeUnless { it.isEmpty() },
          summary = this@with.summary.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: Citation.CitedArtifact): CitationCitedArtifactSurrogate =
      with(model) {
        CitationCitedArtifactSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          identifier = this@with.identifier.takeUnless { it.isEmpty() },
          relatedIdentifier = this@with.relatedIdentifier.takeUnless { it.isEmpty() },
          ...
          currentState = this@with.currentState.takeUnless { it.isEmpty() },
          statusDate = this@with.statusDate.takeUnless { it.isEmpty() },
          title = this@with.title.takeUnless { it.isEmpty() },
          `abstract` = this@with.`abstract`.takeUnless { it.isEmpty() },
          part = this@with.part,
          relatesTo = this@with.relatesTo.takeUnless { it.isEmpty() },
          publicationForm = this@with.publicationForm.takeUnless { it.isEmpty() },
          webLocation = this@with.webLocation.takeUnless { it.isEmpty() },
...
internal data class CitationSurrogate(
  ...
  public fun toModel(): Citation =
    Citation(
      ...
      implicitRules =
        Uri.ofNullable(this@CitationSurrogate.implicitRules, this@CitationSurrogate._implicitRules),
      language = Code.ofNullable(this@CitationSurrogate.language, this@CitationSurrogate._language),
      ...
      url = Uri.ofNullable(this@CitationSurrogate.url, this@CitationSurrogate._url),
      identifier = this@CitationSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@CitationSurrogate.version, this@CitationSurrogate._version),
      versionAlgorithm =
        Citation.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@CitationSurrogate.name, this@CitationSurrogate._name),
      title = R5String.ofNullable(this@CitationSurrogate.title, this@CitationSurrogate._title),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@CitationSurrogate.experimental,
          this@CitationSurrogate._experimental,
        ),
      date =
        DateTime.ofNullable(
      ...
      publisher =
        R5String.ofNullable(this@CitationSurrogate.publisher, this@CitationSurrogate._publisher),
      contact = this@CitationSurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(
          this@CitationSurrogate.description,
          this@CitationSurrogate._description,
        ),
      useContext = this@CitationSurrogate.useContext ?: mutableListOf(),
      jurisdiction = this@CitationSurrogate.jurisdiction ?: mutableListOf(),
      purpose =
        Markdown.ofNullable(this@CitationSurrogate.purpose, this@CitationSurrogate._purpose),
      copyright =
        Markdown.ofNullable(this@CitationSurrogate.copyright, this@CitationSurrogate._copyright),
      copyrightLabel =
        R5String.ofNullable(
          this@CitationSurrogate.copyrightLabel,
          this@CitationSurrogate._copyrightLabel,
        ),
      approvalDate =
        Date.ofNullable(
