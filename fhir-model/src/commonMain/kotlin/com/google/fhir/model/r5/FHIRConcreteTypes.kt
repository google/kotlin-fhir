...
public enum class FHIRConcreteTypes(
  ...
  public companion object {
    public fun fromCode(code: kotlin.String): FHIRConcreteTypes =
      when (code) {
        "Address" -> Address
        ...
        else -> throw IllegalArgumentException("Unknown code $code for enum FHIRConcreteTypes")
      }
  }
}
