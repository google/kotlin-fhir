      ...
      use =
        Enumeration.of(
          this@OperationDefinitionParameterSurrogate.use?.let {
            com.google.fhir.model.r4.OperationDefinition.OperationParameterUse.fromCode(it)
          },
...
internal data class OperationDefinitionSurrogate(
  ...
  public fun toModel(): OperationDefinition =
    OperationDefinition().apply {
      ...
      name =
        R4String.of(this@OperationDefinitionSurrogate.name, this@OperationDefinitionSurrogate._name)
      title =
        R4String.of(
      ...
      kind =
        Enumeration.of(
          this@OperationDefinitionSurrogate.kind?.let {
            com.google.fhir.model.r4.OperationDefinition.OperationKind.fromCode(it)
          },
