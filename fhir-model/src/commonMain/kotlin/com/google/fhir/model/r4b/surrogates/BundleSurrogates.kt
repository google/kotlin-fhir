...
internal data class BundleLinkSurrogate(
  ...
  public fun toModel(): Bundle.Link =
    Bundle.Link().apply {
      ...
      relation = R4bString.of(this@BundleLinkSurrogate.relation, this@BundleLinkSurrogate._relation)
      ...
      method =
        Enumeration.of(
          this@BundleEntryRequestSurrogate.method?.let {
            com.google.fhir.model.r4b.Bundle.HTTPVerb.fromCode(it)
          },
      ...
      type =
        Enumeration.of(
          this@BundleSurrogate.type?.let {
            com.google.fhir.model.r4b.Bundle.BundleType.fromCode(it)
          },
