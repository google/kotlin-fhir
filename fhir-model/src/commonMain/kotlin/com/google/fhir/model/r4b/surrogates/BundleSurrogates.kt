...
internal data class BundleLinkSurrogate(
  ...
  public var relation: KotlinString?,
  ...
  public fun toModel(): Bundle.Link =
    Bundle.Link(
      ...
      relation =
        R4bString.of(this@BundleLinkSurrogate.relation!!, this@BundleLinkSurrogate._relation),
    ...
    Bundle.Entry.Search(
      ...
      mode =
        this@BundleEntrySearchSurrogate.mode?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.Bundle.SearchEntryMode.fromCode(it!!),
            this@BundleEntrySearchSurrogate._mode,
          )
        },
      score =
        Decimal.ofNullable(
          this@BundleEntrySearchSurrogate.score,
          this@BundleEntrySearchSurrogate._score,
        ),
    )
...
internal data class BundleEntryRequestSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var method: KotlinString?,
  ...
  public fun toModel(): Bundle.Entry.Request =
    Bundle.Entry.Request(
      ...
      method =
        Enumeration.of(
          com.google.fhir.model.r4b.Bundle.HTTPVerb.fromCode(
...
internal data class BundleEntrySurrogate(
  ...
  public fun toModel(): Bundle.Entry =
    Bundle.Entry(
      ...
      fullUrl =
        Uri.ofNullable(this@BundleEntrySurrogate.fullUrl, this@BundleEntrySurrogate._fullUrl),
...
internal data class BundleSurrogate(
  ...
  public fun toModel(): Bundle =
    Bundle(
      ...
      implicitRules =
        Uri.ofNullable(this@BundleSurrogate.implicitRules, this@BundleSurrogate._implicitRules),
      language = Code.ofNullable(this@BundleSurrogate.language, this@BundleSurrogate._language),
      identifier = this@BundleSurrogate.identifier,
      type =
        Enumeration.of(
          com.google.fhir.model.r4b.Bundle.BundleType.fromCode(this@BundleSurrogate.type!!),
      ...
      total = UnsignedInt.ofNullable(this@BundleSurrogate.total, this@BundleSurrogate._total),
