    ...
    Evidence.Statistic.ModelCharacteristic.Variable(
      ...
      handling =
        this@EvidenceStatisticModelCharacteristicVariableSurrogate.handling?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.Evidence.EvidenceVariableHandling.fromCode(it!!),
...
internal data class EvidenceSurrogate(
  ...
  public fun toModel(): Evidence =
    Evidence(
      ...
      version =
        R4bString.ofNullable(this@EvidenceSurrogate.version, this@EvidenceSurrogate._version),
      title = R4bString.ofNullable(this@EvidenceSurrogate.title, this@EvidenceSurrogate._title),
      citeAs =
      ...
      publisher =
        R4bString.ofNullable(this@EvidenceSurrogate.publisher, this@EvidenceSurrogate._publisher),
