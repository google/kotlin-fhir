...
internal data class DeviceUdiCarrierSurrogate(
  ...
  public fun toModel(): Device.UdiCarrier =
    Device.UdiCarrier(
      ...
      issuer =
        Uri.ofNullable(
          this@DeviceUdiCarrierSurrogate.issuer,
          this@DeviceUdiCarrierSurrogate._issuer,
        ),
      jurisdiction =
        Uri.ofNullable(
...
internal data class DeviceDeviceNameSurrogate(
  ...
  public fun toModel(): Device.DeviceName =
    Device.DeviceName(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4b.Device.DeviceNameType.fromCode(
    ...
    public fun fromModel(model: Device.Property): DevicePropertySurrogate =
      with(model) {
        DevicePropertySurrogate(
          ...
          valueCode = this@with.valueCode.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class DeviceSurrogate(
  ...
  public fun toModel(): Device =
    Device(
      ...
      manufacturer =
        R4bString.ofNullable(this@DeviceSurrogate.manufacturer, this@DeviceSurrogate._manufacturer),
      manufactureDate =
        DateTime.ofNullable(
      ...
      lotNumber =
        R4bString.ofNullable(this@DeviceSurrogate.lotNumber, this@DeviceSurrogate._lotNumber),
      serialNumber =
        R4bString.ofNullable(this@DeviceSurrogate.serialNumber, this@DeviceSurrogate._serialNumber),
      deviceName = this@DeviceSurrogate.deviceName ?: mutableListOf(),
      modelNumber =
        R4bString.ofNullable(this@DeviceSurrogate.modelNumber, this@DeviceSurrogate._modelNumber),
      partNumber =
        R4bString.ofNullable(this@DeviceSurrogate.partNumber, this@DeviceSurrogate._partNumber),
    ...
    public fun fromModel(model: Device): DeviceSurrogate =
      with(model) {
        DeviceSurrogate(
          ...
          statusReason = this@with.statusReason.takeUnless { it.isEmpty() },
          ...
          type = this@with.type,
          specialization = this@with.specialization.takeUnless { it.isEmpty() },
