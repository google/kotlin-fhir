...
internal data class RequirementsStatementSurrogate(
  ...
  public var requirement: KotlinString?,
    ...
    public fun fromModel(model: Requirements.Statement): RequirementsStatementSurrogate =
      with(model) {
        RequirementsStatementSurrogate(
          ...
          conformance =
            this@with.conformance.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _conformance =
          ...
          satisfiedBy =
            this@with.satisfiedBy.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _satisfiedBy =
...
internal data class RequirementsSurrogate(
  ...
  public fun toModel(): Requirements =
    Requirements(
      ...
      implicitRules =
        Uri.ofNullable(
          this@RequirementsSurrogate.implicitRules,
          this@RequirementsSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@RequirementsSurrogate.language, this@RequirementsSurrogate._language),
      ...
      url = Uri.ofNullable(this@RequirementsSurrogate.url, this@RequirementsSurrogate._url),
      identifier = this@RequirementsSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@RequirementsSurrogate.version,
          this@RequirementsSurrogate._version,
        ),
      versionAlgorithm =
        Requirements.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@RequirementsSurrogate.name, this@RequirementsSurrogate._name),
      title =
        R5String.ofNullable(this@RequirementsSurrogate.title, this@RequirementsSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R5String.ofNullable(
          this@RequirementsSurrogate.publisher,
          this@RequirementsSurrogate._publisher,
        ),
      ...
      purpose =
        Markdown.ofNullable(
          this@RequirementsSurrogate.purpose,
          this@RequirementsSurrogate._purpose,
        ),
      copyright =
        Markdown.ofNullable(
          this@RequirementsSurrogate.copyright,
          this@RequirementsSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
        ...
        RequirementsSurrogate(
          ...
          _reference =
            this@with.reference
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          actor = this@with.actor.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _actor =
            this@with.actor
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ?.map { it ?: Element() }
              ?.toMutableList(),
          statement = this@with.statement.takeUnless { it.isEmpty() },
        )
      }
  }
}
