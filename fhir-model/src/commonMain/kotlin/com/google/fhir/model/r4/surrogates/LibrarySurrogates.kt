...
internal data class LibrarySurrogate(
  ...
  public fun toModel(): Library =
    Library(
      ...
      version = R4String.ofNullable(this@LibrarySurrogate.version, this@LibrarySurrogate._version),
      name = R4String.ofNullable(this@LibrarySurrogate.name, this@LibrarySurrogate._name),
      title = R4String.ofNullable(this@LibrarySurrogate.title, this@LibrarySurrogate._title),
      subtitle =
        R4String.ofNullable(this@LibrarySurrogate.subtitle, this@LibrarySurrogate._subtitle),
      status =
        Enumeration.of(
      ...
      publisher =
        R4String.ofNullable(this@LibrarySurrogate.publisher, this@LibrarySurrogate._publisher),
      ...
      usage = R4String.ofNullable(this@LibrarySurrogate.usage, this@LibrarySurrogate._usage),
      copyright =
