      ...
      type =
        Enumeration.of(
          this@ActivityDefinitionParticipantSurrogate.type?.let {
            com.google.fhir.model.r4.ActivityDefinition.ActivityParticipantType.fromCode(it)
          },
...
internal data class ActivityDefinitionSurrogate(
  ...
  public fun toModel(): ActivityDefinition =
    ActivityDefinition().apply {
      ...
      title =
        R4String.of(this@ActivityDefinitionSurrogate.title, this@ActivityDefinitionSurrogate._title)
      subtitle =
        R4String.of(
      ...
      usage =
        R4String.of(this@ActivityDefinitionSurrogate.usage, this@ActivityDefinitionSurrogate._usage)
      copyright =
        Markdown.of(
