...
internal data class ActivityDefinitionParticipantSurrogate(
  ...
  public fun toModel(): ActivityDefinition.Participant =
    ActivityDefinition.Participant(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4.ActivityDefinition.ActivityParticipantType.fromCode(
...
internal data class ActivityDefinitionSurrogate(
  ...
  public fun toModel(): ActivityDefinition =
    ActivityDefinition(
      ...
      url =
        Uri.ofNullable(this@ActivityDefinitionSurrogate.url, this@ActivityDefinitionSurrogate._url),
      ...
      name =
        R4String.ofNullable(
          this@ActivityDefinitionSurrogate.name,
          this@ActivityDefinitionSurrogate._name,
        ),
      title =
        R4String.ofNullable(
      ...
      subject =
        ActivityDefinition.Subject?.fromNullable(
      ...
      kind =
        this@ActivityDefinitionSurrogate.kind?.let {
          Enumeration.of(
            com.google.fhir.model.r4.ActivityDefinition.ActivityDefinitionKind.fromCode(it!!),
      ...
      intent =
        this@ActivityDefinitionSurrogate.intent?.let {
          Enumeration.of(
            com.google.fhir.model.r4.ActivityDefinition.RequestIntent.fromCode(it!!),
      ...
      priority =
        this@ActivityDefinitionSurrogate.priority?.let {
          Enumeration.of(
            com.google.fhir.model.r4.ActivityDefinition.RequestPriority.fromCode(it!!),
      ...
      timing =
        ActivityDefinition.Timing?.fromNullable(
      ...
      product =
        ActivityDefinition.Product?.fromNullable(
    ...
    public fun fromModel(model: ActivityDefinition): ActivityDefinitionSurrogate =
      with(model) {
        ActivityDefinitionSurrogate(
          ...
          specimenRequirement = this@with.specimenRequirement.takeUnless { it.isEmpty() },
          observationRequirement = this@with.observationRequirement.takeUnless { it.isEmpty() },
          observationResultRequirement =
            this@with.observationResultRequirement.takeUnless { it.isEmpty() },
