...
internal data class DurationSurrogate(
  ...
  public fun toModel(): Duration =
    Duration(
      ...
      `value` = Decimal.ofNullable(this@DurationSurrogate.`value`, this@DurationSurrogate._value),
      comparator =
      ...
      unit = R4bString.ofNullable(this@DurationSurrogate.unit, this@DurationSurrogate._unit),
      system = Uri.ofNullable(this@DurationSurrogate.system, this@DurationSurrogate._system),
      code = Code.ofNullable(this@DurationSurrogate.code, this@DurationSurrogate._code),
    )
