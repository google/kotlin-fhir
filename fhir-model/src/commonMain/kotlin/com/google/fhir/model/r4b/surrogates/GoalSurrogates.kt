...
internal data class GoalSurrogate(
  ...
  public fun toModel(): Goal =
    Goal().apply {
      ...
      lifecycleStatus =
        Enumeration.of(
          this@GoalSurrogate.lifecycleStatus?.let {
            com.google.fhir.model.r4b.Goal.GoalLifecycleStatus.fromCode(it)
          },
      ...
      statusReason = R4bString.of(this@GoalSurrogate.statusReason, this@GoalSurrogate._statusReason)
