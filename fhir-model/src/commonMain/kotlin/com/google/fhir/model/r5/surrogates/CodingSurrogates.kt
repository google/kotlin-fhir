...
internal data class CodingSurrogate(
  ...
  public fun toModel(): Coding =
    Coding(
      ...
      version = R5String.ofNullable(this@CodingSurrogate.version, this@CodingSurrogate._version),
      code = Code.ofNullable(this@CodingSurrogate.code, this@CodingSurrogate._code),
      display = R5String.ofNullable(this@CodingSurrogate.display, this@CodingSurrogate._display),
      userSelected =
        R5Boolean.ofNullable(this@CodingSurrogate.userSelected, this@CodingSurrogate._userSelected),
    )
