...
internal data class ExpressionSurrogate(
  ...
  public var language: KotlinString?,
    ...
    Expression(
      ...
      description =
        R4bString.ofNullable(
          this@ExpressionSurrogate.description,
          this@ExpressionSurrogate._description,
        ),
      name = Id.ofNullable(this@ExpressionSurrogate.name, this@ExpressionSurrogate._name),
      language =
        Enumeration.of(
          com.google.fhir.model.r4b.Expression.ExpressionLanguage.fromCode(
      ...
      expression =
        R4bString.ofNullable(
          this@ExpressionSurrogate.expression,
          this@ExpressionSurrogate._expression,
        ),
      reference =
        Uri.ofNullable(this@ExpressionSurrogate.reference, this@ExpressionSurrogate._reference),
    )
