...
internal data class OperationOutcomeIssueSurrogate(
  ...
  public fun toModel(): OperationOutcome.Issue =
    OperationOutcome.Issue(
      ...
      severity =
        Enumeration.of(
          com.google.fhir.model.r4b.OperationOutcome.IssueSeverity.fromCode(
      ...
      code =
        Enumeration.of(
          com.google.fhir.model.r4b.OperationOutcome.IssueType.fromCode(
    ...
    public fun fromModel(model: OperationOutcome.Issue): OperationOutcomeIssueSurrogate =
      with(model) {
        OperationOutcomeIssueSurrogate(
          ...
          location =
            this@with.location.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _location =
            this@with.location
              .map { it.toElement() }
...
internal data class OperationOutcomeSurrogate(
  ...
  public fun toModel(): OperationOutcome =
    OperationOutcome(
      ...
      language =
        Code.ofNullable(
          this@OperationOutcomeSurrogate.language,
          this@OperationOutcomeSurrogate._language,
        ),
    ...
    public fun fromModel(model: OperationOutcome): OperationOutcomeSurrogate =
      with(model) {
        OperationOutcomeSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          issue = this@with.issue.takeUnless { it.isEmpty() },
        )
      }
  }
}
