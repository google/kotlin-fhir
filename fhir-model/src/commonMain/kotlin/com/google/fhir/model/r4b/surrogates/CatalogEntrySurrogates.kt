...
internal data class CatalogEntryRelatedEntrySurrogate(
  ...
  public fun toModel(): CatalogEntry.RelatedEntry =
    CatalogEntry.RelatedEntry(
      ...
      relationtype =
        Enumeration.of(
          com.google.fhir.model.r4b.CatalogEntry.CatalogEntryRelationType.fromCode(
...
internal data class CatalogEntrySurrogate(
  ...
  public var orderable: KotlinBoolean?,
  ...
  public fun toModel(): CatalogEntry =
    CatalogEntry(
      ...
      implicitRules =
        Uri.ofNullable(
          this@CatalogEntrySurrogate.implicitRules,
          this@CatalogEntrySurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@CatalogEntrySurrogate.language, this@CatalogEntrySurrogate._language),
    ...
    public fun fromModel(model: CatalogEntry): CatalogEntrySurrogate =
      with(model) {
        CatalogEntrySurrogate(
          ...
          additionalIdentifier = this@with.additionalIdentifier.takeUnless { it.isEmpty() },
          ...
          additionalCharacteristic = this@with.additionalCharacteristic.takeUnless { it.isEmpty() },
          additionalClassification = this@with.additionalClassification.takeUnless { it.isEmpty() },
          relatedEntry = this@with.relatedEntry.takeUnless { it.isEmpty() },
        )
      }
  }
}
