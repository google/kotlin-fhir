 ...
 * activity.
 */
public enum class ProvenanceAgentType(
  ...
  public companion object {
    public fun fromCode(code: String): ProvenanceAgentType =
      when (code) {
        "enterer" -> Enterer
        "performer" -> Performer
        "author" -> Author
        ...
        "humanuser" -> Humanuser
        else -> throw IllegalArgumentException("Unknown code $code for enum ProvenanceAgentType")
      }
  }
}
