...
internal data class TestPlanTestCaseTestRunScriptSurrogate(
  ...
  public fun toModel(): TestPlan.TestCase.TestRun.Script =
    TestPlan.TestCase.TestRun.Script(
      ...
      source =
        TestPlan.TestCase.TestRun.Script.Source?.fromNullable(
          R5String.ofNullable(
...
internal data class TestPlanTestCaseTestDataSurrogate(
  ...
  public fun toModel(): TestPlan.TestCase.TestData =
    TestPlan.TestCase.TestData(
      ...
      source =
        TestPlan.TestCase.TestData.Source?.fromNullable(
          R5String.ofNullable(
    ...
    public fun fromModel(model: TestPlan.TestCase.Assertion): TestPlanTestCaseAssertionSurrogate =
      with(model) {
        TestPlanTestCaseAssertionSurrogate(
          ...
          `object` = this@with.`object`.takeUnless { it.isEmpty() },
          result = this@with.result.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: TestPlan.TestCase): TestPlanTestCaseSurrogate =
      with(model) {
        TestPlanTestCaseSurrogate(
          ...
          dependency = this@with.dependency.takeUnless { it.isEmpty() },
          testRun = this@with.testRun.takeUnless { it.isEmpty() },
          testData = this@with.testData.takeUnless { it.isEmpty() },
          assertion = this@with.assertion.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class TestPlanSurrogate(
  ...
  public fun toModel(): TestPlan =
    TestPlan(
      ...
      implicitRules =
        Uri.ofNullable(this@TestPlanSurrogate.implicitRules, this@TestPlanSurrogate._implicitRules),
      language = Code.ofNullable(this@TestPlanSurrogate.language, this@TestPlanSurrogate._language),
      ...
      url = Uri.ofNullable(this@TestPlanSurrogate.url, this@TestPlanSurrogate._url),
      identifier = this@TestPlanSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@TestPlanSurrogate.version, this@TestPlanSurrogate._version),
      versionAlgorithm =
        TestPlan.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@TestPlanSurrogate.name, this@TestPlanSurrogate._name),
      title = R5String.ofNullable(this@TestPlanSurrogate.title, this@TestPlanSurrogate._title),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@TestPlanSurrogate.experimental,
          this@TestPlanSurrogate._experimental,
        ),
      date =
        DateTime.ofNullable(
      ...
      publisher =
        R5String.ofNullable(this@TestPlanSurrogate.publisher, this@TestPlanSurrogate._publisher),
      contact = this@TestPlanSurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(
          this@TestPlanSurrogate.description,
          this@TestPlanSurrogate._description,
        ),
      useContext = this@TestPlanSurrogate.useContext ?: mutableListOf(),
      jurisdiction = this@TestPlanSurrogate.jurisdiction ?: mutableListOf(),
      purpose =
        Markdown.ofNullable(this@TestPlanSurrogate.purpose, this@TestPlanSurrogate._purpose),
      copyright =
        Markdown.ofNullable(this@TestPlanSurrogate.copyright, this@TestPlanSurrogate._copyright),
      copyrightLabel =
        R5String.ofNullable(
          this@TestPlanSurrogate.copyrightLabel,
          this@TestPlanSurrogate._copyrightLabel,
        ),
      category = this@TestPlanSurrogate.category ?: mutableListOf(),
      scope = this@TestPlanSurrogate.scope ?: mutableListOf(),
      testTools =
        Markdown.ofNullable(this@TestPlanSurrogate.testTools, this@TestPlanSurrogate._testTools),
      dependency = this@TestPlanSurrogate.dependency ?: mutableListOf(),
      exitCriteria =
        Markdown.ofNullable(
          this@TestPlanSurrogate.exitCriteria,
          this@TestPlanSurrogate._exitCriteria,
        ),
    ...
    public fun fromModel(model: TestPlan): TestPlanSurrogate =
      with(model) {
        TestPlanSurrogate(
          ...
          testCase = this@with.testCase.takeUnless { it.isEmpty() },
        )
      }
  }
}
