...
internal data class ServiceRequestPatientInstructionSurrogate(
  ...
  public fun toModel(): ServiceRequest.PatientInstruction =
    ServiceRequest.PatientInstruction(
      ...
      instruction =
        ServiceRequest.PatientInstruction.Instruction?.fromNullable(
          Markdown.ofNullable(
...
internal data class ServiceRequestSurrogate(
  ...
  public fun toModel(): ServiceRequest =
    ServiceRequest(
      ...
      language =
        Code.ofNullable(
          this@ServiceRequestSurrogate.language,
          this@ServiceRequestSurrogate._language,
        ),
      ...
      quantity =
        ServiceRequest.Quantity?.fromNullable(
      ...
      occurrence =
        ServiceRequest.Occurrence?.fromNullable(
          DateTime.ofNullable(
      ...
      asNeeded =
        ServiceRequest.AsNeeded?.fromNullable(
          R5Boolean.ofNullable(
    ...
    public fun fromModel(model: ServiceRequest): ServiceRequestSurrogate =
      with(model) {
        ServiceRequestSurrogate(
          ...
          code = this@with.code,
          orderDetail = this@with.orderDetail.takeUnless { it.isEmpty() },
