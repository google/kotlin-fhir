...
internal data class DeviceNameSurrogate(
  ...
  public fun toModel(): Device.Name =
    Device.Name(
      ...
      display =
        R5Boolean.ofNullable(this@DeviceNameSurrogate.display, this@DeviceNameSurrogate._display),
    )
...
internal data class DeviceConformsToSurrogate(
  ...
  public fun toModel(): Device.ConformsTo =
    Device.ConformsTo(
      ...
      version =
        R5String.ofNullable(
          this@DeviceConformsToSurrogate.version,
          this@DeviceConformsToSurrogate._version,
        ),
    )
...
internal data class DeviceSurrogate(
  ...
  public fun toModel(): Device =
    Device(
      ...
      implicitRules =
        Uri.ofNullable(this@DeviceSurrogate.implicitRules, this@DeviceSurrogate._implicitRules),
      language = Code.ofNullable(this@DeviceSurrogate.language, this@DeviceSurrogate._language),
      ...
      displayName =
        R5String.ofNullable(this@DeviceSurrogate.displayName, this@DeviceSurrogate._displayName),
      ...
      manufacturer =
        R5String.ofNullable(this@DeviceSurrogate.manufacturer, this@DeviceSurrogate._manufacturer),
      manufactureDate =
        DateTime.ofNullable(
      ...
      lotNumber =
        R5String.ofNullable(this@DeviceSurrogate.lotNumber, this@DeviceSurrogate._lotNumber),
      serialNumber =
        R5String.ofNullable(this@DeviceSurrogate.serialNumber, this@DeviceSurrogate._serialNumber),
      name = this@DeviceSurrogate.name ?: mutableListOf(),
      modelNumber =
        R5String.ofNullable(this@DeviceSurrogate.modelNumber, this@DeviceSurrogate._modelNumber),
      partNumber =
        R5String.ofNullable(this@DeviceSurrogate.partNumber, this@DeviceSurrogate._partNumber),
      ...
      url = Uri.ofNullable(this@DeviceSurrogate.url, this@DeviceSurrogate._url),
    ...
    public fun fromModel(model: Device): DeviceSurrogate =
      with(model) {
        DeviceSurrogate(
          ...
          udiCarrier = this@with.udiCarrier.takeUnless { it.isEmpty() },
          ...
          name = this@with.name.takeUnless { it.isEmpty() },
          ...
          gateway = this@with.gateway.takeUnless { it.isEmpty() },
