...
internal data class SubscriptionChannelSurrogate(
  ...
  public fun toModel(): Subscription.Channel =
    Subscription.Channel(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4.Subscription.SubscriptionChannelType.fromCode(
...
internal data class SubscriptionSurrogate(
  ...
  public var reason: KotlinString?,
  public var _reason: Element? = null,
  public var criteria: KotlinString?,
  ...
  public fun toModel(): Subscription =
    Subscription(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Subscription.SubscriptionStatus.fromCode(
      ...
      error =
        R4String.ofNullable(this@SubscriptionSurrogate.error, this@SubscriptionSurrogate._error),
