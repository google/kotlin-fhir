...
internal data class ImagingSelectionInstanceImageRegion2DSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var regionType: KotlinString?,
    ...
    public fun fromModel(
      ...
      with(model) {
        ImagingSelectionInstanceImageRegion2DSurrogate(
          ...
          coordinate =
            this@with.coordinate.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _coordinate =
    ...
    public fun fromModel(model: ImagingSelection.Instance): ImagingSelectionInstanceSurrogate =
      with(model) {
        ImagingSelectionInstanceSurrogate(
          ...
          subset = this@with.subset.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _subset =
            this@with.subset
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ?.map { it ?: Element() }
              ?.toMutableList(),
          imageRegion2D = this@with.imageRegion2D.takeUnless { it.isEmpty() },
          imageRegion3D = this@with.imageRegion3D.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ImagingSelectionSurrogate(
  ...
  public fun toModel(): ImagingSelection =
    ImagingSelection(
      ...
      language =
        Code.ofNullable(
          this@ImagingSelectionSurrogate.language,
          this@ImagingSelectionSurrogate._language,
        ),
      ...
      studyUid =
        Id.ofNullable(
          this@ImagingSelectionSurrogate.studyUid,
          this@ImagingSelectionSurrogate._studyUid,
        ),
      ...
      seriesUid =
        Id.ofNullable(
          this@ImagingSelectionSurrogate.seriesUid,
          this@ImagingSelectionSurrogate._seriesUid,
        ),
      seriesNumber =
        UnsignedInt.ofNullable(
