...
public data class SubscriptionStatus(
   ...
   */
  public val eventsSinceSubscriptionStart: Integer64? = null,
  ...
  public class NotificationEvent(
     ...
     */
    public val eventNumber: Integer64,
    ...
    public class Builder(
       ...
       *
       * In subscriptions where delivery of notifications IS NOT guaranteed (e.g., REST-Hook), this
       * number is a unique and monotonically-increasing event number for a subscription. In
       * channels where delivery of notifications IS guaranteed, this number is a relative index for
       * the events present in the notification (e.g., 1, 2, etc.).
       */
      public var eventNumber: Integer64.Builder
    ) {
      /**
  ...
  public class Builder(
     ...
     */
    public var eventsSinceSubscriptionStart: Integer64.Builder? = null
