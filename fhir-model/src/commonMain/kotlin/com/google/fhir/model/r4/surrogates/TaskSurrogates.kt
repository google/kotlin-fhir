    ...
    Task.Input().apply {
      ...
      `value` =
        Task.Input.Value?.from(
          ...
          R4Boolean.of(this@TaskInputSurrogate.valueBoolean, this@TaskInputSurrogate._valueBoolean),
          Canonical.of(
    ...
    Task.Output().apply {
      ...
      `value` =
        Task.Output.Value?.from(
          ...
          R4String.of(this@TaskOutputSurrogate.valueString, this@TaskOutputSurrogate._valueString),
...
internal data class TaskSurrogate(
  ...
  public fun toModel(): Task =
    Task().apply {
      ...
      status =
        Enumeration.of(
          this@TaskSurrogate.status?.let { com.google.fhir.model.r4.Task.TaskStatus.fromCode(it) },
      ...
      intent =
        Enumeration.of(
          this@TaskSurrogate.intent?.let { com.google.fhir.model.r4.Task.TaskIntent.fromCode(it) },
