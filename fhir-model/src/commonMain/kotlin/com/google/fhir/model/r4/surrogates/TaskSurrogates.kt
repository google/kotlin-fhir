    ...
    Task.Input(
      ...
      `value` =
        Task.Input.Value.from(
          ...
          R4String.of(this@TaskInputSurrogate.valueString!!, this@TaskInputSurrogate._valueString),
...
internal data class TaskSurrogate(
  ...
  public fun toModel(): Task =
    Task(
      ...
      description =
        R4String.ofNullable(this@TaskSurrogate.description, this@TaskSurrogate._description),
