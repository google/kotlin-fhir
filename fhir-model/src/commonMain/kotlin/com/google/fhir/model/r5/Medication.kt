...
public data class Medication(
  ...
  public enum class MedicationStatus(
    ...
    Active("active", "http://hl7.org/fhir/CodeSystem/medication-status", "Active", null),
    Inactive("inactive", "http://hl7.org/fhir/CodeSystem/medication-status", "Inactive", null),
    Entered_In_Error(
      "entered-in-error",
