...
internal data class EventDefinitionSurrogate(
  ...
  public fun toModel(): EventDefinition =
    EventDefinition(
      ...
      title =
        R4String.of(this@EventDefinitionSurrogate.title, this@EventDefinitionSurrogate._title),
      subtitle =
        R4String.of(
      ...
      usage =
        R4String.of(this@EventDefinitionSurrogate.usage, this@EventDefinitionSurrogate._usage),
      copyright =
        Markdown.of(
