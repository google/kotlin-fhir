...
internal data class ConsentPolicySurrogate(
  ...
  public fun toModel(): Consent.Policy =
    Consent.Policy(
      ...
      authority =
        Uri.ofNullable(
          this@ConsentPolicySurrogate.authority,
          this@ConsentPolicySurrogate._authority,
        ),
      uri = Uri.ofNullable(this@ConsentPolicySurrogate.uri, this@ConsentPolicySurrogate._uri),
    )
    ...
    public fun fromModel(model: Consent): ConsentSurrogate =
      with(model) {
        ConsentSurrogate(
          ...
          policy = this@with.policy.takeUnless { it.isEmpty() },
