...
internal data class ImagingStudySurrogate(
  ...
  public fun toModel(): ImagingStudy =
    ImagingStudy().apply {
      ...
      status =
        Enumeration.of(
          this@ImagingStudySurrogate.status?.let {
            com.google.fhir.model.r4.ImagingStudy.ImagingStudyStatus.fromCode(it)
          },
      ...
      description =
        R4String.of(this@ImagingStudySurrogate.description, this@ImagingStudySurrogate._description)
