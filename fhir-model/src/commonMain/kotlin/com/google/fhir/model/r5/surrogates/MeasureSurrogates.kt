...
internal data class MeasureTermSurrogate(
  ...
  public fun toModel(): Measure.Term =
    Measure.Term(
      ...
      definition =
        Markdown.ofNullable(
          this@MeasureTermSurrogate.definition,
          this@MeasureTermSurrogate._definition,
        ),
    )
...
internal data class MeasureGroupSurrogate(
  ...
  public fun toModel(): Measure.Group =
    Measure.Group(
      ...
      linkId =
        R5String.ofNullable(this@MeasureGroupSurrogate.linkId, this@MeasureGroupSurrogate._linkId),
      ...
      subject =
        Measure.Group.Subject?.fromNullable(
    ...
    public fun fromModel(model: Measure.Group): MeasureGroupSurrogate =
      with(model) {
        MeasureGroupSurrogate(
          ...
          library =
            this@with.library.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _library =
            this@with.library
              .map { it.toElement() }
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          population = this@with.population.takeUnless { it.isEmpty() },
          stratifier = this@with.stratifier.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: Measure.SupplementalData): MeasureSupplementalDataSurrogate =
      with(model) {
        MeasureSupplementalDataSurrogate(
          ...
          _linkId = this@with.linkId?.toElement(),
          code = this@with.code,
          usage = this@with.usage.takeUnless { it.isEmpty() },
          description = this@with.description?.value,
          _description = this@with.description?.toElement(),
          criteria = this@with.criteria,
        )
...
internal data class MeasureSurrogate(
  ...
  public fun toModel(): Measure =
    Measure(
      ...
      implicitRules =
        Uri.ofNullable(this@MeasureSurrogate.implicitRules, this@MeasureSurrogate._implicitRules),
      language = Code.ofNullable(this@MeasureSurrogate.language, this@MeasureSurrogate._language),
      ...
      url = Uri.ofNullable(this@MeasureSurrogate.url, this@MeasureSurrogate._url),
      identifier = this@MeasureSurrogate.identifier ?: mutableListOf(),
      version = R5String.ofNullable(this@MeasureSurrogate.version, this@MeasureSurrogate._version),
      versionAlgorithm =
        Measure.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@MeasureSurrogate.name, this@MeasureSurrogate._name),
      title = R5String.ofNullable(this@MeasureSurrogate.title, this@MeasureSurrogate._title),
      subtitle =
        R5String.ofNullable(this@MeasureSurrogate.subtitle, this@MeasureSurrogate._subtitle),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@MeasureSurrogate.experimental,
          this@MeasureSurrogate._experimental,
        ),
      subject =
        Measure.Subject?.fromNullable(
      ...
      publisher =
        R5String.ofNullable(this@MeasureSurrogate.publisher, this@MeasureSurrogate._publisher),
      contact = this@MeasureSurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(this@MeasureSurrogate.description, this@MeasureSurrogate._description),
      useContext = this@MeasureSurrogate.useContext ?: mutableListOf(),
      jurisdiction = this@MeasureSurrogate.jurisdiction ?: mutableListOf(),
      purpose = Markdown.ofNullable(this@MeasureSurrogate.purpose, this@MeasureSurrogate._purpose),
      usage = Markdown.ofNullable(this@MeasureSurrogate.usage, this@MeasureSurrogate._usage),
      copyright =
        Markdown.ofNullable(this@MeasureSurrogate.copyright, this@MeasureSurrogate._copyright),
      copyrightLabel =
        R5String.ofNullable(
          this@MeasureSurrogate.copyrightLabel,
          this@MeasureSurrogate._copyrightLabel,
        ),
      approvalDate =
        Date.ofNullable(
      ...
      disclaimer =
        Markdown.ofNullable(this@MeasureSurrogate.disclaimer, this@MeasureSurrogate._disclaimer),
      ...
      riskAdjustment =
        Markdown.ofNullable(
          this@MeasureSurrogate.riskAdjustment,
          this@MeasureSurrogate._riskAdjustment,
        ),
      rateAggregation =
        Markdown.ofNullable(
          this@MeasureSurrogate.rateAggregation,
          this@MeasureSurrogate._rateAggregation,
        ),
      rationale =
        Markdown.ofNullable(this@MeasureSurrogate.rationale, this@MeasureSurrogate._rationale),
      ...
      guidance =
        Markdown.ofNullable(this@MeasureSurrogate.guidance, this@MeasureSurrogate._guidance),
    ...
    public fun fromModel(model: Measure): MeasureSurrogate =
      with(model) {
        MeasureSurrogate(
          ...
          supplementalData = this@with.supplementalData.takeUnless { it.isEmpty() },
        )
      }
  }
}
