...
internal data class ParametersParameterSurrogate(
  ...
  public fun toModel(): Parameters.Parameter =
    Parameters.Parameter(
      ...
      `value` =
        Parameters.Parameter.Value?.fromNullable(
          ...
          this@ParametersParameterSurrogate.valueContributor,
...
internal data class ParametersSurrogate(
  ...
  public fun toModel(): Parameters =
    Parameters(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ParametersSurrogate.implicitRules,
          this@ParametersSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ParametersSurrogate.language, this@ParametersSurrogate._language),
