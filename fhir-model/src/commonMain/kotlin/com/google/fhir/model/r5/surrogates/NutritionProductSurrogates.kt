    ...
    public fun fromModel(model: NutritionProduct.Nutrient): NutritionProductNutrientSurrogate =
      with(model) {
        NutritionProductNutrientSurrogate(
          ...
          item = this@with.item,
          amount = this@with.amount.takeUnless { it.isEmpty() },
        )
      }
  }
}
      ...
      `value` =
        NutritionProduct.Characteristic.Value.from(
          ...
          R5String.of(
            ...
            this@NutritionProductCharacteristicSurrogate._valueString,
          ),
          this@NutritionProductCharacteristicSurrogate.valueQuantity,
          Base64Binary.of(
            this@NutritionProductCharacteristicSurrogate.valueBase64Binary!!,
            this@NutritionProductCharacteristicSurrogate._valueBase64Binary,
          ),
          this@NutritionProductCharacteristicSurrogate.valueAttachment,
          R5Boolean.of(
...
internal data class NutritionProductSurrogate(
  ...
  public fun toModel(): NutritionProduct =
    NutritionProduct(
      ...
      language =
        Code.ofNullable(
          this@NutritionProductSurrogate.language,
          this@NutritionProductSurrogate._language,
        ),
    ...
    public fun fromModel(model: NutritionProduct): NutritionProductSurrogate =
      with(model) {
        NutritionProductSurrogate(
          ...
          knownAllergen = this@with.knownAllergen.takeUnless { it.isEmpty() },
