    ...
    public fun fromModel(
      ...
      with(model) {
        MedicinalProductPackagedPackageItemSurrogate(
          ...
          manufacturedItem = this@with.manufacturedItem.takeUnless { it.isEmpty() },
          packageItem = this@with.packageItem.takeUnless { it.isEmpty() },
          physicalCharacteristics = this@with.physicalCharacteristics,
          otherCharacteristics = this@with.otherCharacteristics.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(model: MedicinalProductPackaged): MedicinalProductPackagedSurrogate =
      with(model) {
        MedicinalProductPackagedSurrogate(
          ...
          manufacturer = this@with.manufacturer.takeUnless { it.isEmpty() },
          batchIdentifier = this@with.batchIdentifier.takeUnless { it.isEmpty() },
          packageItem = this@with.packageItem.takeUnless { it.isEmpty() },
        )
      }
  }
