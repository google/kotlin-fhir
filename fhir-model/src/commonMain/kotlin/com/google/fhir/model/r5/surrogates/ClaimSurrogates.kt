...
internal data class ClaimSupportingInfoSurrogate(
  ...
  public fun toModel(): Claim.SupportingInfo =
    Claim.SupportingInfo(
      ...
      timing =
        Claim.SupportingInfo.Timing?.fromNullable(
          Date.ofNullable(
      ...
      `value` =
        Claim.SupportingInfo.Value?.fromNullable(
          R5Boolean.ofNullable(
...
internal data class ClaimAccidentSurrogate(
  ...
  public fun toModel(): Claim.Accident =
    Claim.Accident(
      ...
      location =
        Claim.Accident.Location?.fromNullable(
...
internal data class ClaimItemDetailSurrogate(
  ...
  public fun toModel(): Claim.Item.Detail =
    Claim.Item.Detail(
      ...
      factor =
        Decimal.ofNullable(
          this@ClaimItemDetailSurrogate.factor,
          this@ClaimItemDetailSurrogate._factor,
        ),
...
internal data class ClaimItemSurrogate(
  ...
  public fun toModel(): Claim.Item =
    Claim.Item(
      ...
      serviced =
        Claim.Item.Serviced?.fromNullable(
          Date.ofNullable(
      ...
      location =
        Claim.Item.Location?.fromNullable(
      ...
      factor = Decimal.ofNullable(this@ClaimItemSurrogate.factor, this@ClaimItemSurrogate._factor),
...
internal data class ClaimSurrogate(
  ...
  public fun toModel(): Claim =
    Claim(
      ...
      implicitRules =
        Uri.ofNullable(this@ClaimSurrogate.implicitRules, this@ClaimSurrogate._implicitRules),
      language = Code.ofNullable(this@ClaimSurrogate.language, this@ClaimSurrogate._language),
