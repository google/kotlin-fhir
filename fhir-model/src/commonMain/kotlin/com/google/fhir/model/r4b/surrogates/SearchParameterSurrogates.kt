...
internal data class SearchParameterComponentSurrogate(
  ...
  public var expression: KotlinString?,
...
internal data class SearchParameterSurrogate(
  ...
  public fun toModel(): SearchParameter =
    SearchParameter(
      ...
      language =
        Code.ofNullable(
          this@SearchParameterSurrogate.language,
          this@SearchParameterSurrogate._language,
        ),
      ...
      version =
        R4bString.ofNullable(
          this@SearchParameterSurrogate.version,
          this@SearchParameterSurrogate._version,
        ),
      name =
      ...
      purpose =
        Markdown.ofNullable(
          this@SearchParameterSurrogate.purpose,
          this@SearchParameterSurrogate._purpose,
        ),
      ...
      xpath =
        R4bString.ofNullable(
          this@SearchParameterSurrogate.xpath,
          this@SearchParameterSurrogate._xpath,
        ),
      xpathUsage =
        this@SearchParameterSurrogate.xpathUsage?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.SearchParameter.XPathUsageType.fromCode(it!!),
        ...
        if (
          ...
          (this@SearchParameterSurrogate.comparator
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4b.SearchParameter.SearchComparator.fromCode(it!!)
                },
                element,
              )
            }
        ...
        if (
          ...
          (this@SearchParameterSurrogate.modifier
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4b.SearchParameter.SearchModifierCode.fromCode(it!!)
                },
                element,
              )
            }
    ...
    public fun fromModel(model: SearchParameter): SearchParameterSurrogate =
      with(model) {
        SearchParameterSurrogate(
          ...
          base =
            this@with.base.map { it.value.getCode() }.toMutableList().takeUnless { it.isEmpty() },
          _base =
            this@with.base
              .map { it.toElement() }
          ...
          target =
            this@with.target.map { it.value.getCode() }.toMutableList().takeUnless { it.isEmpty() },
          _target =
            this@with.target
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
          ...
          _modifier =
            this@with.modifier
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          chain = this@with.chain.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _chain =
            this@with.chain
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
