...
internal data class NamingSystemSurrogate(
  ...
  public fun toModel(): NamingSystem =
    NamingSystem(
      ...
      implicitRules =
        Uri.ofNullable(
          this@NamingSystemSurrogate.implicitRules,
          this@NamingSystemSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@NamingSystemSurrogate.language, this@NamingSystemSurrogate._language),
      ...
      url = Uri.ofNullable(this@NamingSystemSurrogate.url, this@NamingSystemSurrogate._url),
      identifier = this@NamingSystemSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@NamingSystemSurrogate.version,
          this@NamingSystemSurrogate._version,
        ),
      versionAlgorithm =
        NamingSystem.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      title =
        R5String.ofNullable(this@NamingSystemSurrogate.title, this@NamingSystemSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R5String.ofNullable(
          this@NamingSystemSurrogate.publisher,
          this@NamingSystemSurrogate._publisher,
        ),
      ...
      purpose =
        Markdown.ofNullable(
          this@NamingSystemSurrogate.purpose,
          this@NamingSystemSurrogate._purpose,
        ),
      copyright =
        Markdown.ofNullable(
          this@NamingSystemSurrogate.copyright,
          this@NamingSystemSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
      ...
      usage =
        R5String.ofNullable(this@NamingSystemSurrogate.usage, this@NamingSystemSurrogate._usage),
    ...
    public fun fromModel(model: NamingSystem): NamingSystemSurrogate =
      with(model) {
        NamingSystemSurrogate(
          ...
          uniqueId = this@with.uniqueId.takeUnless { it.isEmpty() },
        )
      }
  }
}
