...
internal data class EventDefinitionSurrogate(
  ...
  public fun toModel(): EventDefinition =
    EventDefinition(
      ...
      language =
        Code.ofNullable(
          this@EventDefinitionSurrogate.language,
          this@EventDefinitionSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@EventDefinitionSurrogate.url, this@EventDefinitionSurrogate._url),
      identifier = this@EventDefinitionSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
          this@EventDefinitionSurrogate.version,
          this@EventDefinitionSurrogate._version,
        ),
      versionAlgorithm =
        EventDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name =
        R5String.ofNullable(
          this@EventDefinitionSurrogate.name,
          this@EventDefinitionSurrogate._name,
        ),
      title =
        R5String.ofNullable(
          this@EventDefinitionSurrogate.title,
          this@EventDefinitionSurrogate._title,
        ),
      subtitle =
        R5String.ofNullable(
      ...
      subject =
        EventDefinition.Subject?.fromNullable(
      ...
      purpose =
        Markdown.ofNullable(
          this@EventDefinitionSurrogate.purpose,
          this@EventDefinitionSurrogate._purpose,
        ),
      usage =
        Markdown.ofNullable(
          this@EventDefinitionSurrogate.usage,
          this@EventDefinitionSurrogate._usage,
        ),
      copyright =
        Markdown.ofNullable(
