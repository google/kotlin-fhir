...
internal data class HumanNameSurrogate(
  ...
  public fun toModel(): HumanName =
    HumanName(
      ...
      text = R4bString.ofNullable(this@HumanNameSurrogate.text, this@HumanNameSurrogate._text),
      family =
        R4bString.ofNullable(this@HumanNameSurrogate.family, this@HumanNameSurrogate._family),
      given =
