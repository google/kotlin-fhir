...
internal data class ConditionDefinitionPreconditionSurrogate(
  ...
  public fun toModel(): ConditionDefinition.Precondition =
    ConditionDefinition.Precondition(
      ...
      `value` =
        ConditionDefinition.Precondition.Value?.fromNullable(
...
internal data class ConditionDefinitionSurrogate(
  ...
  public fun toModel(): ConditionDefinition =
    ConditionDefinition(
      ...
      url =
        Uri.ofNullable(
          this@ConditionDefinitionSurrogate.url,
          this@ConditionDefinitionSurrogate._url,
        ),
      ...
      versionAlgorithm =
        ConditionDefinition.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
        ...
        ConditionDefinitionSurrogate(
          ...
          _definition =
            this@with.definition
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          observation = this@with.observation.takeUnless { it.isEmpty() },
          medication = this@with.medication.takeUnless { it.isEmpty() },
          precondition = this@with.precondition.takeUnless { it.isEmpty() },
          team = this@with.team.takeUnless { it.isEmpty() },
          questionnaire = this@with.questionnaire.takeUnless { it.isEmpty() },
