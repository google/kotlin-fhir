...
@Serializable
internal class DataRequirementValueFilterValueSurrogate {
  public var valueDateTime: KotlinString? = null
  ...
  public fun toModel(): DataRequirement.ValueFilter.Value =
    ...
    ) ?: DataRequirement.ValueFilter.Value.Null
...
internal data class DataRequirementValueFilterSurrogate(
  ...
  public var `value`: DataRequirement.ValueFilter.Value? = null,
) {
  public fun toModel(): DataRequirement.ValueFilter =
    DataRequirement.ValueFilter().apply {
      id = this@DataRequirementValueFilterSurrogate.id
      extension = this@DataRequirementValueFilterSurrogate.extension
      path =
        R5String.of(
      ...
      `value` = this@DataRequirementValueFilterSurrogate.`value`
    }

  public companion object {
    public fun fromModel(model: DataRequirement.ValueFilter): DataRequirementValueFilterSurrogate =
      with(model) {
        DataRequirementValueFilterSurrogate().apply {
          id = this@with.id
          extension = this@with.extension
          path = this@with.path?.value
          _path = this@with.path?.toElement()
...
internal data class DataRequirementSortSurrogate(
  ...
  public fun toModel(): DataRequirement.Sort =
    DataRequirement.Sort().apply {
      ...
      path =
        R5String.of(this@DataRequirementSortSurrogate.path, this@DataRequirementSortSurrogate._path)
      direction =
        Enumeration.of(
          this@DataRequirementSortSurrogate.direction?.let {
            com.google.fhir.model.r5.DataRequirement.SortDirection.fromCode(it)
          },
...
internal data class DataRequirementSurrogate(
  ...
  public fun toModel(): DataRequirement =
    DataRequirement().apply {
      ...
      valueFilter = this@DataRequirementSurrogate.valueFilter
      limit =
    ...
    public fun fromModel(model: DataRequirement): DataRequirementSurrogate =
      with(model) {
        DataRequirementSurrogate().apply {
          ...
          valueFilter = this@with.valueFilter
