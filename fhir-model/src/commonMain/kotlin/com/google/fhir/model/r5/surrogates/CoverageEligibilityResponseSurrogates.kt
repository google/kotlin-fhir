...
@Serializable
internal class CoverageEligibilityResponseEventWhenSurrogate {
  ...
  public fun toModel(): CoverageEligibilityResponse.Event.When =
    ...
    ) ?: CoverageEligibilityResponse.Event.When.Null
...
internal data class CoverageEligibilityResponseEventSurrogate(
  ...
  public var `when`: CoverageEligibilityResponse.Event.When? = null,
) {
