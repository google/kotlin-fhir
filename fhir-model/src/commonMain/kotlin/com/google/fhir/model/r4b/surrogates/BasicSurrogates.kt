...
import com.google.fhir.model.r4b.Basic
...
internal data class BasicSurrogate(
  ...
  public fun toModel(): Basic =
    Basic(
      ...
      implicitRules =
        Uri.ofNullable(this@BasicSurrogate.implicitRules, this@BasicSurrogate._implicitRules),
      language = Code.ofNullable(this@BasicSurrogate.language, this@BasicSurrogate._language),
      ...
      created =
        Date.ofNullable(
          FhirDate.fromString(this@BasicSurrogate.created),
