    ...
    public fun fromModel(
      ...
      with(model) {
        VerificationResultPrimarySourceSurrogate(
          ...
          communicationMethod = this@with.communicationMethod.takeUnless { it.isEmpty() },
          ...
          pushTypeAvailable = this@with.pushTypeAvailable.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class VerificationResultSurrogate(
  ...
  public fun toModel(): VerificationResult =
    VerificationResult(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.VerificationResult.Status.fromCode(
    ...
    public fun fromModel(model: VerificationResult): VerificationResultSurrogate =
      with(model) {
        VerificationResultSurrogate(
          ...
          targetLocation =
            this@with.targetLocation.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _targetLocation =
          ...
          validationProcess = this@with.validationProcess.takeUnless { it.isEmpty() },
          ...
          primarySource = this@with.primarySource.takeUnless { it.isEmpty() },
          attestation = this@with.attestation,
          validator = this@with.validator.takeUnless { it.isEmpty() },
        )
      }
  }
}
