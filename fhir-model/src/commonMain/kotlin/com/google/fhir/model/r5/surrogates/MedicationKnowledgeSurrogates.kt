    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeRelatedMedicationKnowledgeSurrogate(
          ...
          type = this@with.type,
          reference = this@with.reference.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    MedicationKnowledge.Cost(
      ...
      cost =
        MedicationKnowledge.Cost.Cost.from(
          this@MedicationKnowledgeCostSurrogate.costMoney,
          this@MedicationKnowledgeCostSurrogate.costCodeableConcept,
        ),
    )
    ...
    public fun fromModel(model: MedicationKnowledge.Cost): MedicationKnowledgeCostSurrogate =
      with(model) {
        MedicationKnowledgeCostSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          effectiveDate = this@with.effectiveDate.takeUnless { it.isEmpty() },
          type = this@with.type,
          source = this@with.source?.value,
          _source = this@with.source?.toElement(),
          costMoney = this@with.cost?.asMoney()?.value,
          costCodeableConcept = this@with.cost?.asCodeableConcept()?.value,
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeIndicationGuidelineDosingGuidelineDosageSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          type = this@with.type,
          dosage = this@with.dosage.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeIndicationGuidelineDosingGuidelineSurrogate(
          ...
          patientCharacteristic = this@with.patientCharacteristic.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeIndicationGuidelineSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          indication = this@with.indication.takeUnless { it.isEmpty() },
          dosingGuideline = this@with.dosingGuideline.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class MedicationKnowledgeMedicineClassificationSurrogate(
  ...
  public fun toModel(): MedicationKnowledge.MedicineClassification =
    MedicationKnowledge.MedicineClassification(
      ...
      source =
        MedicationKnowledge.MedicineClassification.Source?.fromNullable(
          R5String.ofNullable(
            this@MedicationKnowledgeMedicineClassificationSurrogate.sourceString,
            this@MedicationKnowledgeMedicineClassificationSurrogate._sourceString,
          ),
          Uri.ofNullable(
            this@MedicationKnowledgeMedicineClassificationSurrogate.sourceUri,
            this@MedicationKnowledgeMedicineClassificationSurrogate._sourceUri,
          ),
        ),
      classification =
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeMedicineClassificationSurrogate(
          ...
          classification = this@with.classification.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgePackagingSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          cost = this@with.cost.takeUnless { it.isEmpty() },
    ...
    MedicationKnowledge.StorageGuideline.EnvironmentalSetting(
      ...
      `value` =
        MedicationKnowledge.StorageGuideline.EnvironmentalSetting.Value.from(
          this@MedicationKnowledgeStorageGuidelineEnvironmentalSettingSurrogate.valueQuantity,
          this@MedicationKnowledgeStorageGuidelineEnvironmentalSettingSurrogate.valueRange,
          this@MedicationKnowledgeStorageGuidelineEnvironmentalSettingSurrogate.valueCodeableConcept,
        ),
    )
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeStorageGuidelineSurrogate(
          ...
          environmentalSetting = this@with.environmentalSetting.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class MedicationKnowledgeRegulatorySubstitutionSurrogate(
  ...
  public var modifierExtension: MutableList<Extension>? = null,
  public var type: CodeableConcept,
  public var allowed: KotlinBoolean?,
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeRegulatorySurrogate(
          ...
          substitution = this@with.substitution.takeUnless { it.isEmpty() },
          schedule = this@with.schedule.takeUnless { it.isEmpty() },
...
internal data class MedicationKnowledgeDefinitionalIngredientSurrogate(
  ...
  public fun toModel(): MedicationKnowledge.Definitional.Ingredient =
    MedicationKnowledge.Definitional.Ingredient(
      ...
      strength =
        MedicationKnowledge.Definitional.Ingredient.Strength?.fromNullable(
          this@MedicationKnowledgeDefinitionalIngredientSurrogate.strengthRatio,
          this@MedicationKnowledgeDefinitionalIngredientSurrogate.strengthCodeableConcept,
          this@MedicationKnowledgeDefinitionalIngredientSurrogate.strengthQuantity,
        ),
    )
...
internal data class MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate(
  ...
  public fun toModel(): MedicationKnowledge.Definitional.DrugCharacteristic =
    MedicationKnowledge.Definitional.DrugCharacteristic(
      ...
      `value` =
        MedicationKnowledge.Definitional.DrugCharacteristic.Value?.fromNullable(
          this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate.valueCodeableConcept,
          R5String.ofNullable(
            this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate.valueString,
            this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate._valueString,
          ),
          this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate.valueQuantity,
          Base64Binary.ofNullable(
            this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate.valueBase64Binary,
            this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate._valueBase64Binary,
          ),
          this@MedicationKnowledgeDefinitionalDrugCharacteristicSurrogate.valueAttachment,
        ),
    )
    ...
    public fun fromModel(
      ...
      with(model) {
        MedicationKnowledgeDefinitionalSurrogate(
          ...
          extension = this@with.extension.takeUnless { it.isEmpty() },
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          definition = this@with.definition.takeUnless { it.isEmpty() },
          doseForm = this@with.doseForm,
          intendedRoute = this@with.intendedRoute.takeUnless { it.isEmpty() },
          ingredient = this@with.ingredient.takeUnless { it.isEmpty() },
          drugCharacteristic = this@with.drugCharacteristic.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: MedicationKnowledge): MedicationKnowledgeSurrogate =
      with(model) {
        MedicationKnowledgeSurrogate(
          ...
          intendedJurisdiction = this@with.intendedJurisdiction.takeUnless { it.isEmpty() },
          name = this@with.name.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _name =
            this@with.name
              .map { it.toElement() }
              ...
              ?.toMutableList(),
          relatedMedicationKnowledge =
            this@with.relatedMedicationKnowledge.takeUnless { it.isEmpty() },
          associatedMedication = this@with.associatedMedication.takeUnless { it.isEmpty() },
          productType = this@with.productType.takeUnless { it.isEmpty() },
          monograph = this@with.monograph.takeUnless { it.isEmpty() },
          ...
          cost = this@with.cost.takeUnless { it.isEmpty() },
          monitoringProgram = this@with.monitoringProgram.takeUnless { it.isEmpty() },
          indicationGuideline = this@with.indicationGuideline.takeUnless { it.isEmpty() },
          medicineClassification = this@with.medicineClassification.takeUnless { it.isEmpty() },
          packaging = this@with.packaging.takeUnless { it.isEmpty() },
          clinicalUseIssue = this@with.clinicalUseIssue.takeUnless { it.isEmpty() },
          storageGuideline = this@with.storageGuideline.takeUnless { it.isEmpty() },
          regulatory = this@with.regulatory.takeUnless { it.isEmpty() },
