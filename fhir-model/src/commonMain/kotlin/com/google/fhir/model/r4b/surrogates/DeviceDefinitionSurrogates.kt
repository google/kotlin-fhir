...
internal data class DeviceDefinitionDeviceNameSurrogate(
  ...
  public fun toModel(): DeviceDefinition.DeviceName =
    DeviceDefinition.DeviceName(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4b.DeviceDefinition.DeviceNameType.fromCode(
...
internal data class DeviceDefinitionSpecializationSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var systemType: KotlinString?,
    ...
    public fun fromModel(model: DeviceDefinition.Capability): DeviceDefinitionCapabilitySurrogate =
      with(model) {
        DeviceDefinitionCapabilitySurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          type = this@with.type,
          description = this@with.description.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class DeviceDefinitionSurrogate(
  ...
  public fun toModel(): DeviceDefinition =
    DeviceDefinition(
      ...
      manufacturer =
        DeviceDefinition.Manufacturer?.fromNullable(
          R4bString.ofNullable(
      ...
      url = Uri.ofNullable(this@DeviceDefinitionSurrogate.url, this@DeviceDefinitionSurrogate._url),
      onlineInformation =
        Uri.ofNullable(
