...
internal data class ReferenceSurrogate(
  ...
  public fun toModel(): Reference =
    Reference(
      ...
      reference =
        R4bString.ofNullable(this@ReferenceSurrogate.reference, this@ReferenceSurrogate._reference),
      type = Uri.ofNullable(this@ReferenceSurrogate.type, this@ReferenceSurrogate._type),
      identifier = this@ReferenceSurrogate.identifier,
      display =
        R4bString.ofNullable(this@ReferenceSurrogate.display, this@ReferenceSurrogate._display),
    )
