...
internal data class ScheduleSurrogate(
  ...
  public fun toModel(): Schedule =
    Schedule(
      ...
      implicitRules =
        Uri.ofNullable(this@ScheduleSurrogate.implicitRules, this@ScheduleSurrogate._implicitRules),
      language = Code.ofNullable(this@ScheduleSurrogate.language, this@ScheduleSurrogate._language),
      ...
      active = R5Boolean.ofNullable(this@ScheduleSurrogate.active, this@ScheduleSurrogate._active),
      ...
      name = R5String.ofNullable(this@ScheduleSurrogate.name, this@ScheduleSurrogate._name),
      actor = this@ScheduleSurrogate.actor ?: mutableListOf(),
      planningHorizon = this@ScheduleSurrogate.planningHorizon,
      comment = Markdown.ofNullable(this@ScheduleSurrogate.comment, this@ScheduleSurrogate._comment),
    )
