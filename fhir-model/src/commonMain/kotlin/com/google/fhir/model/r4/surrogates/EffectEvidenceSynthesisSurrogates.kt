    ...
    public fun fromModel(
      ...
      with(model) {
        EffectEvidenceSynthesisEffectEstimateSurrogate(
          ...
          precisionEstimate = this@with.precisionEstimate.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        EffectEvidenceSynthesisCertaintyCertaintySubcomponentSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          type = this@with.type,
          rating = this@with.rating.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        EffectEvidenceSynthesisCertaintySurrogate(
          ...
          rating = this@with.rating.takeUnless { it.isEmpty() },
          note = this@with.note.takeUnless { it.isEmpty() },
          certaintySubcomponent = this@with.certaintySubcomponent.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: EffectEvidenceSynthesis): EffectEvidenceSynthesisSurrogate =
      with(model) {
        EffectEvidenceSynthesisSurrogate(
          ...
          resultsByExposure = this@with.resultsByExposure.takeUnless { it.isEmpty() },
          effectEstimate = this@with.effectEstimate.takeUnless { it.isEmpty() },
