...
internal data class AuditEventAgentSurrogate(
  ...
  public var requestor: KotlinBoolean?,
  ...
  public fun toModel(): AuditEvent.Agent =
    AuditEvent.Agent(
      ...
      altId =
        R4bString.ofNullable(
          this@AuditEventAgentSurrogate.altId,
          this@AuditEventAgentSurrogate._altId,
        ),
      name =
        R4bString.ofNullable(
          this@AuditEventAgentSurrogate.name,
          this@AuditEventAgentSurrogate._name,
        ),
      requestor =
        R4bBoolean.of(
    ...
    public fun fromModel(model: AuditEvent.Agent): AuditEventAgentSurrogate =
      with(model) {
        AuditEventAgentSurrogate(
          ...
          purposeOfUse = this@with.purposeOfUse.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class AuditEventSourceSurrogate(
  ...
  public fun toModel(): AuditEvent.Source =
    AuditEvent.Source(
      ...
      site =
        R4bString.ofNullable(
          this@AuditEventSourceSurrogate.site,
          this@AuditEventSourceSurrogate._site,
        ),
...
internal data class AuditEventEntitySurrogate(
  ...
  public fun toModel(): AuditEvent.Entity =
    AuditEvent.Entity(
      ...
      name =
        R4bString.ofNullable(
          this@AuditEventEntitySurrogate.name,
          this@AuditEventEntitySurrogate._name,
        ),
      description =
        R4bString.ofNullable(
...
internal data class AuditEventSurrogate(
  ...
  public fun toModel(): AuditEvent =
    AuditEvent(
      ...
      outcomeDesc =
        R4bString.ofNullable(
          this@AuditEventSurrogate.outcomeDesc,
          this@AuditEventSurrogate._outcomeDesc,
        ),
    ...
    public fun fromModel(model: AuditEvent): AuditEventSurrogate =
      with(model) {
        AuditEventSurrogate(
          ...
          purposeOfEvent = this@with.purposeOfEvent.takeUnless { it.isEmpty() },
