    ...
    public fun fromModel(model: NutritionOrder.OralDiet): NutritionOrderOralDietSurrogate =
      with(model) {
        NutritionOrderOralDietSurrogate(
          ...
          nutrient = this@with.nutrient.takeUnless { it.isEmpty() },
          texture = this@with.texture.takeUnless { it.isEmpty() },
          fluidConsistencyType = this@with.fluidConsistencyType.takeUnless { it.isEmpty() },
...
internal data class NutritionOrderEnteralFormulaAdministrationSurrogate(
  ...
  public fun toModel(): NutritionOrder.EnteralFormula.Administration =
    NutritionOrder.EnteralFormula.Administration(
      ...
      rate =
        NutritionOrder.EnteralFormula.Administration.Rate?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        NutritionOrderEnteralFormulaSurrogate(
          ...
          administration = this@with.administration.takeUnless { it.isEmpty() },
...
internal data class NutritionOrderSurrogate(
  ...
  public var dateTime: KotlinString?,
  ...
  public fun toModel(): NutritionOrder =
    NutritionOrder(
      ...
      language =
        Code.ofNullable(
          this@NutritionOrderSurrogate.language,
          this@NutritionOrderSurrogate._language,
        ),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.NutritionOrder.NutritionOrderStatus.fromCode(
      ...
      intent =
        Enumeration.of(
          com.google.fhir.model.r4.NutritionOrder.NutritiionOrderIntent.fromCode(
    ...
    public fun fromModel(model: NutritionOrder): NutritionOrderSurrogate =
      with(model) {
        NutritionOrderSurrogate(
          ...
          allergyIntolerance = this@with.allergyIntolerance.takeUnless { it.isEmpty() },
          foodPreferenceModifier = this@with.foodPreferenceModifier.takeUnless { it.isEmpty() },
          excludeFoodModifier = this@with.excludeFoodModifier.takeUnless { it.isEmpty() },
          oralDiet = this@with.oralDiet,
          supplement = this@with.supplement.takeUnless { it.isEmpty() },
