...
internal data class OrganizationSurrogate(
  ...
  public fun toModel(): Organization =
    Organization(
      ...
      implicitRules =
        Uri.ofNullable(
          this@OrganizationSurrogate.implicitRules,
          this@OrganizationSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@OrganizationSurrogate.language, this@OrganizationSurrogate._language),
      ...
      active =
        R5Boolean.ofNullable(this@OrganizationSurrogate.active, this@OrganizationSurrogate._active),
      type = this@OrganizationSurrogate.type ?: mutableListOf(),
      name = R5String.ofNullable(this@OrganizationSurrogate.name, this@OrganizationSurrogate._name),
      alias =
