...
internal data class DeviceUsageSurrogate(
  ...
  public fun toModel(): DeviceUsage =
    DeviceUsage(
      ...
      implicitRules =
        Uri.ofNullable(
          this@DeviceUsageSurrogate.implicitRules,
          this@DeviceUsageSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@DeviceUsageSurrogate.language, this@DeviceUsageSurrogate._language),
      ...
      timing =
        DeviceUsage.Timing?.fromNullable(
    ...
    public fun fromModel(model: DeviceUsage): DeviceUsageSurrogate =
      with(model) {
        DeviceUsageSurrogate(
          ...
          usageReason = this@with.usageReason.takeUnless { it.isEmpty() },
