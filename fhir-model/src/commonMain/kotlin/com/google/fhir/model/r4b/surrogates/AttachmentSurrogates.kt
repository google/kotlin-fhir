...
internal data class AttachmentSurrogate(
  ...
  public fun toModel(): Attachment =
    Attachment(
      ...
      size = UnsignedInt.ofNullable(this@AttachmentSurrogate.size, this@AttachmentSurrogate._size),
      hash = Base64Binary.ofNullable(this@AttachmentSurrogate.hash, this@AttachmentSurrogate._hash),
      title = R4bString.ofNullable(this@AttachmentSurrogate.title, this@AttachmentSurrogate._title),
      creation =
        DateTime.ofNullable(
