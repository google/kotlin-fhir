...
internal data class EvidenceSurrogate(
  ...
  public fun toModel(): Evidence =
    Evidence(
      ...
      version =
        R4String.ofNullable(this@EvidenceSurrogate.version, this@EvidenceSurrogate._version),
      name = R4String.ofNullable(this@EvidenceSurrogate.name, this@EvidenceSurrogate._name),
      title = R4String.ofNullable(this@EvidenceSurrogate.title, this@EvidenceSurrogate._title),
      shortTitle =
        R4String.ofNullable(this@EvidenceSurrogate.shortTitle, this@EvidenceSurrogate._shortTitle),
      subtitle =
        R4String.ofNullable(this@EvidenceSurrogate.subtitle, this@EvidenceSurrogate._subtitle),
      status =
        Enumeration.of(
      ...
      publisher =
        R4String.ofNullable(this@EvidenceSurrogate.publisher, this@EvidenceSurrogate._publisher),
    ...
    public fun fromModel(model: Evidence): EvidenceSurrogate =
      with(model) {
        EvidenceSurrogate(
          ...
          exposureVariant = this@with.exposureVariant.takeUnless { it.isEmpty() },
          outcome = this@with.outcome.takeUnless { it.isEmpty() },
        )
      }
  }
}
