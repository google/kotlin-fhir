...
internal data class SpecimenCollectionSurrogate(
  ...
  public fun toModel(): Specimen.Collection =
    Specimen.Collection(
      ...
      collected =
        Specimen.Collection.Collected?.fromNullable(
          DateTime.ofNullable(
      ...
      fastingStatus =
        Specimen.Collection.FastingStatus?.fromNullable(
...
internal data class SpecimenProcessingSurrogate(
  ...
  public fun toModel(): Specimen.Processing =
    Specimen.Processing(
      ...
      time =
        Specimen.Processing.Time?.fromNullable(
          DateTime.ofNullable(
...
internal data class SpecimenSurrogate(
  ...
  public fun toModel(): Specimen =
    Specimen(
      ...
      implicitRules =
        Uri.ofNullable(this@SpecimenSurrogate.implicitRules, this@SpecimenSurrogate._implicitRules),
      language = Code.ofNullable(this@SpecimenSurrogate.language, this@SpecimenSurrogate._language),
      ...
      combined = Code.ofNullable(this@SpecimenSurrogate.combined, this@SpecimenSurrogate._combined),
    ...
    public fun fromModel(model: Specimen): SpecimenSurrogate =
      with(model) {
        SpecimenSurrogate(
          ...
          parent = this@with.parent.takeUnless { it.isEmpty() },
          ...
          feature = this@with.feature.takeUnless { it.isEmpty() },
          collection = this@with.collection,
          processing = this@with.processing.takeUnless { it.isEmpty() },
          container = this@with.container.takeUnless { it.isEmpty() },
