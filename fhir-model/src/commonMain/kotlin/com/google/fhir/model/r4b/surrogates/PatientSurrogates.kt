...
internal data class PatientSurrogate(
  ...
  public fun toModel(): Patient =
    Patient(
      ...
      implicitRules =
        Uri.ofNullable(this@PatientSurrogate.implicitRules, this@PatientSurrogate._implicitRules),
      language = Code.ofNullable(this@PatientSurrogate.language, this@PatientSurrogate._language),
      ...
      active = R4bBoolean.ofNullable(this@PatientSurrogate.active, this@PatientSurrogate._active),
      ...
      multipleBirth =
        Patient.MultipleBirth?.fromNullable(
          R4bBoolean.ofNullable(
    ...
    public fun fromModel(model: Patient): PatientSurrogate =
      with(model) {
        PatientSurrogate(
          ...
          photo = this@with.photo.takeUnless { it.isEmpty() },
          contact = this@with.contact.takeUnless { it.isEmpty() },
          communication = this@with.communication.takeUnless { it.isEmpty() },
          generalPractitioner = this@with.generalPractitioner.takeUnless { it.isEmpty() },
