...
internal data class InvoiceLineItemSurrogate(
  ...
  public fun toModel(): Invoice.LineItem =
    Invoice.LineItem(
      ...
      serviced =
        Invoice.LineItem.Serviced?.fromNullable(
          Date.ofNullable(
    ...
    public fun fromModel(model: Invoice.LineItem): InvoiceLineItemSurrogate =
      with(model) {
        InvoiceLineItemSurrogate(
          ...
          priceComponent = this@with.priceComponent.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class InvoiceSurrogate(
  ...
  public fun toModel(): Invoice =
    Invoice(
      ...
      implicitRules =
        Uri.ofNullable(this@InvoiceSurrogate.implicitRules, this@InvoiceSurrogate._implicitRules),
      language = Code.ofNullable(this@InvoiceSurrogate.language, this@InvoiceSurrogate._language),
      ...
      cancelledReason =
        R5String.ofNullable(
          this@InvoiceSurrogate.cancelledReason,
          this@InvoiceSurrogate._cancelledReason,
        ),
      ...
      paymentTerms =
        Markdown.ofNullable(
          this@InvoiceSurrogate.paymentTerms,
          this@InvoiceSurrogate._paymentTerms,
        ),
    ...
    public fun fromModel(model: Invoice): InvoiceSurrogate =
      with(model) {
        InvoiceSurrogate(
          ...
          lineItem = this@with.lineItem.takeUnless { it.isEmpty() },
          totalPriceComponent = this@with.totalPriceComponent.takeUnless { it.isEmpty() },
