...
internal data class BundleLinkSurrogate(
  ...
  public fun toModel(): Bundle.Link =
    Bundle.Link().apply {
      ...
      relation = R4String.of(this@BundleLinkSurrogate.relation, this@BundleLinkSurrogate._relation)
      ...
      method =
        Enumeration.of(
          this@BundleEntryRequestSurrogate.method?.let {
            com.google.fhir.model.r4.Bundle.HTTPVerb.fromCode(it)
          },
...
internal data class BundleEntryResponseSurrogate(
  ...
  public fun toModel(): Bundle.Entry.Response =
    Bundle.Entry.Response().apply {
      ...
      etag =
        R4String.of(this@BundleEntryResponseSurrogate.etag, this@BundleEntryResponseSurrogate._etag)
      lastModified =
        Instant.of(
      ...
      type =
        Enumeration.of(
          this@BundleSurrogate.type?.let {
            com.google.fhir.model.r4.Bundle.BundleType.fromCode(it)
          },
