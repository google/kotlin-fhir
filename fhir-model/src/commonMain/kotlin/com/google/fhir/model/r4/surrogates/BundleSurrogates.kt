    ...
    Bundle.Entry.Search(
      ...
      mode =
        this@BundleEntrySearchSurrogate.mode?.let {
          Enumeration.of(
            com.google.fhir.model.r4.Bundle.SearchEntryMode.fromCode(it!!),
...
internal data class BundleEntryRequestSurrogate(
  ...
  public fun toModel(): Bundle.Entry.Request =
    Bundle.Entry.Request(
      ...
      method =
        Enumeration.of(
          com.google.fhir.model.r4.Bundle.HTTPVerb.fromCode(
...
internal data class BundleSurrogate(
  ...
  public fun toModel(): Bundle =
    Bundle(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4.Bundle.BundleType.fromCode(this@BundleSurrogate.type!!),
