      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.SupportingInfo.Timing"
          )
        }
    ...
    public sealed interface Value {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.SupportingInfo.Value"
          )
        }
    ...
    public sealed interface Diagnosis {
      ...
      public companion object {
        public fun from(
          ...
          if (ReferenceValue != null) return Reference(ReferenceValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.Diagnosis.Diagnosis"
          )
        }
    ...
    public sealed interface Procedure {
      ...
      public companion object {
        public fun from(
          ...
          if (ReferenceValue != null) return Reference(ReferenceValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.Procedure.Procedure"
          )
        }
    ...
    public sealed interface Location {
      ...
      public companion object {
        public fun from(
          ...
          if (ReferenceValue != null) return Reference(ReferenceValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.Accident.Location"
          )
        }
    ...
    public sealed interface Serviced {
      ...
      public companion object {
        public fun from(
          ...
          if (PeriodValue != null) return Period(PeriodValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.Item.Serviced"
          )
        }
    ...
    public sealed interface Location {
      ...
      public companion object {
        public fun from(
          ...
          if (ReferenceValue != null) return Reference(ReferenceValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Claim.Item.Location"
          )
        }
