...
internal data class GroupCharacteristicSurrogate(
  ...
  public var exclude: KotlinBoolean?,
    ...
    Group.Member(
      ...
      inactive =
        R5Boolean.ofNullable(
          this@GroupMemberSurrogate.inactive,
          this@GroupMemberSurrogate._inactive,
        ),
    )
...
internal data class GroupSurrogate(
  ...
  public var membership: KotlinString?,
  ...
  public fun toModel(): Group =
    Group(
      ...
      implicitRules =
        Uri.ofNullable(this@GroupSurrogate.implicitRules, this@GroupSurrogate._implicitRules),
      language = Code.ofNullable(this@GroupSurrogate.language, this@GroupSurrogate._language),
      ...
      active = R5Boolean.ofNullable(this@GroupSurrogate.active, this@GroupSurrogate._active),
      type =
        Enumeration.of(
      ...
      name = R5String.ofNullable(this@GroupSurrogate.name, this@GroupSurrogate._name),
      description =
        Markdown.ofNullable(this@GroupSurrogate.description, this@GroupSurrogate._description),
      quantity =
        UnsignedInt.ofNullable(this@GroupSurrogate.quantity, this@GroupSurrogate._quantity),
    ...
    public fun fromModel(model: Group): GroupSurrogate =
      with(model) {
        GroupSurrogate(
          ...
          member = this@with.member.takeUnless { it.isEmpty() },
        )
      }
  }
}
