...
internal data class LibrarySurrogate(
  ...
  public fun toModel(): Library =
    Library(
      ...
      version = R4bString.ofNullable(this@LibrarySurrogate.version, this@LibrarySurrogate._version),
      name = R4bString.ofNullable(this@LibrarySurrogate.name, this@LibrarySurrogate._name),
      title = R4bString.ofNullable(this@LibrarySurrogate.title, this@LibrarySurrogate._title),
      subtitle =
        R4bString.ofNullable(this@LibrarySurrogate.subtitle, this@LibrarySurrogate._subtitle),
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.PublicationStatus.fromCode(this@LibrarySurrogate.status!!),
      ...
      publisher =
        R4bString.ofNullable(this@LibrarySurrogate.publisher, this@LibrarySurrogate._publisher),
      ...
      usage = R4bString.ofNullable(this@LibrarySurrogate.usage, this@LibrarySurrogate._usage),
      copyright =
