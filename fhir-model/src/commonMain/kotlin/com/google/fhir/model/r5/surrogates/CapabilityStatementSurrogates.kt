      ...
      code =
        Enumeration.of(
          this@CapabilityStatementRestResourceInteractionSurrogate.code?.let {
            com.google.fhir.model.r5.CapabilityStatement.TypeRestfulInteraction.fromCode(it)
          },
        ...
        if (
          ...
          (this@CapabilityStatementRestResourceSurrogate.referencePolicy
            ...
            .mapNotNull { (value, element) ->
              Enumeration.of(
                value?.let {
                  com.google.fhir.model.r5.CapabilityStatement.ReferenceHandlingPolicy.fromCode(it)
                },
                element,
              )
            }
      ...
      code =
        Enumeration.of(
          this@CapabilityStatementRestInteractionSurrogate.code?.let {
            com.google.fhir.model.r5.CapabilityStatement.SystemRestfulInteraction.fromCode(it)
          },
      ...
      mode =
        Enumeration.of(
          this@CapabilityStatementRestSurrogate.mode?.let {
            com.google.fhir.model.r5.CapabilityStatement.RestfulCapabilityMode.fromCode(it)
          },
      ...
      mode =
        Enumeration.of(
          this@CapabilityStatementMessagingSupportedMessageSurrogate.mode?.let {
            com.google.fhir.model.r5.CapabilityStatement.EventCapabilityMode.fromCode(it)
          },
      ...
      mode =
        Enumeration.of(
          this@CapabilityStatementDocumentSurrogate.mode?.let {
            com.google.fhir.model.r5.CapabilityStatement.DocumentMode.fromCode(it)
          },
...
internal data class CapabilityStatementSurrogate(
  ...
  public fun toModel(): CapabilityStatement =
    CapabilityStatement().apply {
      ...
      identifier = this@CapabilityStatementSurrogate.identifier
      version =
        R5String.of(
      ...
      kind =
        Enumeration.of(
          this@CapabilityStatementSurrogate.kind?.let {
            com.google.fhir.model.r5.CapabilityStatement.CapabilityStatementKind.fromCode(it)
          },
    ...
    public fun fromModel(model: CapabilityStatement): CapabilityStatementSurrogate =
      with(model) {
        CapabilityStatementSurrogate().apply {
          ...
          acceptLanguage =
            this@with.acceptLanguage?.map { it?.value }?.takeUnless { it.all { it == null } }
          _acceptLanguage =
            this@with.acceptLanguage?.map { it?.toElement() }?.takeUnless { it.all { it == null } }
          implementationGuide =
