...
internal data class GroupSurrogate(
  ...
  public fun toModel(): Group =
    Group(
      ...
      active = R4bBoolean.ofNullable(this@GroupSurrogate.active, this@GroupSurrogate._active),
      type =
        Enumeration.of(
      ...
      name = R4bString.ofNullable(this@GroupSurrogate.name, this@GroupSurrogate._name),
      quantity =
