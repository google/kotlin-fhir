...
internal data class SignatureSurrogate(
  ...
  public fun toModel(): Signature =
    Signature(
      ...
      targetFormat =
        Code.ofNullable(
          this@SignatureSurrogate.targetFormat,
          this@SignatureSurrogate._targetFormat,
        ),
      sigFormat =
        Code.ofNullable(this@SignatureSurrogate.sigFormat, this@SignatureSurrogate._sigFormat),
      `data` =
        Base64Binary.ofNullable(this@SignatureSurrogate.`data`, this@SignatureSurrogate._data),
    )
