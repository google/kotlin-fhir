...
internal data class CodeSystemSurrogate(
  ...
  public fun toModel(): CodeSystem =
    CodeSystem(
      ...
      version =
        R4String.ofNullable(this@CodeSystemSurrogate.version, this@CodeSystemSurrogate._version),
      name = R4String.ofNullable(this@CodeSystemSurrogate.name, this@CodeSystemSurrogate._name),
      title = R4String.ofNullable(this@CodeSystemSurrogate.title, this@CodeSystemSurrogate._title),
      status =
        Enumeration.of(
