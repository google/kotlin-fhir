...
import com.google.fhir.model.r4.Group
...
internal data class GroupSurrogate(
  ...
  public var `actual`: KotlinBoolean?,
  ...
  public fun toModel(): Group =
    Group(
      ...
      active = R4Boolean.ofNullable(this@GroupSurrogate.active, this@GroupSurrogate._active),
      type =
        Enumeration.of(
      ...
      name = R4String.ofNullable(this@GroupSurrogate.name, this@GroupSurrogate._name),
      quantity =
