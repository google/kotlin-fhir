...
internal data class GroupMemberSurrogate(
  ...
  public fun toModel(): Group.Member =
    Group.Member().apply {
      ...
      inactive =
        R4Boolean.of(this@GroupMemberSurrogate.inactive, this@GroupMemberSurrogate._inactive)
    }
...
internal data class GroupSurrogate(
  ...
  public fun toModel(): Group =
    Group().apply {
      ...
      type =
        Enumeration.of(
          this@GroupSurrogate.type?.let { com.google.fhir.model.r4.Group.GroupType.fromCode(it) },
