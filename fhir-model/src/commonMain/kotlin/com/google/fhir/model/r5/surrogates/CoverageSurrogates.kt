...
internal data class CoverageClassSurrogate(
  ...
  public fun toModel(): Coverage.Class =
    Coverage.Class(
      ...
      name =
        R5String.ofNullable(this@CoverageClassSurrogate.name, this@CoverageClassSurrogate._name),
    )
...
internal data class CoverageCostToBeneficiarySurrogate(
  ...
  public fun toModel(): Coverage.CostToBeneficiary =
    Coverage.CostToBeneficiary(
      ...
      `value` =
        Coverage.CostToBeneficiary.Value?.fromNullable(
    ...
    public fun fromModel(model: Coverage.CostToBeneficiary): CoverageCostToBeneficiarySurrogate =
      with(model) {
        CoverageCostToBeneficiarySurrogate(
          ...
          exception = this@with.exception.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class CoverageSurrogate(
  ...
  public fun toModel(): Coverage =
    Coverage(
      ...
      implicitRules =
        Uri.ofNullable(this@CoverageSurrogate.implicitRules, this@CoverageSurrogate._implicitRules),
      language = Code.ofNullable(this@CoverageSurrogate.language, this@CoverageSurrogate._language),
      ...
      dependent =
        R5String.ofNullable(this@CoverageSurrogate.dependent, this@CoverageSurrogate._dependent),
      ...
      order = PositiveInt.ofNullable(this@CoverageSurrogate.order, this@CoverageSurrogate._order),
      network =
        R5String.ofNullable(this@CoverageSurrogate.network, this@CoverageSurrogate._network),
      costToBeneficiary = this@CoverageSurrogate.costToBeneficiary ?: mutableListOf(),
      subrogation =
        R5Boolean.ofNullable(
          this@CoverageSurrogate.subrogation,
          this@CoverageSurrogate._subrogation,
        ),
    ...
    public fun fromModel(model: Coverage): CoverageSurrogate =
      with(model) {
        CoverageSurrogate(
          ...
          paymentBy = this@with.paymentBy.takeUnless { it.isEmpty() },
          type = this@with.type,
          policyHolder = this@with.policyHolder,
          subscriber = this@with.subscriber,
          subscriberId = this@with.subscriberId.takeUnless { it.isEmpty() },
          ...
          costToBeneficiary = this@with.costToBeneficiary.takeUnless { it.isEmpty() },
          subrogation = this@with.subrogation?.value,
          _subrogation = this@with.subrogation?.toElement(),
          contract = this@with.contract.takeUnless { it.isEmpty() },
