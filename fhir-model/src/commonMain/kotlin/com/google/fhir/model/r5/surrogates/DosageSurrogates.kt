...
internal data class DosageSurrogate(
  ...
  public fun toModel(): Dosage =
    Dosage(
      ...
      sequence = Integer.ofNullable(this@DosageSurrogate.sequence, this@DosageSurrogate._sequence),
      text = R5String.ofNullable(this@DosageSurrogate.text, this@DosageSurrogate._text),
      ...
      asNeeded =
        R5Boolean.ofNullable(this@DosageSurrogate.asNeeded, this@DosageSurrogate._asNeeded),
    ...
    public fun fromModel(model: Dosage): DosageSurrogate =
      with(model) {
        DosageSurrogate(
          ...
          additionalInstruction = this@with.additionalInstruction.takeUnless { it.isEmpty() },
          ...
          asNeededFor = this@with.asNeededFor.takeUnless { it.isEmpty() },
          site = this@with.site,
          route = this@with.route,
          method = this@with.method,
          doseAndRate = this@with.doseAndRate.takeUnless { it.isEmpty() },
          maxDosePerPeriod = this@with.maxDosePerPeriod.takeUnless { it.isEmpty() },
