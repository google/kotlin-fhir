...
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemBodySiteSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemDetailSubDetailSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemDetailSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemLocationSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemServicedSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseAddItemSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseErrorSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseEventSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseEventWhenSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseInsuranceSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseItemAdjudicationSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseItemDetailSubDetailSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseItemDetailSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseItemReviewOutcomeSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseItemSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponsePaymentSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseProcessNoteSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseSurrogate
import com.google.fhir.model.r5.surrogates.ClaimResponseTotalSurrogate
...
public object ClaimResponseEventWhenSerializer : KSerializer<ClaimResponse.Event.When> {
  internal val surrogateSerializer: KSerializer<ClaimResponseEventWhenSurrogate> by lazy {
    ClaimResponseEventWhenSurrogate.serializer()
  }
  ...
  override fun serialize(encoder: Encoder, `value`: ClaimResponse.Event.When) {
    surrogateSerializer.serialize(encoder, ClaimResponseEventWhenSurrogate.fromModel(value))
  }
}

public object ClaimResponseEventSerializer : KSerializer<ClaimResponse.Event> {
  internal val surrogateSerializer: KSerializer<ClaimResponseEventSurrogate> by lazy {
    ClaimResponseEventSurrogate.serializer()
  }
  ...
  override fun serialize(encoder: Encoder, `value`: ClaimResponse.Event) {
    ...
    val surrogate = ClaimResponseEventSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
...
public object ClaimResponseItemReviewOutcomeSerializer :
  KSerializer<ClaimResponse.Item.ReviewOutcome> {
  internal val surrogateSerializer: KSerializer<ClaimResponseItemReviewOutcomeSurrogate> by lazy {
    ClaimResponseItemReviewOutcomeSurrogate.serializer()
  }
  ...
  override fun serialize(encoder: Encoder, `value`: ClaimResponse.Item.ReviewOutcome) {
    surrogateSerializer.serialize(encoder, ClaimResponseItemReviewOutcomeSurrogate.fromModel(value))
  }
}
...
public object ClaimResponseAddItemBodySiteSerializer : KSerializer<ClaimResponse.AddItem.BodySite> {
  internal val surrogateSerializer: KSerializer<ClaimResponseAddItemBodySiteSurrogate> by lazy {
    ClaimResponseAddItemBodySiteSurrogate.serializer()
  }
  ...
  override fun serialize(encoder: Encoder, `value`: ClaimResponse.AddItem.BodySite) {
    surrogateSerializer.serialize(encoder, ClaimResponseAddItemBodySiteSurrogate.fromModel(value))
  }
}
