...
internal data class DeviceMetricSurrogate(
  ...
  public fun toModel(): DeviceMetric =
    DeviceMetric(
      ...
      implicitRules =
        Uri.ofNullable(
          this@DeviceMetricSurrogate.implicitRules,
          this@DeviceMetricSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@DeviceMetricSurrogate.language, this@DeviceMetricSurrogate._language),
      ...
      color = Code.ofNullable(this@DeviceMetricSurrogate.color, this@DeviceMetricSurrogate._color),
      category =
        Enumeration.of(
    ...
    public fun fromModel(model: DeviceMetric): DeviceMetricSurrogate =
      with(model) {
        DeviceMetricSurrogate(
          ...
          calibration = this@with.calibration.takeUnless { it.isEmpty() },
        )
      }
  }
}
