      ...
      type =
        Enumeration.of(
          this@TestReportParticipantSurrogate.type?.let {
            com.google.fhir.model.r4.TestReport.TestReportParticipantType.fromCode(it)
          },
      ...
      result =
        Enumeration.of(
          this@TestReportSetupActionOperationSurrogate.result?.let {
            com.google.fhir.model.r4.TestReport.TestReportActionResult.fromCode(it)
          },
      ...
      status =
        Enumeration.of(
          this@TestReportSurrogate.status?.let {
            com.google.fhir.model.r4.TestReport.TestReportStatus.fromCode(it)
          },
      ...
      result =
        Enumeration.of(
          this@TestReportSurrogate.result?.let {
            com.google.fhir.model.r4.TestReport.TestReportResult.fromCode(it)
          },
