...
internal data class TestReportTestSurrogate(
  ...
  public fun toModel(): TestReport.Test =
    TestReport.Test(
      ...
      name =
        R4String.ofNullable(this@TestReportTestSurrogate.name, this@TestReportTestSurrogate._name),
      description =
        R4String.ofNullable(
...
internal data class TestReportSurrogate(
  ...
  public fun toModel(): TestReport =
    TestReport(
      ...
      name = R4String.ofNullable(this@TestReportSurrogate.name, this@TestReportSurrogate._name),
      status =
        Enumeration.of(
      ...
      tester =
        R4String.ofNullable(this@TestReportSurrogate.tester, this@TestReportSurrogate._tester),
      issued =
        DateTime.ofNullable(
