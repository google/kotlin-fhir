...
internal data class StructureMapConstSurrogate(
  ...
  public fun toModel(): StructureMap.Const =
    StructureMap.Const(
      ...
      name =
        Id.ofNullable(this@StructureMapConstSurrogate.name, this@StructureMapConstSurrogate._name),
      `value` =
        R5String.ofNullable(
          this@StructureMapConstSurrogate.`value`,
          this@StructureMapConstSurrogate._value,
        ),
    )
...
internal data class StructureMapGroupRuleSourceSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var context: KotlinString?,
    ...
    public fun fromModel(model: StructureMap.Group.Rule): StructureMapGroupRuleSurrogate =
      with(model) {
        StructureMapGroupRuleSurrogate(
          ...
          dependent = this@with.dependent.takeUnless { it.isEmpty() },
          documentation = this@with.documentation?.value,
          _documentation = this@with.documentation?.toElement(),
        )
      }
...
internal data class StructureMapGroupSurrogate(
  ...
  public fun toModel(): StructureMap.Group =
    StructureMap.Group(
      ...
      extends =
        Id.ofNullable(
          this@StructureMapGroupSurrogate.extends,
          this@StructureMapGroupSurrogate._extends,
        ),
      typeMode =
...
internal data class StructureMapSurrogate(
  ...
  public fun toModel(): StructureMap =
    StructureMap(
      ...
      implicitRules =
        Uri.ofNullable(
          this@StructureMapSurrogate.implicitRules,
          this@StructureMapSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@StructureMapSurrogate.language, this@StructureMapSurrogate._language),
      ...
      version =
        R5String.ofNullable(
          this@StructureMapSurrogate.version,
          this@StructureMapSurrogate._version,
        ),
      versionAlgorithm =
        StructureMap.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      title =
        R5String.ofNullable(this@StructureMapSurrogate.title, this@StructureMapSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R5String.ofNullable(
          this@StructureMapSurrogate.publisher,
          this@StructureMapSurrogate._publisher,
        ),
      ...
      purpose =
        Markdown.ofNullable(
          this@StructureMapSurrogate.purpose,
          this@StructureMapSurrogate._purpose,
        ),
      copyright =
        Markdown.ofNullable(
          this@StructureMapSurrogate.copyright,
          this@StructureMapSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
    ...
    public fun fromModel(model: StructureMap): StructureMapSurrogate =
      with(model) {
        StructureMapSurrogate(
          ...
          structure = this@with.structure.takeUnless { it.isEmpty() },
          `import` =
            this@with.`import`.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _import =
            this@with.`import`
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ?.map { it ?: Element() }
              ?.toMutableList(),
          `const` = this@with.`const`.takeUnless { it.isEmpty() },
