...
internal data class MeasureSurrogate(
  ...
  public fun toModel(): Measure =
    Measure(
      ...
      version = R4bString.ofNullable(this@MeasureSurrogate.version, this@MeasureSurrogate._version),
      name = R4bString.ofNullable(this@MeasureSurrogate.name, this@MeasureSurrogate._name),
      title = R4bString.ofNullable(this@MeasureSurrogate.title, this@MeasureSurrogate._title),
      subtitle =
        R4bString.ofNullable(this@MeasureSurrogate.subtitle, this@MeasureSurrogate._subtitle),
      status =
        Enumeration.of(
      ...
      publisher =
        R4bString.ofNullable(this@MeasureSurrogate.publisher, this@MeasureSurrogate._publisher),
      ...
      usage = R4bString.ofNullable(this@MeasureSurrogate.usage, this@MeasureSurrogate._usage),
      copyright =
