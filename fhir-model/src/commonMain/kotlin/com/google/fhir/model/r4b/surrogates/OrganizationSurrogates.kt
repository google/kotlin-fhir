    ...
    Organization(
      ...
      active =
        R4bBoolean.ofNullable(
          this@OrganizationSurrogate.active,
          this@OrganizationSurrogate._active,
        ),
      type = this@OrganizationSurrogate.type ?: mutableListOf(),
      name =
        R4bString.ofNullable(this@OrganizationSurrogate.name, this@OrganizationSurrogate._name),
      alias =
