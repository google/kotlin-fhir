...
internal data class ScheduleSurrogate(
  ...
  public fun toModel(): Schedule =
    Schedule(
      ...
      active = R4Boolean.ofNullable(this@ScheduleSurrogate.active, this@ScheduleSurrogate._active),
      ...
      comment = R4String.ofNullable(this@ScheduleSurrogate.comment, this@ScheduleSurrogate._comment),
    )
