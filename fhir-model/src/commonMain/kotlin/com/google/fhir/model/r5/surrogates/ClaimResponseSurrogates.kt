...
internal data class ClaimResponseItemDetailSubDetailSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var subDetailSequence: Int?,
...
internal data class ClaimResponseAddItemSurrogate(
  ...
  public fun toModel(): ClaimResponse.AddItem =
    ClaimResponse.AddItem(
      ...
      serviced =
        ClaimResponse.AddItem.Serviced?.fromNullable(
          Date.ofNullable(
      ...
      location =
        ClaimResponse.AddItem.Location?.fromNullable(
    ...
    public fun fromModel(model: ClaimResponse.Error): ClaimResponseErrorSurrogate =
      with(model) {
        ClaimResponseErrorSurrogate(
          ...
          code = this@with.code,
          expression =
            this@with.expression.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _expression =
...
internal data class ClaimResponseSurrogate(
  ...
  public fun toModel(): ClaimResponse =
    ClaimResponse(
      ...
      language =
        Code.ofNullable(
          this@ClaimResponseSurrogate.language,
          this@ClaimResponseSurrogate._language,
        ),
    ...
    public fun fromModel(model: ClaimResponse): ClaimResponseSurrogate =
      with(model) {
        ClaimResponseSurrogate(
          ...
          communicationRequest = this@with.communicationRequest.takeUnless { it.isEmpty() },
          insurance = this@with.insurance.takeUnless { it.isEmpty() },
          error = this@with.error.takeUnless { it.isEmpty() },
        )
      }
  }
}
