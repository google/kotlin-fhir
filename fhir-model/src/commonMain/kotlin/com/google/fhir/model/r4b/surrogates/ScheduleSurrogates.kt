...
internal data class ScheduleSurrogate(
  ...
  public fun toModel(): Schedule =
    Schedule(
      ...
      active = R4bBoolean.ofNullable(this@ScheduleSurrogate.active, this@ScheduleSurrogate._active),
      ...
      comment =
        R4bString.ofNullable(this@ScheduleSurrogate.comment, this@ScheduleSurrogate._comment),
    )
