...
internal data class AttachmentSurrogate(
  ...
  public fun toModel(): Attachment =
    Attachment(
      ...
      contentType =
        Code.ofNullable(
          this@AttachmentSurrogate.contentType,
          this@AttachmentSurrogate._contentType,
        ),
      language =
        Code.ofNullable(this@AttachmentSurrogate.language, this@AttachmentSurrogate._language),
      `data` =
        Base64Binary.ofNullable(this@AttachmentSurrogate.`data`, this@AttachmentSurrogate._data),
      url = Url.ofNullable(this@AttachmentSurrogate.url, this@AttachmentSurrogate._url),
      size = Integer64.ofNullable(this@AttachmentSurrogate.size, this@AttachmentSurrogate._size),
      hash = Base64Binary.ofNullable(this@AttachmentSurrogate.hash, this@AttachmentSurrogate._hash),
      title = R5String.ofNullable(this@AttachmentSurrogate.title, this@AttachmentSurrogate._title),
      creation =
        DateTime.ofNullable(
      ...
      height =
        PositiveInt.ofNullable(this@AttachmentSurrogate.height, this@AttachmentSurrogate._height),
      width =
        PositiveInt.ofNullable(this@AttachmentSurrogate.width, this@AttachmentSurrogate._width),
      frames =
        PositiveInt.ofNullable(this@AttachmentSurrogate.frames, this@AttachmentSurrogate._frames),
      duration =
        Decimal.ofNullable(this@AttachmentSurrogate.duration, this@AttachmentSurrogate._duration),
      pages =
        PositiveInt.ofNullable(this@AttachmentSurrogate.pages, this@AttachmentSurrogate._pages),
    )
