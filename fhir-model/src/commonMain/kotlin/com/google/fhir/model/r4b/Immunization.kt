...
public data class Immunization(
   ...
   * administration.
   */
  public var education: MutableList<Education> = mutableListOf(),
  /** Indicates a patient's eligibility for a funding program. */
  public var programEligibility: MutableList<CodeableConcept> = mutableListOf(),
  /**
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4b.Immunization.ProtocolApplied.DoseNumber"
          )
        }
    ...
    public sealed interface SeriesDoses {
      ...
      public companion object {
        public fun from(
          ...
          if (stringValue != null) return String(stringValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4b.Immunization.ProtocolApplied.SeriesDoses"
          )
        }
  ...
  public sealed interface Occurrence {
    ...
    public companion object {
      public fun from(
        ...
        if (stringValue != null) return String(stringValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r4b.Immunization.Occurrence"
        )
      }
