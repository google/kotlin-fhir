      ...
      kind =
        Enumeration.of(
          this@PlanDefinitionActionConditionSurrogate.kind?.let {
            com.google.fhir.model.r4b.PlanDefinition.ActionConditionKind.fromCode(it)
          },
      ...
      relationship =
        Enumeration.of(
          this@PlanDefinitionActionRelatedActionSurrogate.relationship?.let {
            com.google.fhir.model.r4b.PlanDefinition.ActionRelationshipType.fromCode(it)
          },
      ...
      type =
        Enumeration.of(
          this@PlanDefinitionActionParticipantSurrogate.type?.let {
            com.google.fhir.model.r4b.PlanDefinition.ActionParticipantType.fromCode(it)
          },
