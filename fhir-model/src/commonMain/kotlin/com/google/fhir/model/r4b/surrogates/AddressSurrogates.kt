...
internal data class AddressSurrogate(
  ...
  public fun toModel(): Address =
    Address(
      ...
      text = R4bString.ofNullable(this@AddressSurrogate.text, this@AddressSurrogate._text),
      line =
      ...
      city = R4bString.ofNullable(this@AddressSurrogate.city, this@AddressSurrogate._city),
      district =
        R4bString.ofNullable(this@AddressSurrogate.district, this@AddressSurrogate._district),
      state = R4bString.ofNullable(this@AddressSurrogate.state, this@AddressSurrogate._state),
      postalCode =
        R4bString.ofNullable(this@AddressSurrogate.postalCode, this@AddressSurrogate._postalCode),
      country = R4bString.ofNullable(this@AddressSurrogate.country, this@AddressSurrogate._country),
