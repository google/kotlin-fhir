...
internal data class ExplanationOfBenefitSupportingInfoSurrogate(
  ...
  public fun toModel(): ExplanationOfBenefit.SupportingInfo =
    ExplanationOfBenefit.SupportingInfo(
      ...
      timing =
        ExplanationOfBenefit.SupportingInfo.Timing?.fromNullable(
          Date.ofNullable(
      ...
      `value` =
        ExplanationOfBenefit.SupportingInfo.Value?.fromNullable(
          R5Boolean.ofNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitProcedureSurrogate(
          ...
          udi = this@with.udi.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ExplanationOfBenefitInsuranceSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var focal: KotlinBoolean?,
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitInsuranceSurrogate(
          ...
          preAuthRef =
            this@with.preAuthRef.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _preAuthRef =
...
internal data class ExplanationOfBenefitAccidentSurrogate(
  ...
  public fun toModel(): ExplanationOfBenefit.Accident =
    ExplanationOfBenefit.Accident(
      ...
      location =
        ExplanationOfBenefit.Accident.Location?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitItemBodySiteSurrogate(
          ...
          subSite = this@with.subSite.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitItemDetailSubDetailSurrogate(
          ...
          sequence = this@with.sequence.value!!,
          _sequence = this@with.sequence.toElement(),
          traceNumber = this@with.traceNumber.takeUnless { it.isEmpty() },
          revenue = this@with.revenue,
          category = this@with.category,
          productOrService = this@with.productOrService,
          productOrServiceEnd = this@with.productOrServiceEnd,
          modifier = this@with.modifier.takeUnless { it.isEmpty() },
          programCode = this@with.programCode.takeUnless { it.isEmpty() },
          ...
          udi = this@with.udi.takeUnless { it.isEmpty() },
          noteNumber =
            this@with.noteNumber.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _noteNumber =
          ...
          adjudication = this@with.adjudication.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitItemDetailSurrogate(
          ...
          reviewOutcome = this@with.reviewOutcome,
          adjudication = this@with.adjudication.takeUnless { it.isEmpty() },
          subDetail = this@with.subDetail.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ExplanationOfBenefitItemSurrogate(
  ...
  public fun toModel(): ExplanationOfBenefit.Item =
    ExplanationOfBenefit.Item(
      ...
      serviced =
        ExplanationOfBenefit.Item.Serviced?.fromNullable(
          Date.ofNullable(
      ...
      location =
        ExplanationOfBenefit.Item.Location?.fromNullable(
    ...
    public fun fromModel(model: ExplanationOfBenefit.Item): ExplanationOfBenefitItemSurrogate =
      with(model) {
        ExplanationOfBenefitItemSurrogate(
          ...
          productOrService = this@with.productOrService,
          productOrServiceEnd = this@with.productOrServiceEnd,
          request = this@with.request.takeUnless { it.isEmpty() },
          modifier = this@with.modifier.takeUnless { it.isEmpty() },
          programCode = this@with.programCode.takeUnless { it.isEmpty() },
          ...
          net = this@with.net,
          udi = this@with.udi.takeUnless { it.isEmpty() },
          bodySite = this@with.bodySite.takeUnless { it.isEmpty() },
          encounter = this@with.encounter.takeUnless { it.isEmpty() },
          noteNumber =
            this@with.noteNumber.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _noteNumber =
            this@with.noteNumber
...
internal data class ExplanationOfBenefitAddItemSurrogate(
  ...
  public fun toModel(): ExplanationOfBenefit.AddItem =
    ExplanationOfBenefit.AddItem(
      ...
      serviced =
        ExplanationOfBenefit.AddItem.Serviced?.fromNullable(
          Date.ofNullable(
      ...
      location =
        ExplanationOfBenefit.AddItem.Location?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitAddItemSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          itemSequence =
            this@with.itemSequence.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _itemSequence =
            this@with.itemSequence
              ...
              ?.toMutableList(),
          detailSequence =
            this@with.detailSequence.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _detailSequence =
          ...
          _subDetailSequence =
            this@with.subDetailSequence
              ...
              ?.toMutableList(),
          traceNumber = this@with.traceNumber.takeUnless { it.isEmpty() },
          provider = this@with.provider.takeUnless { it.isEmpty() },
          revenue = this@with.revenue,
          productOrService = this@with.productOrService,
          productOrServiceEnd = this@with.productOrServiceEnd,
          request = this@with.request.takeUnless { it.isEmpty() },
...
internal data class ExplanationOfBenefitBenefitBalanceFinancialSurrogate(
  ...
  public fun toModel(): ExplanationOfBenefit.BenefitBalance.Financial =
    ExplanationOfBenefit.BenefitBalance.Financial(
      ...
      allowed =
        ExplanationOfBenefit.BenefitBalance.Financial.Allowed?.fromNullable(
      ...
      used =
        ExplanationOfBenefit.BenefitBalance.Financial.Used?.fromNullable(
          UnsignedInt.ofNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ExplanationOfBenefitBenefitBalanceSurrogate(
          ...
          unit = this@with.unit,
          term = this@with.term,
          financial = this@with.financial.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ExplanationOfBenefitSurrogate(
  ...
  public var created: KotlinString?,
  ...
  public var outcome: KotlinString?,
    ...
    public fun fromModel(model: ExplanationOfBenefit): ExplanationOfBenefitSurrogate =
      with(model) {
        ExplanationOfBenefitSurrogate(
          ...
          related = this@with.related.takeUnless { it.isEmpty() },
          prescription = this@with.prescription,
          originalPrescription = this@with.originalPrescription,
          event = this@with.event.takeUnless { it.isEmpty() },
          ...
          _preAuthRef =
            this@with.preAuthRef
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          preAuthRefPeriod = this@with.preAuthRefPeriod.takeUnless { it.isEmpty() },
          diagnosisRelatedGroup = this@with.diagnosisRelatedGroup,
          careTeam = this@with.careTeam.takeUnless { it.isEmpty() },
          supportingInfo = this@with.supportingInfo.takeUnless { it.isEmpty() },
          diagnosis = this@with.diagnosis.takeUnless { it.isEmpty() },
          procedure = this@with.procedure.takeUnless { it.isEmpty() },
          precedence = this@with.precedence?.value,
          _precedence = this@with.precedence?.toElement(),
          insurance = this@with.insurance.takeUnless { it.isEmpty() },
          accident = this@with.accident,
          patientPaid = this@with.patientPaid,
          item = this@with.item.takeUnless { it.isEmpty() },
          addItem = this@with.addItem.takeUnless { it.isEmpty() },
          adjudication = this@with.adjudication.takeUnless { it.isEmpty() },
          total = this@with.total.takeUnless { it.isEmpty() },
          payment = this@with.payment,
          formCode = this@with.formCode,
          form = this@with.form,
          processNote = this@with.processNote.takeUnless { it.isEmpty() },
          benefitPeriod = this@with.benefitPeriod,
          benefitBalance = this@with.benefitBalance.takeUnless { it.isEmpty() },
        )
      }
  }
}
