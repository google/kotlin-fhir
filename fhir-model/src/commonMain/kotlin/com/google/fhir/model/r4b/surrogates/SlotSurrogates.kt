...
internal data class SlotSurrogate(
  ...
  public fun toModel(): Slot =
    Slot(
      ...
      overbooked =
        R4bBoolean.ofNullable(this@SlotSurrogate.overbooked, this@SlotSurrogate._overbooked),
      comment = R4bString.ofNullable(this@SlotSurrogate.comment, this@SlotSurrogate._comment),
    )
