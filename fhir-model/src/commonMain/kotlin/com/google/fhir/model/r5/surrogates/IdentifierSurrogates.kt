    ...
    Identifier(
      ...
      use =
        this@IdentifierSurrogate.use?.let {
          Enumeration.of(
            com.google.fhir.model.r5.Identifier.IdentifierUse.fromCode(it!!),
            this@IdentifierSurrogate._use,
          )
        },
      type = this@IdentifierSurrogate.type,
      system = Uri.ofNullable(this@IdentifierSurrogate.system, this@IdentifierSurrogate._system),
      `value` =
        R5String.ofNullable(this@IdentifierSurrogate.`value`, this@IdentifierSurrogate._value),
