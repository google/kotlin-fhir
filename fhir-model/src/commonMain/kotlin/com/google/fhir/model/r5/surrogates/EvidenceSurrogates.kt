    ...
    public fun fromModel(
      ...
      with(model) {
        EvidenceStatisticAttributeEstimateSurrogate(
          ...
          attributeEstimate = this@with.attributeEstimate.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        EvidenceStatisticModelCharacteristicVariableSurrogate(
          ...
          valueCategory = this@with.valueCategory.takeUnless { it.isEmpty() },
          valueQuantity = this@with.valueQuantity.takeUnless { it.isEmpty() },
          valueRange = this@with.valueRange.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: Evidence.Statistic): EvidenceStatisticSurrogate =
      with(model) {
        EvidenceStatisticSurrogate(
          ...
          attributeEstimate = this@with.attributeEstimate.takeUnless { it.isEmpty() },
          modelCharacteristic = this@with.modelCharacteristic.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class EvidenceCertaintySurrogate(
  ...
  public fun toModel(): Evidence.Certainty =
    Evidence.Certainty(
      ...
      rater =
        R5String.ofNullable(
          this@EvidenceCertaintySurrogate.rater,
          this@EvidenceCertaintySurrogate._rater,
        ),
    ...
    public fun fromModel(model: Evidence.Certainty): EvidenceCertaintySurrogate =
      with(model) {
        EvidenceCertaintySurrogate(
          ...
          subcomponent = this@with.subcomponent.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class EvidenceSurrogate(
  ...
  public fun toModel(): Evidence =
    Evidence(
      ...
      implicitRules =
        Uri.ofNullable(this@EvidenceSurrogate.implicitRules, this@EvidenceSurrogate._implicitRules),
      language = Code.ofNullable(this@EvidenceSurrogate.language, this@EvidenceSurrogate._language),
      ...
      url = Uri.ofNullable(this@EvidenceSurrogate.url, this@EvidenceSurrogate._url),
      identifier = this@EvidenceSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@EvidenceSurrogate.version, this@EvidenceSurrogate._version),
      versionAlgorithm =
        Evidence.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@EvidenceSurrogate.name, this@EvidenceSurrogate._name),
      title = R5String.ofNullable(this@EvidenceSurrogate.title, this@EvidenceSurrogate._title),
      citeAs =
        Evidence.CiteAs?.fromNullable(
          this@EvidenceSurrogate.citeAsReference,
          Markdown.ofNullable(
            this@EvidenceSurrogate.citeAsMarkdown,
            this@EvidenceSurrogate._citeAsMarkdown,
          ),
        ),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@EvidenceSurrogate.experimental,
          this@EvidenceSurrogate._experimental,
        ),
      date =
        DateTime.ofNullable(
      ...
      publisher =
        R5String.ofNullable(this@EvidenceSurrogate.publisher, this@EvidenceSurrogate._publisher),
      ...
      purpose =
        Markdown.ofNullable(this@EvidenceSurrogate.purpose, this@EvidenceSurrogate._purpose),
      copyright =
        Markdown.ofNullable(this@EvidenceSurrogate.copyright, this@EvidenceSurrogate._copyright),
      copyrightLabel =
        R5String.ofNullable(
          this@EvidenceSurrogate.copyrightLabel,
          this@EvidenceSurrogate._copyrightLabel,
        ),
      relatedArtifact = this@EvidenceSurrogate.relatedArtifact ?: mutableListOf(),
      description =
        Markdown.ofNullable(
          this@EvidenceSurrogate.description,
          this@EvidenceSurrogate._description,
        ),
      assertion =
        Markdown.ofNullable(this@EvidenceSurrogate.assertion, this@EvidenceSurrogate._assertion),
    ...
    public fun fromModel(model: Evidence): EvidenceSurrogate =
      with(model) {
        EvidenceSurrogate(
          ...
          note = this@with.note.takeUnless { it.isEmpty() },
          variableDefinition = this@with.variableDefinition.takeUnless { it.isEmpty() },
          synthesisType = this@with.synthesisType,
          studyDesign = this@with.studyDesign.takeUnless { it.isEmpty() },
          statistic = this@with.statistic.takeUnless { it.isEmpty() },
          certainty = this@with.certainty.takeUnless { it.isEmpty() },
        )
      }
  }
}
