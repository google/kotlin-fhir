    ...
    public fun fromModel(model: CarePlan.Activity): CarePlanActivitySurrogate =
      with(model) {
        CarePlanActivitySurrogate(
          ...
          performedActivity = this@with.performedActivity.takeUnless { it.isEmpty() },
...
internal data class CarePlanSurrogate(
  ...
  public fun toModel(): CarePlan =
    CarePlan(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r5.CarePlan.CarePlanStatus.fromCode(
      ...
      title = R5String.ofNullable(this@CarePlanSurrogate.title, this@CarePlanSurrogate._title),
      description =
        R5String.ofNullable(
