...
internal data class ChargeItemSurrogate(
  ...
  public fun toModel(): ChargeItem =
    ChargeItem(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ChargeItemSurrogate.implicitRules,
          this@ChargeItemSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ChargeItemSurrogate.language, this@ChargeItemSurrogate._language),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.ChargeItem.ChargeItemStatus.fromCode(
      ...
      occurrence =
        ChargeItem.Occurrence?.fromNullable(
          DateTime.ofNullable(
      ...
      product =
        ChargeItem.Product?.fromNullable(
    ...
    public fun fromModel(model: ChargeItem): ChargeItemSurrogate =
      with(model) {
        ChargeItemSurrogate(
          ...
          definitionUri =
            this@with.definitionUri.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _definitionUri =
