...
public data class Observation(
  ...
  public var triggeredBy: MutableList<TriggeredBy> = mutableListOf(),
  /**
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Observation.Component.Value"
          )
        }
  ...
  public sealed interface Instantiates {
    ...
    public companion object {
      public fun from(
        ...
        if (ReferenceValue != null) return Reference(ReferenceValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.Observation.Instantiates"
        )
      }
  ...
  public sealed interface Effective {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.Observation.Effective"
        )
      }
  ...
  public sealed interface Value {
    ...
    public companion object {
      public fun from(
        ...
        if (ReferenceValue != null) return Reference(ReferenceValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.Observation.Value"
        )
      }
