...
internal data class CareTeamParticipantSurrogate(
  ...
  public fun toModel(): CareTeam.Participant =
    CareTeam.Participant(
      ...
      coverage =
        CareTeam.Participant.Coverage?.fromNullable(
...
internal data class CareTeamSurrogate(
  ...
  public fun toModel(): CareTeam =
    CareTeam(
      ...
      implicitRules =
        Uri.ofNullable(this@CareTeamSurrogate.implicitRules, this@CareTeamSurrogate._implicitRules),
      language = Code.ofNullable(this@CareTeamSurrogate.language, this@CareTeamSurrogate._language),
      ...
      name = R5String.ofNullable(this@CareTeamSurrogate.name, this@CareTeamSurrogate._name),
    ...
    public fun fromModel(model: CareTeam): CareTeamSurrogate =
      with(model) {
        CareTeamSurrogate(
          ...
          managingOrganization = this@with.managingOrganization.takeUnless { it.isEmpty() },
