...
import com.google.fhir.model.r4b.Substance
import com.google.fhir.model.r4b.surrogates.SubstanceIngredientSubstanceSurrogate
import com.google.fhir.model.r4b.surrogates.SubstanceIngredientSurrogate
import com.google.fhir.model.r4b.surrogates.SubstanceInstanceSurrogate
import com.google.fhir.model.r4b.surrogates.SubstanceSurrogate
...
public object SubstanceIngredientSerializer : KSerializer<Substance.Ingredient> {
  ...
  private val multiChoiceProperties: List<String> = listOf("substance")
  ...
  override fun serialize(encoder: Encoder, `value`: Substance.Ingredient) {
    ...
    val surrogate = SubstanceIngredientSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
