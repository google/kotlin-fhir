...
internal data class ImmunizationProtocolAppliedSurrogate(
  ...
  public fun toModel(): Immunization.ProtocolApplied =
    Immunization.ProtocolApplied(
      ...
      seriesDoses =
        Immunization.ProtocolApplied.SeriesDoses?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        ImmunizationProtocolAppliedSurrogate(
          ...
          targetDisease = this@with.targetDisease.takeUnless { it.isEmpty() },
...
internal data class ImmunizationSurrogate(
  ...
  public fun toModel(): Immunization =
    Immunization(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ImmunizationSurrogate.implicitRules,
          this@ImmunizationSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ImmunizationSurrogate.language, this@ImmunizationSurrogate._language),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.Immunization.ImmunizationStatus.fromCode(
      ...
      lotNumber =
        R4String.ofNullable(
          this@ImmunizationSurrogate.lotNumber,
          this@ImmunizationSurrogate._lotNumber,
        ),
      expirationDate =
        Date.ofNullable(
    ...
    public fun fromModel(model: Immunization): ImmunizationSurrogate =
      with(model) {
        ImmunizationSurrogate(
          ...
          subpotentReason = this@with.subpotentReason.takeUnless { it.isEmpty() },
          education = this@with.education.takeUnless { it.isEmpty() },
          programEligibility = this@with.programEligibility.takeUnless { it.isEmpty() },
          fundingSource = this@with.fundingSource,
          reaction = this@with.reaction.takeUnless { it.isEmpty() },
          protocolApplied = this@with.protocolApplied.takeUnless { it.isEmpty() },
        )
      }
  }
}
