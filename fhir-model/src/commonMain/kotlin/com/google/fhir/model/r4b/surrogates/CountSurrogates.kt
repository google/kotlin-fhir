...
internal data class CountSurrogate(
  ...
  public fun toModel(): Count =
    Count(
      ...
      `value` = Decimal.ofNullable(this@CountSurrogate.`value`, this@CountSurrogate._value),
      comparator =
      ...
      unit = R4bString.ofNullable(this@CountSurrogate.unit, this@CountSurrogate._unit),
      system = Uri.ofNullable(this@CountSurrogate.system, this@CountSurrogate._system),
      code = Code.ofNullable(this@CountSurrogate.code, this@CountSurrogate._code),
    )
