      ...
      mode =
        Enumeration.of(
          this@CompositionAttesterSurrogate.mode?.let {
            com.google.fhir.model.r4b.Composition.CompositionAttestationMode.fromCode(it)
          },
...
@Serializable
internal class CompositionRelatesToTargetSurrogate {
  ...
  public fun toModel(): Composition.RelatesTo.Target =
    ...
    ) ?: Composition.RelatesTo.Target.Null
...
internal data class CompositionRelatesToSurrogate(
  ...
  public var target: Composition.RelatesTo.Target? = null,
) {
      ...
      code =
        Enumeration.of(
          this@CompositionRelatesToSurrogate.code?.let {
            com.google.fhir.model.r4b.Composition.DocumentRelationshipType.fromCode(it)
          },
      ...
      status =
        Enumeration.of(
          this@CompositionSurrogate.status?.let {
            com.google.fhir.model.r4b.Composition.CompositionStatus.fromCode(it)
          },
