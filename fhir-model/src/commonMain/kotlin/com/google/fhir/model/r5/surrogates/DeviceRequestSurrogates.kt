...
internal data class DeviceRequestParameterSurrogate(
  ...
  public fun toModel(): DeviceRequest.Parameter =
    DeviceRequest.Parameter(
      ...
      `value` =
        DeviceRequest.Parameter.Value?.fromNullable(
...
internal data class DeviceRequestSurrogate(
  ...
  public fun toModel(): DeviceRequest =
    DeviceRequest(
      ...
      language =
        Code.ofNullable(
          this@DeviceRequestSurrogate.language,
          this@DeviceRequestSurrogate._language,
        ),
      ...
      quantity =
        Integer.ofNullable(
          this@DeviceRequestSurrogate.quantity,
          this@DeviceRequestSurrogate._quantity,
        ),
      ...
      occurrence =
        DeviceRequest.Occurrence?.fromNullable(
          DateTime.ofNullable(
      ...
      asNeeded =
        R5Boolean.ofNullable(
          this@DeviceRequestSurrogate.asNeeded,
          this@DeviceRequestSurrogate._asNeeded,
        ),
