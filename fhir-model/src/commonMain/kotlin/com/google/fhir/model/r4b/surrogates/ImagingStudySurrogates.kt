...
internal data class ImagingStudySurrogate(
  ...
  public fun toModel(): ImagingStudy =
    ImagingStudy(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ImagingStudySurrogate.implicitRules,
          this@ImagingStudySurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ImagingStudySurrogate.language, this@ImagingStudySurrogate._language),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.ImagingStudy.ImagingStudyStatus.fromCode(
    ...
    public fun fromModel(model: ImagingStudy): ImagingStudySurrogate =
      with(model) {
        ImagingStudySurrogate(
          ...
          modality = this@with.modality.takeUnless { it.isEmpty() },
          ...
          procedureCode = this@with.procedureCode.takeUnless { it.isEmpty() },
          ...
          description = this@with.description?.value,
          _description = this@with.description?.toElement(),
          series = this@with.series.takeUnless { it.isEmpty() },
        )
      }
  }
}
