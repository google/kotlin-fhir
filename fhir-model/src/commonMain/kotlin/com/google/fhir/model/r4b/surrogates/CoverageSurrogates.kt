...
internal data class CoverageClassSurrogate(
  ...
  public fun toModel(): Coverage.Class =
    Coverage.Class(
      ...
      name =
        R4bString.ofNullable(this@CoverageClassSurrogate.name, this@CoverageClassSurrogate._name),
    )
...
internal data class CoverageSurrogate(
  ...
  public fun toModel(): Coverage =
    Coverage(
      ...
      dependent =
        R4bString.ofNullable(this@CoverageSurrogate.dependent, this@CoverageSurrogate._dependent),
      ...
      network =
        R4bString.ofNullable(this@CoverageSurrogate.network, this@CoverageSurrogate._network),
