...
internal data class CodingSurrogate(
  ...
  public fun toModel(): Coding =
    Coding(
      ...
      system = Uri.ofNullable(this@CodingSurrogate.system, this@CodingSurrogate._system),
      version = R4bString.ofNullable(this@CodingSurrogate.version, this@CodingSurrogate._version),
      code = Code.ofNullable(this@CodingSurrogate.code, this@CodingSurrogate._code),
      display = R4bString.ofNullable(this@CodingSurrogate.display, this@CodingSurrogate._display),
      userSelected =
        R4bBoolean.ofNullable(this@CodingSurrogate.userSelected, this@CodingSurrogate._userSelected),
    )
