...
internal data class AccountSurrogate(
  ...
  public fun toModel(): Account =
    Account(
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.Account.AccountStatus.fromCode(this@AccountSurrogate.status!!),
          this@AccountSurrogate._status,
        ),
      type = this@AccountSurrogate.type,
      name = R4bString.ofNullable(this@AccountSurrogate.name, this@AccountSurrogate._name),
      ...
      description =
        R4bString.ofNullable(this@AccountSurrogate.description, this@AccountSurrogate._description),
