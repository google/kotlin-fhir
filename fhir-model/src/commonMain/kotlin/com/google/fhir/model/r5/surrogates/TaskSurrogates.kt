...
internal data class TaskSurrogate(
  ...
  public fun toModel(): Task =
    Task(
      ...
      doNotPerform =
        R5Boolean.ofNullable(this@TaskSurrogate.doNotPerform, this@TaskSurrogate._doNotPerform),
      code = this@TaskSurrogate.code,
      description =
        R5String.ofNullable(this@TaskSurrogate.description, this@TaskSurrogate._description),
    ...
    public fun fromModel(model: Task): TaskSurrogate =
      with(model) {
        TaskSurrogate(
          ...
          requestedPerformer = this@with.requestedPerformer.takeUnless { it.isEmpty() },
