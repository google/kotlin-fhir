...
internal data class TaskPerformerSurrogate(
  ...
  public fun toModel(): Task.Performer =
    Task.Performer(
      ...
      extension = this@TaskPerformerSurrogate.extension ?: listOf(),
      modifierExtension = this@TaskPerformerSurrogate.modifierExtension ?: listOf(),
...
internal data class TaskInputValueSurrogate(
  ...
  public fun toModel(): Task.Input.Value =
    Task.Input.Value.from(
      ...
      Integer64.of(
        this@TaskInputValueSurrogate.valueInteger64?.toLong(),
...
internal data class TaskOutputValueSurrogate(
  ...
  public fun toModel(): Task.Output.Value =
    Task.Output.Value.from(
      ...
      Integer64.of(
        this@TaskOutputValueSurrogate.valueInteger64?.toLong(),
...
internal data class TaskSurrogate(
  ...
  public fun toModel(): Task =
    Task(
      ...
      requestedPerformer = this@TaskSurrogate.requestedPerformer ?: listOf(),
      owner = this@TaskSurrogate.owner,
      performer = this@TaskSurrogate.performer ?: listOf(),
      location = this@TaskSurrogate.location,
      reason = this@TaskSurrogate.reason ?: listOf(),
