...
@Serializable
internal class ElementDefinitionExampleValueSurrogate {
  ...
  public fun toModel(): ElementDefinition.Example.Value =
    ElementDefinition.Example.Value?.from(
      ...
      Integer64.of(
        this@ElementDefinitionExampleValueSurrogate.valueInteger64,
        this@ElementDefinitionExampleValueSurrogate._valueInteger64,
      ),
      Markdown.of(
      ...
      this@ElementDefinitionExampleValueSurrogate.valueCodeableReference,
      ...
      this@ElementDefinitionExampleValueSurrogate.valueRatioRange,
      ...
      this@ElementDefinitionExampleValueSurrogate.valueAvailability,
    ...
    ) ?: ElementDefinition.Example.Value.Null
  ...
  public companion object {
    public fun fromModel(
      ...
      with(model) {
        ElementDefinitionExampleValueSurrogate().apply {
...
internal data class ElementDefinitionExampleSurrogate(
  ...
  public var `value`: ElementDefinition.Example.Value? = null,
) {
...
@Serializable
internal class ElementDefinitionDefaultValueSurrogate {
  ...
  public fun toModel(): ElementDefinition.DefaultValue =
    ElementDefinition.DefaultValue?.from(
      ...
      Integer64.of(
        this@ElementDefinitionDefaultValueSurrogate.defaultValueInteger64,
    ...
    ) ?: ElementDefinition.DefaultValue.Null
  ...
  public companion object {
    public fun fromModel(
      ...
      with(model) {
        ElementDefinitionDefaultValueSurrogate().apply {
          ...
          defaultValueInteger64 = this@with.asInteger64()?.value?.value
...
@Serializable
internal class ElementDefinitionFixedSurrogate {
  ...
  public fun toModel(): ElementDefinition.Fixed =
    ElementDefinition.Fixed?.from(
      ...
      Integer64.of(
        this@ElementDefinitionFixedSurrogate.fixedInteger64,
    ...
    public fun fromModel(model: ElementDefinition.Fixed): ElementDefinitionFixedSurrogate =
      with(model) {
        ElementDefinitionFixedSurrogate().apply {
          ...
          fixedInteger64 = this@with.asInteger64()?.value?.value
...
@Serializable
internal class ElementDefinitionPatternSurrogate {
  ...
  public var patternInteger64: Int? = null
  ...
  public fun toModel(): ElementDefinition.Pattern =
    ElementDefinition.Pattern?.from(
      ...
      Integer64.of(
        this@ElementDefinitionPatternSurrogate.patternInteger64,
    ...
    public fun fromModel(model: ElementDefinition.Pattern): ElementDefinitionPatternSurrogate =
      with(model) {
        ElementDefinitionPatternSurrogate().apply {
          ...
          patternInteger64 = this@with.asInteger64()?.value?.value
...
@Serializable
internal class ElementDefinitionMinValueSurrogate {
  ...
  public fun toModel(): ElementDefinition.MinValue =
    ElementDefinition.MinValue?.from(
      ...
      Integer64.of(
        this@ElementDefinitionMinValueSurrogate.minValueInteger64,
        this@ElementDefinitionMinValueSurrogate._minValueInteger64,
      ),
      PositiveInt.of(
    ...
    public fun fromModel(model: ElementDefinition.MinValue): ElementDefinitionMinValueSurrogate =
      with(model) {
        ElementDefinitionMinValueSurrogate().apply {
          ...
          minValueInteger64 = this@with.asInteger64()?.value?.value
          _minValueInteger64 = this@with.asInteger64()?.value?.toElement()
...
@Serializable
internal class ElementDefinitionMaxValueSurrogate {
  ...
  public fun toModel(): ElementDefinition.MaxValue =
    ElementDefinition.MaxValue?.from(
      ...
      Integer64.of(
        this@ElementDefinitionMaxValueSurrogate.maxValueInteger64,
        this@ElementDefinitionMaxValueSurrogate._maxValueInteger64,
      ),
      PositiveInt.of(
    ...
    public fun fromModel(model: ElementDefinition.MaxValue): ElementDefinitionMaxValueSurrogate =
      with(model) {
        ElementDefinitionMaxValueSurrogate().apply {
          ...
          maxValueInteger64 = this@with.asInteger64()?.value?.value
          _maxValueInteger64 = this@with.asInteger64()?.value?.toElement()
