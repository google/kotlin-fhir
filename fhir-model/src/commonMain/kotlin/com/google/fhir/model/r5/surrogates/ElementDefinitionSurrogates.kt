...
internal data class ElementDefinitionBindingSurrogate(
  ...
  public fun toModel(): ElementDefinition.Binding =
    ElementDefinition.Binding(
      ...
      additional = this@ElementDefinitionBindingSurrogate.additional ?: listOf(),
    )
...
internal data class ElementDefinitionBindingAdditionalSurrogate(
  ...
  public fun toModel(): ElementDefinition.Binding.Additional =
    ElementDefinition.Binding.Additional(
      ...
      extension = this@ElementDefinitionBindingAdditionalSurrogate.extension ?: listOf(),
      purpose =
        Enumeration.of(
      ...
      usage = this@ElementDefinitionBindingAdditionalSurrogate.usage ?: listOf(),
      any =
        R5Boolean.of(
...
internal data class ElementDefinitionExampleValueSurrogate(
  ...
  public fun toModel(): ElementDefinition.Example.Value =
    ElementDefinition.Example.Value.from(
      ...
      Integer64.of(
        this@ElementDefinitionExampleValueSurrogate.valueInteger64?.toLong(),
...
internal data class ElementDefinitionMinValueSurrogate(
  ...
  public var minValueInteger64: KotlinString? = null,
  ...
  public fun toModel(): ElementDefinition.MinValue =
    ElementDefinition.MinValue.from(
      ...
      Integer64.of(
        this@ElementDefinitionMinValueSurrogate.minValueInteger64?.toLong(),
    ...
    public fun fromModel(model: ElementDefinition.MinValue): ElementDefinitionMinValueSurrogate =
      with(model) {
        ElementDefinitionMinValueSurrogate(
          ...
          minValueInteger64 = this@with.asInteger64()?.value?.value?.toString(),
...
internal data class ElementDefinitionMaxValueSurrogate(
  ...
  public var maxValueInteger64: KotlinString? = null,
  ...
  public fun toModel(): ElementDefinition.MaxValue =
    ElementDefinition.MaxValue.from(
      ...
      Integer64.of(
        this@ElementDefinitionMaxValueSurrogate.maxValueInteger64?.toLong(),
    ...
    public fun fromModel(model: ElementDefinition.MaxValue): ElementDefinitionMaxValueSurrogate =
      with(model) {
        ElementDefinitionMaxValueSurrogate(
          ...
          maxValueInteger64 = this@with.asInteger64()?.value?.value?.toString(),
