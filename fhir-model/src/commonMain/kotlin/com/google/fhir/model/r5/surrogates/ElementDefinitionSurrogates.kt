    ...
    ElementDefinition.Example(
      ...
      `value` =
        ElementDefinition.Example.Value.from(
          ...
          Integer64.of(
            this@ElementDefinitionExampleSurrogate.valueInteger64?.toLong(),
    ...
    ElementDefinition(
      ...
      defaultValue =
        ElementDefinition.DefaultValue?.from(
          ...
          Integer64.of(
            this@ElementDefinitionSurrogate.defaultValueInteger64?.toLong(),
      ...
      fixed =
        ElementDefinition.Fixed?.from(
          ...
          Integer64.of(
            this@ElementDefinitionSurrogate.fixedInteger64?.toLong(),
      ...
      minValue =
        ElementDefinition.MinValue?.from(
          ...
          Integer64.of(
            this@ElementDefinitionSurrogate.minValueInteger64?.toLong(),
      ...
      maxValue =
        ElementDefinition.MaxValue?.from(
          ...
          Integer64.of(
            this@ElementDefinitionSurrogate.maxValueInteger64?.toLong(),
    ...
    public fun fromModel(model: ElementDefinition): ElementDefinitionSurrogate =
      with(model) {
        ElementDefinitionSurrogate(
          ...
          defaultValueInteger64 = this@with.defaultValue?.asInteger64()?.value?.value?.toString(),
          ...
          fixedInteger64 = this@with.fixed?.asInteger64()?.value?.value?.toString(),
          ...
          minValueInteger64 = this@with.minValue?.asInteger64()?.value?.value?.toString(),
          ...
          maxValueInteger64 = this@with.maxValue?.asInteger64()?.value?.value?.toString(),
