    ...
    EvidenceReport.RelatesTo(
      ...
      target =
        EvidenceReport.RelatesTo.Target.from(
          this@EvidenceReportRelatesToSurrogate.targetIdentifier,
          this@EvidenceReportRelatesToSurrogate.targetReference,
        ),
    )
    ...
    public fun fromModel(model: EvidenceReport.Section): EvidenceReportSectionSurrogate =
      with(model) {
        EvidenceReportSectionSurrogate(
          ...
          entryClassifier = this@with.entryClassifier.takeUnless { it.isEmpty() },
          entryReference = this@with.entryReference.takeUnless { it.isEmpty() },
          entryQuantity = this@with.entryQuantity.takeUnless { it.isEmpty() },
...
internal data class EvidenceReportSurrogate(
  ...
  public fun toModel(): EvidenceReport =
    EvidenceReport(
      ...
      language =
        Code.ofNullable(
          this@EvidenceReportSurrogate.language,
          this@EvidenceReportSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@EvidenceReportSurrogate.url, this@EvidenceReportSurrogate._url),
      status =
        Enumeration.of(
      ...
      citeAs =
        EvidenceReport.CiteAs?.fromNullable(
