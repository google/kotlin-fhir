...
internal data class DocumentManifestSurrogate(
  ...
  public fun toModel(): DocumentManifest =
    DocumentManifest(
      ...
      language =
        Code.ofNullable(
          this@DocumentManifestSurrogate.language,
          this@DocumentManifestSurrogate._language,
        ),
      ...
      source =
        Uri.ofNullable(
          this@DocumentManifestSurrogate.source,
          this@DocumentManifestSurrogate._source,
        ),
      description =
