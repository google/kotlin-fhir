    ...
    public fun fromModel(model: SubstanceSourceMaterial): SubstanceSourceMaterialSurrogate =
      with(model) {
        SubstanceSourceMaterialSurrogate(
          ...
          parentSubstanceId = this@with.parentSubstanceId.takeUnless { it.isEmpty() },
          parentSubstanceName =
          ...
          fractionDescription = this@with.fractionDescription.takeUnless { it.isEmpty() },
          organism = this@with.organism,
          partDescription = this@with.partDescription.takeUnless { it.isEmpty() },
        )
      }
  }
}
