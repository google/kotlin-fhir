        ...
        ContractTermActionSurrogate(
          ...
          _performerLinkId =
            this@with.performerLinkId
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          reason = this@with.reason.takeUnless { it.isEmpty() },
          reasonLinkId =
...
internal data class ContractTermSurrogate(
  ...
  public fun toModel(): Contract.Term =
    Contract.Term(
      ...
      text = R5String.ofNullable(this@ContractTermSurrogate.text, this@ContractTermSurrogate._text),
...
internal data class ContractSurrogate(
  ...
  public fun toModel(): Contract =
    Contract(
      ...
      version =
        R5String.ofNullable(this@ContractSurrogate.version, this@ContractSurrogate._version),
      status =
      ...
      name = R5String.ofNullable(this@ContractSurrogate.name, this@ContractSurrogate._name),
      title = R5String.ofNullable(this@ContractSurrogate.title, this@ContractSurrogate._title),
      subtitle =
        R5String.ofNullable(this@ContractSurrogate.subtitle, this@ContractSurrogate._subtitle),
      alias =
