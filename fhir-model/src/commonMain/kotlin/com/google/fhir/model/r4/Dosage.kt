...
public data class Dosage(
  ...
  public class DoseAndRate(
    ...
    public sealed interface Dose {
      ...
      public data class Range(public val `value`: com.google.fhir.model.r4.Range) : Dose

      public data class Quantity(public val `value`: com.google.fhir.model.r4.Quantity) : Dose
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Dosage.DoseAndRate.Dose"
          )
        }
    ...
    public sealed interface Rate {
      ...
      public data class Range(public val `value`: com.google.fhir.model.r4.Range) : Rate
      ...
      public companion object {
        public fun from(
          ...
          if (QuantityValue != null) return Quantity(QuantityValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r4.Dosage.DoseAndRate.Rate"
          )
        }
  ...
  public sealed interface AsNeeded {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException("Missing value for com.google.fhir.model.r4.Dosage.AsNeeded")
      }
