...
import com.google.fhir.model.r4.surrogates.MediaCreatedSurrogate
import com.google.fhir.model.r4.surrogates.MediaSurrogate
...
public object MediaCreatedSerializer : KSerializer<Media.Created> {
  internal val surrogateSerializer: KSerializer<MediaCreatedSurrogate> by lazy {
    MediaCreatedSurrogate.serializer()
  }

  override val descriptor: SerialDescriptor by lazy {
    SerialDescriptor("Created", surrogateSerializer.descriptor)
  }
...
public object MediaSerializer : KSerializer<Media> {
  ...
  private val resourceType: String? = "Media"

  private val multiChoiceProperties: List<String> = listOf("created")
  ...
  override fun serialize(encoder: Encoder, `value`: Media) {
    ...
    val surrogate = MediaSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
