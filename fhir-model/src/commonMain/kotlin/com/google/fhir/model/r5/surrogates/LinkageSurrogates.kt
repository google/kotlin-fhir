...
internal data class LinkageItemSurrogate(
  ...
  public fun toModel(): Linkage.Item =
    Linkage.Item(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r5.Linkage.LinkageType.fromCode(this@LinkageItemSurrogate.type!!),
...
internal data class LinkageSurrogate(
  ...
  public fun toModel(): Linkage =
    Linkage(
      ...
      implicitRules =
        Uri.ofNullable(this@LinkageSurrogate.implicitRules, this@LinkageSurrogate._implicitRules),
      language = Code.ofNullable(this@LinkageSurrogate.language, this@LinkageSurrogate._language),
      ...
      active = R5Boolean.ofNullable(this@LinkageSurrogate.active, this@LinkageSurrogate._active),
