...
internal data class CommunicationRequestSurrogate(
  ...
  public fun toModel(): CommunicationRequest =
    CommunicationRequest().apply {
      ...
      status =
        Enumeration.of(
          this@CommunicationRequestSurrogate.status?.let {
            com.google.fhir.model.r5.CommunicationRequest.CommunicationRequestStatus.fromCode(it)
          },
      ...
      intent =
        Enumeration.of(
          this@CommunicationRequestSurrogate.intent?.let {
            com.google.fhir.model.r5.CommunicationRequest.CommunicationRequestIntent.fromCode(it)
          },
      ...
      informationProvider = this@CommunicationRequestSurrogate.informationProvider
      reason = this@CommunicationRequestSurrogate.reason
    ...
    public fun fromModel(model: CommunicationRequest): CommunicationRequestSurrogate =
      with(model) {
        CommunicationRequestSurrogate().apply {
          ...
          informationProvider = this@with.informationProvider
