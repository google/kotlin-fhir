...
internal data class CommunicationRequestSurrogate(
  ...
  public fun toModel(): CommunicationRequest =
    CommunicationRequest(
      ...
      occurrence =
        CommunicationRequest.Occurrence?.fromNullable(
          DateTime.ofNullable(
    ...
    public fun fromModel(model: CommunicationRequest): CommunicationRequestSurrogate =
      with(model) {
        CommunicationRequestSurrogate(
          ...
          medium = this@with.medium.takeUnless { it.isEmpty() },
          subject = this@with.subject,
          about = this@with.about.takeUnless { it.isEmpty() },
          ...
          informationProvider = this@with.informationProvider.takeUnless { it.isEmpty() },
