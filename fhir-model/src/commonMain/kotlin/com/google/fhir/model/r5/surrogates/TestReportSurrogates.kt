...
internal data class TestReportSetupActionOperationSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var result: KotlinString?,
...
internal data class TestReportSetupActionAssertRequirementSurrogate(
  ...
  public fun toModel(): TestReport.Setup.Action.Assert.Requirement =
    TestReport.Setup.Action.Assert.Requirement(
      ...
      link =
        TestReport.Setup.Action.Assert.Requirement.Link?.fromNullable(
          Uri.ofNullable(
...
internal data class TestReportTestSurrogate(
  ...
  public fun toModel(): TestReport.Test =
    TestReport.Test(
      ...
      name =
        R5String.ofNullable(this@TestReportTestSurrogate.name, this@TestReportTestSurrogate._name),
      description =
        R5String.ofNullable(
...
internal data class TestReportSurrogate(
  ...
  public var testScript: KotlinString?,
  ...
  public fun toModel(): TestReport =
    TestReport(
      ...
      implicitRules =
        Uri.ofNullable(
          this@TestReportSurrogate.implicitRules,
          this@TestReportSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@TestReportSurrogate.language, this@TestReportSurrogate._language),
      ...
      name = R5String.ofNullable(this@TestReportSurrogate.name, this@TestReportSurrogate._name),
      status =
        Enumeration.of(
      ...
      score = Decimal.ofNullable(this@TestReportSurrogate.score, this@TestReportSurrogate._score),
      tester =
        R5String.ofNullable(this@TestReportSurrogate.tester, this@TestReportSurrogate._tester),
      issued =
        DateTime.ofNullable(
