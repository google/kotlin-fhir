      ...
      type =
        Enumeration.of(
          this@TestReportParticipantSurrogate.type?.let {
            com.google.fhir.model.r5.TestReport.TestReportParticipantType.fromCode(it)
          },
      ...
      result =
        Enumeration.of(
          this@TestReportSetupActionOperationSurrogate.result?.let {
            com.google.fhir.model.r5.TestReport.TestReportActionResult.fromCode(it)
          },
...
@Serializable
internal class TestReportSetupActionAssertRequirementLinkSurrogate {
  ...
  public fun toModel(): TestReport.Setup.Action.Assert.Requirement.Link =
    ...
    ) ?: TestReport.Setup.Action.Assert.Requirement.Link.Null
...
internal data class TestReportSetupActionAssertRequirementSurrogate(
  ...
  public fun toModel(): TestReport.Setup.Action.Assert.Requirement =
    TestReport.Setup.Action.Assert.Requirement().apply {
      id = this@TestReportSetupActionAssertRequirementSurrogate.id
      extension = this@TestReportSetupActionAssertRequirementSurrogate.extension
      modifierExtension = this@TestReportSetupActionAssertRequirementSurrogate.modifierExtension
  ...
  public companion object {
    public fun fromModel(
      ...
      with(model) {
        TestReportSetupActionAssertRequirementSurrogate().apply {
          id = this@with.id
          extension = this@with.extension
          modifierExtension = this@with.modifierExtension
          link = this@with.link
...
internal data class TestReportSetupActionAssertSurrogate(
  ...
  public fun toModel(): TestReport.Setup.Action.Assert =
    TestReport.Setup.Action.Assert().apply {
      ...
      requirement = this@TestReportSetupActionAssertSurrogate.requirement
    }
      ...
      status =
        Enumeration.of(
          this@TestReportSurrogate.status?.let {
            com.google.fhir.model.r5.TestReport.TestReportStatus.fromCode(it)
          },
      ...
      result =
        Enumeration.of(
          this@TestReportSurrogate.result?.let {
            com.google.fhir.model.r5.TestReport.TestReportResult.fromCode(it)
          },
