...
internal data class InventoryItemSurrogate(
  ...
  public fun toModel(): InventoryItem =
    InventoryItem(
      ...
      language =
        Code.ofNullable(
          this@InventoryItemSurrogate.language,
          this@InventoryItemSurrogate._language,
        ),
    ...
    public fun fromModel(model: InventoryItem): InventoryItemSurrogate =
      with(model) {
        InventoryItemSurrogate(
          ...
          responsibleOrganization = this@with.responsibleOrganization.takeUnless { it.isEmpty() },
          description = this@with.description,
          inventoryStatus = this@with.inventoryStatus.takeUnless { it.isEmpty() },
          baseUnit = this@with.baseUnit,
          netContent = this@with.netContent,
          association = this@with.association.takeUnless { it.isEmpty() },
