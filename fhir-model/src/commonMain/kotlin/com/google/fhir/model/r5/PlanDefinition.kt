...
public data class PlanDefinition(
        ...
        public companion object {
          public fun from(
            ...
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.PlanDefinition.Goal.Target.Detail"
            )
          }
  ...
  public class Actor(
    ...
    public var option: MutableList<Option> = mutableListOf(),
  ) : BackboneElement() {
    /** The characteristics of the candidates that could serve as the actor. */
      ...
      public sealed interface Offset {
        ...
        public companion object {
          public fun from(
            ...
            if (RangeValue != null) return Range(RangeValue)
            throw IllegalArgumentException(
              "Missing value for com.google.fhir.model.r5.PlanDefinition.Action.RelatedAction.Offset"
            )
          }
    ...
    public sealed interface Subject {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.PlanDefinition.Action.Subject"
          )
        }
    ...
    public sealed interface Timing {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.PlanDefinition.Action.Timing"
          )
        }
    ...
    public sealed interface Definition {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.PlanDefinition.Action.Definition"
          )
        }
  ...
  public sealed interface VersionAlgorithm {
    ...
    public companion object {
      public fun from(
        ...
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.PlanDefinition.VersionAlgorithm"
        )
      }
  ...
  public sealed interface Subject {
    ...
    public companion object {
      public fun from(
        ...
        if (canonicalValue != null) return Canonical(canonicalValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.PlanDefinition.Subject"
        )
      }
  ...
  public sealed interface AsNeeded {
    ...
    public companion object {
      public fun from(
        ...
        if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
        throw IllegalArgumentException(
          "Missing value for com.google.fhir.model.r5.PlanDefinition.AsNeeded"
        )
      }
