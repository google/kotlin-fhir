...
public data class Goal(
   ...
   * measured.
   */
  public var outcome: MutableList<CodeableReference> = mutableListOf(),
) : DomainResource() {
  /** Indicates what should be done by when. */
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Goal.Target.Detail"
          )
        }
    ...
    public sealed interface Due {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Goal.Target.Due"
          )
        }
  ...
  public sealed interface Start {
    ...
    public companion object {
      public fun from(
        ...
        if (dateValue != null) return Date(dateValue)
        if (CodeableConceptValue != null) return CodeableConcept(CodeableConceptValue)
        throw IllegalArgumentException("Missing value for com.google.fhir.model.r5.Goal.Start")
      }
