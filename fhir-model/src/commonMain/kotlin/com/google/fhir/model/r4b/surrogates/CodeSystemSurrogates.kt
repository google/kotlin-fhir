...
internal data class CodeSystemFilterSurrogate(
  ...
  public fun toModel(): CodeSystem.Filter =
    CodeSystem.Filter(
      ...
      `value` =
        R4bString.of(
          this@CodeSystemFilterSurrogate.`value`!!,
          this@CodeSystemFilterSurrogate._value,
        ),
    )
...
internal data class CodeSystemPropertySurrogate(
  ...
  public fun toModel(): CodeSystem.Property =
    CodeSystem.Property(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4b.CodeSystem.PropertyType.fromCode(
...
internal data class CodeSystemSurrogate(
  ...
  public fun toModel(): CodeSystem =
    CodeSystem(
      ...
      version =
        R4bString.ofNullable(this@CodeSystemSurrogate.version, this@CodeSystemSurrogate._version),
      name = R4bString.ofNullable(this@CodeSystemSurrogate.name, this@CodeSystemSurrogate._name),
      title = R4bString.ofNullable(this@CodeSystemSurrogate.title, this@CodeSystemSurrogate._title),
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.PublicationStatus.fromCode(this@CodeSystemSurrogate.status!!),
      ...
      content =
        Enumeration.of(
          com.google.fhir.model.r4b.CodeSystem.CodeSystemContentMode.fromCode(
