...
public enum class DocumentReferenceStatus(
  ...
  Current("current", "http://hl7.org/fhir/document-reference-status", "Current", null),
  Superseded("superseded", "http://hl7.org/fhir/document-reference-status", "Superseded", null),
  Entered_In_Error(
    "entered-in-error",
