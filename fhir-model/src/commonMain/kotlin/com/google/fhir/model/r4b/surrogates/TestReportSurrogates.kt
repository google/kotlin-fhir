...
internal data class TestReportTestSurrogate(
  ...
  public fun toModel(): TestReport.Test =
    TestReport.Test(
      ...
      name =
        R4bString.ofNullable(this@TestReportTestSurrogate.name, this@TestReportTestSurrogate._name),
      description =
        R4bString.ofNullable(
...
internal data class TestReportSurrogate(
  ...
  public fun toModel(): TestReport =
    TestReport(
      ...
      name = R4bString.ofNullable(this@TestReportSurrogate.name, this@TestReportSurrogate._name),
      status =
        Enumeration.of(
      ...
      tester =
        R4bString.ofNullable(this@TestReportSurrogate.tester, this@TestReportSurrogate._tester),
      issued =
        DateTime.ofNullable(
