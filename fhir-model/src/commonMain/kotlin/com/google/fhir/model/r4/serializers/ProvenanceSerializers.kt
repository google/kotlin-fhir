...
import com.google.fhir.model.r4.surrogates.ProvenanceAgentSurrogate
import com.google.fhir.model.r4.surrogates.ProvenanceEntitySurrogate
import com.google.fhir.model.r4.surrogates.ProvenanceOccurredSurrogate
import com.google.fhir.model.r4.surrogates.ProvenanceSurrogate
...
public object ProvenanceOccurredSerializer : KSerializer<Provenance.Occurred> {
  internal val surrogateSerializer: KSerializer<ProvenanceOccurredSurrogate> by lazy {
    ProvenanceOccurredSurrogate.serializer()
  }
...
public object ProvenanceSerializer : KSerializer<Provenance> {
  ...
  private val resourceType: String? = "Provenance"
  ...
  override fun serialize(encoder: Encoder, `value`: Provenance) {
    ...
    val surrogate = ProvenanceSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
