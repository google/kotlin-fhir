...
internal data class InventoryReportSurrogate(
  ...
  public var reportedDateTime: String?,
  ...
  public fun toModel(): InventoryReport =
    InventoryReport(
      ...
      language =
        Code.ofNullable(
          this@InventoryReportSurrogate.language,
          this@InventoryReportSurrogate._language,
        ),
    ...
    public fun fromModel(model: InventoryReport): InventoryReportSurrogate =
      with(model) {
        InventoryReportSurrogate(
          ...
          inventoryListing = this@with.inventoryListing.takeUnless { it.isEmpty() },
