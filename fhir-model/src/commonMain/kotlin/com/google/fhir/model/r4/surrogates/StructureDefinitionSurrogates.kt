      ...
      type =
        Enumeration.of(
          this@StructureDefinitionContextSurrogate.type?.let {
            com.google.fhir.model.r4.StructureDefinition.ExtensionContextType.fromCode(it)
          },
...
internal data class StructureDefinitionSurrogate(
  ...
  public fun toModel(): StructureDefinition =
    StructureDefinition().apply {
      ...
      name =
        R4String.of(this@StructureDefinitionSurrogate.name, this@StructureDefinitionSurrogate._name)
      title =
        R4String.of(
      ...
      kind =
        Enumeration.of(
          this@StructureDefinitionSurrogate.kind?.let {
            com.google.fhir.model.r4.StructureDefinition.StructureDefinitionKind.fromCode(it)
          },
