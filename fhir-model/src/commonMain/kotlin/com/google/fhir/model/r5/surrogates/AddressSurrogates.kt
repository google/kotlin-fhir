    ...
    Address(
      ...
      use =
        this@AddressSurrogate.use?.let {
          Enumeration.of(
            com.google.fhir.model.r5.Address.AddressUse.fromCode(it!!),
      ...
      type =
        this@AddressSurrogate.type?.let {
          Enumeration.of(
            com.google.fhir.model.r5.Address.AddressType.fromCode(it!!),
            this@AddressSurrogate._type,
          )
        },
      text = R5String.ofNullable(this@AddressSurrogate.text, this@AddressSurrogate._text),
      line =
      ...
      city = R5String.ofNullable(this@AddressSurrogate.city, this@AddressSurrogate._city),
      district =
        R5String.ofNullable(this@AddressSurrogate.district, this@AddressSurrogate._district),
      state = R5String.ofNullable(this@AddressSurrogate.state, this@AddressSurrogate._state),
      postalCode =
        R5String.ofNullable(this@AddressSurrogate.postalCode, this@AddressSurrogate._postalCode),
      country = R5String.ofNullable(this@AddressSurrogate.country, this@AddressSurrogate._country),
    ...
    public fun fromModel(model: Address): AddressSurrogate =
      with(model) {
        AddressSurrogate(
          ...
          line = this@with.line.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _line =
            this@with.line
              .map { it.toElement() }
