...
internal data class AddressSurrogate(
  ...
  public fun toModel(): Address =
    Address().apply {
      ...
      state = R5String.of(this@AddressSurrogate.state, this@AddressSurrogate._state)
      postalCode = R5String.of(this@AddressSurrogate.postalCode, this@AddressSurrogate._postalCode)
      country = R5String.of(this@AddressSurrogate.country, this@AddressSurrogate._country)
