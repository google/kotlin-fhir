...
internal data class DetectedIssueSurrogate(
  ...
  public fun toModel(): DetectedIssue =
    DetectedIssue(
      ...
      language =
        Code.ofNullable(
          this@DetectedIssueSurrogate.language,
          this@DetectedIssueSurrogate._language,
        ),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4.DetectedIssue.DetectedIssueStatus.fromCode(
      ...
      identified =
        DetectedIssue.Identified?.fromNullable(
          DateTime.ofNullable(
      ...
      detail =
        R4String.ofNullable(
          this@DetectedIssueSurrogate.detail,
          this@DetectedIssueSurrogate._detail,
        ),
      reference =
        Uri.ofNullable(
          this@DetectedIssueSurrogate.reference,
          this@DetectedIssueSurrogate._reference,
        ),
    ...
    public fun fromModel(model: DetectedIssue): DetectedIssueSurrogate =
      with(model) {
        DetectedIssueSurrogate(
          ...
          author = this@with.author,
          implicated = this@with.implicated.takeUnless { it.isEmpty() },
          ...
          mitigation = this@with.mitigation.takeUnless { it.isEmpty() },
        )
      }
  }
}
