      ...
      equivalence =
        Enumeration.of(
          this@ConceptMapGroupElementTargetSurrogate.equivalence?.let {
            com.google.fhir.model.r4b.ConceptMapEquivalence.fromCode(it)
          },
      ...
      mode =
        Enumeration.of(
          this@ConceptMapGroupUnmappedSurrogate.mode?.let {
            com.google.fhir.model.r4b.ConceptMap.ConceptMapGroupUnmappedMode.fromCode(it)
          },
...
internal data class ConceptMapSurrogate(
  ...
  public fun toModel(): ConceptMap =
    ConceptMap().apply {
      ...
      experimental =
        R4bBoolean.of(this@ConceptMapSurrogate.experimental, this@ConceptMapSurrogate._experimental)
      date =
        DateTime.of(
