...
internal data class ConceptMapSurrogate(
  ...
  public fun toModel(): ConceptMap =
    ConceptMap(
      ...
      version =
        R4bString.ofNullable(this@ConceptMapSurrogate.version, this@ConceptMapSurrogate._version),
      name = R4bString.ofNullable(this@ConceptMapSurrogate.name, this@ConceptMapSurrogate._name),
      title = R4bString.ofNullable(this@ConceptMapSurrogate.title, this@ConceptMapSurrogate._title),
      status =
        Enumeration.of(
