...
internal data class ObservationTriggeredBySurrogate(
  ...
  public fun toModel(): Observation.TriggeredBy =
    Observation.TriggeredBy(
      ...
      extension = this@ObservationTriggeredBySurrogate.extension ?: listOf(),
      modifierExtension = this@ObservationTriggeredBySurrogate.modifierExtension ?: listOf(),
      observation = this@ObservationTriggeredBySurrogate.observation,
      type =
        Enumeration.of(
          Observation.TriggeredBytype.fromCode(this@ObservationTriggeredBySurrogate.type!!),
...
@Serializable
internal data class ObservationInstantiatesSurrogate(
...
internal data class ObservationSurrogate(
  ...
  public fun toModel(): Observation =
    Observation(
      ...
      triggeredBy = this@ObservationSurrogate.triggeredBy ?: listOf(),
    ...
    public fun fromModel(model: Observation): ObservationSurrogate =
      with(model) {
        ObservationSurrogate(
          ...
          triggeredBy = this@with.triggeredBy.takeIf { it.isNotEmpty() },
