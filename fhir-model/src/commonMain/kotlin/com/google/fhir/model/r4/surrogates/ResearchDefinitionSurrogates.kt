...
internal data class ResearchDefinitionSurrogate(
  ...
  public fun toModel(): ResearchDefinition =
    ResearchDefinition(
      ...
      url =
        Uri.ofNullable(this@ResearchDefinitionSurrogate.url, this@ResearchDefinitionSurrogate._url),
      ...
      name =
        R4String.ofNullable(
          this@ResearchDefinitionSurrogate.name,
          this@ResearchDefinitionSurrogate._name,
        ),
      title =
        R4String.ofNullable(
      ...
      subject =
        ResearchDefinition.Subject?.fromNullable(
