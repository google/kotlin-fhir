...
internal data class ContractTermSurrogate(
  ...
  public fun toModel(): Contract.Term =
    Contract.Term(
      ...
      text =
        R4bString.ofNullable(this@ContractTermSurrogate.text, this@ContractTermSurrogate._text),
...
internal data class ContractSurrogate(
  ...
  public fun toModel(): Contract =
    Contract(
      ...
      version =
        R4bString.ofNullable(this@ContractSurrogate.version, this@ContractSurrogate._version),
      status =
      ...
      name = R4bString.ofNullable(this@ContractSurrogate.name, this@ContractSurrogate._name),
      title = R4bString.ofNullable(this@ContractSurrogate.title, this@ContractSurrogate._title),
      subtitle =
        R4bString.ofNullable(this@ContractSurrogate.subtitle, this@ContractSurrogate._subtitle),
      alias =
