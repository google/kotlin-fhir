      ...
      type =
        Enumeration.of(
          this@ElementDefinitionSlicingDiscriminatorSurrogate.type?.let {
            com.google.fhir.model.r4.ElementDefinition.DiscriminatorType.fromCode(it)
          },
      ...
      rules =
        Enumeration.of(
          this@ElementDefinitionSlicingSurrogate.rules?.let {
            com.google.fhir.model.r4.ElementDefinition.SlicingRules.fromCode(it)
          },
      ...
      severity =
        Enumeration.of(
          this@ElementDefinitionConstraintSurrogate.severity?.let {
            com.google.fhir.model.r4.ElementDefinition.ConstraintSeverity.fromCode(it)
          },
      ...
      strength =
        Enumeration.of(
          this@ElementDefinitionBindingSurrogate.strength?.let {
            com.google.fhir.model.r4.BindingStrength.fromCode(it)
          },
