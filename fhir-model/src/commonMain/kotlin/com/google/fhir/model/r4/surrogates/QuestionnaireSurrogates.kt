...
@Serializable
internal class QuestionnaireItemEnableWhenAnswerSurrogate {
  ...
  public fun toModel(): Questionnaire.Item.EnableWhen.Answer =
    ...
    ) ?: Questionnaire.Item.EnableWhen.Answer.Null
...
internal data class QuestionnaireItemEnableWhenSurrogate(
  ...
  public var answer: Questionnaire.Item.EnableWhen.Answer? = null,
) {
      ...
      `operator` =
        Enumeration.of(
          this@QuestionnaireItemEnableWhenSurrogate.`operator`?.let {
            com.google.fhir.model.r4.Questionnaire.QuestionnaireItemOperator.fromCode(it)
          },
...
@Serializable
internal class QuestionnaireItemAnswerOptionValueSurrogate {
  ...
  public fun toModel(): Questionnaire.Item.AnswerOption.Value =
    ...
    ) ?: Questionnaire.Item.AnswerOption.Value.Null
...
internal data class QuestionnaireItemAnswerOptionSurrogate(
  ...
  public var `value`: Questionnaire.Item.AnswerOption.Value? = null,
) {
...
@Serializable
internal class QuestionnaireItemInitialValueSurrogate {
  ...
  public fun toModel(): Questionnaire.Item.Initial.Value =
    ...
    ) ?: Questionnaire.Item.Initial.Value.Null
...
internal data class QuestionnaireItemInitialSurrogate(
  ...
  public var extension: List<Extension?>? = null,
  public var modifierExtension: List<Extension?>? = null,
  public var `value`: Questionnaire.Item.Initial.Value? = null,
) {
...
internal data class QuestionnaireItemSurrogate(
  ...
  public fun toModel(): Questionnaire.Item =
    Questionnaire.Item().apply {
      ...
      linkId =
        R4String.of(this@QuestionnaireItemSurrogate.linkId, this@QuestionnaireItemSurrogate._linkId)
      definition =
        Uri.of(
      ...
      prefix =
        R4String.of(this@QuestionnaireItemSurrogate.prefix, this@QuestionnaireItemSurrogate._prefix)
      text =
      ...
      type =
        Enumeration.of(
          this@QuestionnaireItemSurrogate.type?.let {
            com.google.fhir.model.r4.Questionnaire.QuestionnaireItemType.fromCode(it)
          },
