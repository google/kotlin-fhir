...
internal data class QuestionnaireSurrogate(
  ...
  public fun toModel(): Questionnaire =
    Questionnaire(
      ...
      name =
        R4String.ofNullable(this@QuestionnaireSurrogate.name, this@QuestionnaireSurrogate._name),
      title =
        R4String.ofNullable(this@QuestionnaireSurrogate.title, this@QuestionnaireSurrogate._title),
      derivedFrom =
        if (
