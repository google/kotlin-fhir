    ...
    public fun fromModel(model: Condition.Stage): ConditionStageSurrogate =
      with(model) {
        ConditionStageSurrogate(
          ...
          assessment = this@with.assessment.takeUnless { it.isEmpty() },
          type = this@with.type,
        )
      }
  }
...
internal data class ConditionSurrogate(
  ...
  public fun toModel(): Condition =
    Condition(
      ...
      implicitRules =
        Uri.ofNullable(
          this@ConditionSurrogate.implicitRules,
          this@ConditionSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@ConditionSurrogate.language, this@ConditionSurrogate._language),
      ...
      onset =
        Condition.Onset?.fromNullable(
          ...
          R5String.ofNullable(
            this@ConditionSurrogate.onsetString,
            this@ConditionSurrogate._onsetString,
          ),
        ),
      abatement =
        Condition.Abatement?.fromNullable(
          DateTime.ofNullable(
    ...
    public fun fromModel(model: Condition): ConditionSurrogate =
      with(model) {
        ConditionSurrogate(
          ...
          stage = this@with.stage.takeUnless { it.isEmpty() },
