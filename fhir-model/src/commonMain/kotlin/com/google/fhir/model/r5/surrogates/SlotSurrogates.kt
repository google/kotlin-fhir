...
internal data class SlotSurrogate(
  ...
  public fun toModel(): Slot =
    Slot(
      ...
      implicitRules =
        Uri.ofNullable(this@SlotSurrogate.implicitRules, this@SlotSurrogate._implicitRules),
      language = Code.ofNullable(this@SlotSurrogate.language, this@SlotSurrogate._language),
      ...
      overbooked =
        R5Boolean.ofNullable(this@SlotSurrogate.overbooked, this@SlotSurrogate._overbooked),
      comment = R5String.ofNullable(this@SlotSurrogate.comment, this@SlotSurrogate._comment),
    )
    ...
    public fun fromModel(model: Slot): SlotSurrogate =
      with(model) {
        SlotSurrogate(
          ...
          appointmentType = this@with.appointmentType.takeUnless { it.isEmpty() },
