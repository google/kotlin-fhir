...
@Serializable
internal class ClaimResponseAddItemServicedSurrogate {
  ...
  public fun toModel(): ClaimResponse.AddItem.Serviced =
    ...
    ) ?: ClaimResponse.AddItem.Serviced.Null
...
@Serializable
internal class ClaimResponseAddItemLocationSurrogate {
  ...
  public fun toModel(): ClaimResponse.AddItem.Location =
    ...
    ) ?: ClaimResponse.AddItem.Location.Null
...
internal data class ClaimResponseSurrogate(
  ...
  public fun toModel(): ClaimResponse =
    ClaimResponse().apply {
      ...
      status =
        Enumeration.of(
          this@ClaimResponseSurrogate.status?.let {
            com.google.fhir.model.r4.ClaimResponse.ClaimResponseStatus.fromCode(it)
          },
      ...
      use =
        Enumeration.of(
          this@ClaimResponseSurrogate.use?.let {
            com.google.fhir.model.r4.ClaimResponse.Use.fromCode(it)
          },
      ...
      outcome =
        Enumeration.of(
          this@ClaimResponseSurrogate.outcome?.let {
            com.google.fhir.model.r4.ClaimResponse.RemittanceOutcome.fromCode(it)
          },
      ...
      preAuthRef =
        R4String.of(this@ClaimResponseSurrogate.preAuthRef, this@ClaimResponseSurrogate._preAuthRef)
