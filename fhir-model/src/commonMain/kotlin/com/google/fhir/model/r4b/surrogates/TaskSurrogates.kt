    ...
    Task.Output().apply {
      ...
      `value` =
        Task.Output.Value?.from(
          ...
          R4bString.of(this@TaskOutputSurrogate.valueString, this@TaskOutputSurrogate._valueString),
...
internal data class TaskSurrogate(
  ...
  public fun toModel(): Task =
    Task().apply {
      ...
      status =
        Enumeration.of(
          this@TaskSurrogate.status?.let { com.google.fhir.model.r4b.Task.TaskStatus.fromCode(it) },
      ...
      intent =
        Enumeration.of(
          this@TaskSurrogate.intent?.let { com.google.fhir.model.r4b.Task.TaskIntent.fromCode(it) },
      ...
      performerType = this@TaskSurrogate.performerType
