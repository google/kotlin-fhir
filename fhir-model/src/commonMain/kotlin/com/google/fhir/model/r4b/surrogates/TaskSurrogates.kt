    ...
    public fun fromModel(model: Task.Restriction): TaskRestrictionSurrogate =
      with(model) {
        TaskRestrictionSurrogate(
          ...
          recipient = this@with.recipient.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    Task.Input(
      ...
      `value` =
        Task.Input.Value.from(
          ...
          R4bBoolean.of(
            this@TaskInputSurrogate.valueBoolean!!,
            this@TaskInputSurrogate._valueBoolean,
          ),
          Canonical.of(
          ...
          R4bString.of(this@TaskInputSurrogate.valueString!!, this@TaskInputSurrogate._valueString),
          ...
          this@TaskInputSurrogate.valueContributor,
    ...
    Task.Output(
      ...
      `value` =
        Task.Output.Value.from(
          ...
          Decimal.of(
            this@TaskOutputSurrogate.valueDecimal!!,
            this@TaskOutputSurrogate._valueDecimal,
          ),
          ...
          Integer.of(
            this@TaskOutputSurrogate.valueInteger!!,
            this@TaskOutputSurrogate._valueInteger,
          ),
          Markdown.of(
          ...
          R4bString.of(
            this@TaskOutputSurrogate.valueString!!,
            this@TaskOutputSurrogate._valueString,
          ),
          ...
          this@TaskOutputSurrogate.valueContributor,
...
internal data class TaskSurrogate(
  ...
  public var intent: KotlinString?,
  ...
  public fun toModel(): Task =
    Task(
      ...
      implicitRules =
        Uri.ofNullable(this@TaskSurrogate.implicitRules, this@TaskSurrogate._implicitRules),
      language = Code.ofNullable(this@TaskSurrogate.language, this@TaskSurrogate._language),
      ...
      instantiatesUri =
        Uri.ofNullable(this@TaskSurrogate.instantiatesUri, this@TaskSurrogate._instantiatesUri),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r4b.Task.TaskStatus.fromCode(this@TaskSurrogate.status!!),
      ...
      intent =
        Enumeration.of(
          com.google.fhir.model.r4b.Task.TaskIntent.fromCode(this@TaskSurrogate.intent!!),
          this@TaskSurrogate._intent,
        ),
      priority =
        this@TaskSurrogate.priority?.let {
          Enumeration.of(
            com.google.fhir.model.r4b.Task.TaskPriority.fromCode(it!!),
            this@TaskSurrogate._priority,
          )
        },
      code = this@TaskSurrogate.code,
      description =
        R4bString.ofNullable(this@TaskSurrogate.description, this@TaskSurrogate._description),
