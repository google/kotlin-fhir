...
@Serializable
internal class TaskInputValueSurrogate {
...
internal data class TaskInputSurrogate(
  ...
  public var `value`: Task.Input.Value? = null,
) {
...
@Serializable
internal class TaskOutputValueSurrogate {
  public var valueBase64Binary: KotlinString? = null
...
internal data class TaskOutputSurrogate(
  ...
  public var modifierExtension: List<Extension?>? = null,
  public var type: CodeableConcept? = null,
  public var `value`: Task.Output.Value? = null,
) {
