      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Invoice.LineItem.Serviced"
          )
        }
    ...
    public sealed interface ChargeItem {
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Invoice.LineItem.ChargeItem"
          )
        }
  ...
  public sealed interface Period {
    ...
    public companion object {
      public fun from(
        ...
        if (dateValue != null) return Date(dateValue)
        if (PeriodValue != null) return Period(PeriodValue)
        throw IllegalArgumentException("Missing value for com.google.fhir.model.r5.Invoice.Period")
      }
