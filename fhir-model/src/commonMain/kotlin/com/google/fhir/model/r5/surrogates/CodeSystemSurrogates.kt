      ...
      `operator` =
        if (
          ...
          (this@CodeSystemFilterSurrogate.`operator`
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let { com.google.fhir.model.r5.CodeSystem.FilterOperator.fromCode(it!!) },
                element,
              )
            }
            .toMutableList()
...
internal data class CodeSystemPropertySurrogate(
  ...
  public fun toModel(): CodeSystem.Property =
    CodeSystem.Property(
      ...
      uri =
        Uri.ofNullable(this@CodeSystemPropertySurrogate.uri, this@CodeSystemPropertySurrogate._uri),
      description =
        R5String.ofNullable(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r5.CodeSystem.PropertyType.fromCode(
...
internal data class CodeSystemSurrogate(
  ...
  public var content: KotlinString?,
  ...
  public fun toModel(): CodeSystem =
    CodeSystem(
      ...
      implicitRules =
        Uri.ofNullable(
          this@CodeSystemSurrogate.implicitRules,
          this@CodeSystemSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@CodeSystemSurrogate.language, this@CodeSystemSurrogate._language),
      ...
      url = Uri.ofNullable(this@CodeSystemSurrogate.url, this@CodeSystemSurrogate._url),
      identifier = this@CodeSystemSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(this@CodeSystemSurrogate.version, this@CodeSystemSurrogate._version),
      versionAlgorithm =
        CodeSystem.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name = R5String.ofNullable(this@CodeSystemSurrogate.name, this@CodeSystemSurrogate._name),
      title = R5String.ofNullable(this@CodeSystemSurrogate.title, this@CodeSystemSurrogate._title),
      status =
        Enumeration.of(
      ...
      experimental =
        R5Boolean.ofNullable(
          this@CodeSystemSurrogate.experimental,
          this@CodeSystemSurrogate._experimental,
        ),
      date =
        DateTime.ofNullable(
      ...
      publisher =
        R5String.ofNullable(
          this@CodeSystemSurrogate.publisher,
          this@CodeSystemSurrogate._publisher,
        ),
      contact = this@CodeSystemSurrogate.contact ?: mutableListOf(),
      description =
        Markdown.ofNullable(
          this@CodeSystemSurrogate.description,
          this@CodeSystemSurrogate._description,
        ),
      ...
      purpose =
        Markdown.ofNullable(this@CodeSystemSurrogate.purpose, this@CodeSystemSurrogate._purpose),
      copyright =
        Markdown.ofNullable(
          this@CodeSystemSurrogate.copyright,
          this@CodeSystemSurrogate._copyright,
        ),
      copyrightLabel =
        R5String.ofNullable(
      ...
      valueSet =
        Canonical.ofNullable(this@CodeSystemSurrogate.valueSet, this@CodeSystemSurrogate._valueSet),
      hierarchyMeaning =
        this@CodeSystemSurrogate.hierarchyMeaning?.let {
          Enumeration.of(
            com.google.fhir.model.r5.CodeSystem.CodeSystemHierarchyMeaning.fromCode(it!!),
      ...
      content =
        Enumeration.of(
          com.google.fhir.model.r5.CodeSystem.CodeSystemContentMode.fromCode(
      ...
      supplements =
        Canonical.ofNullable(
          this@CodeSystemSurrogate.supplements,
          this@CodeSystemSurrogate._supplements,
        ),
      count =
        UnsignedInt.ofNullable(this@CodeSystemSurrogate.count, this@CodeSystemSurrogate._count),
