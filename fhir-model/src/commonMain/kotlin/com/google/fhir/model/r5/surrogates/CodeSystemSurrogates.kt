...
internal data class CodeSystemConceptDesignationSurrogate(
  ...
  public fun toModel(): CodeSystem.Concept.Designation =
    CodeSystem.Concept.Designation(
      ...
      additionalUse = this@CodeSystemConceptDesignationSurrogate.additionalUse ?: listOf(),
      `value` =
        R5String.of(
...
internal data class CodeSystemSurrogate(
  ...
  public fun toModel(): CodeSystem =
    CodeSystem(
      ...
      topic = this@CodeSystemSurrogate.topic ?: listOf(),
      author = this@CodeSystemSurrogate.author ?: listOf(),
      editor = this@CodeSystemSurrogate.editor ?: listOf(),
      reviewer = this@CodeSystemSurrogate.reviewer ?: listOf(),
      endorser = this@CodeSystemSurrogate.endorser ?: listOf(),
      relatedArtifact = this@CodeSystemSurrogate.relatedArtifact ?: listOf(),
      caseSensitive =
        R5Boolean.of(
