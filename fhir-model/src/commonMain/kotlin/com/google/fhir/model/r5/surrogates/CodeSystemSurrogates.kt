      ...
      type =
        Enumeration.of(
          this@CodeSystemPropertySurrogate.type?.let {
            com.google.fhir.model.r5.CodeSystem.PropertyType.fromCode(it)
          },
...
internal data class CodeSystemConceptDesignationSurrogate(
  ...
  public fun toModel(): CodeSystem.Concept.Designation =
    CodeSystem.Concept.Designation().apply {
      ...
      additionalUse = this@CodeSystemConceptDesignationSurrogate.additionalUse
      `value` =
        R5String.of(
...
internal data class CodeSystemSurrogate(
  ...
  public fun toModel(): CodeSystem =
    CodeSystem().apply {
      ...
      topic = this@CodeSystemSurrogate.topic
      author = this@CodeSystemSurrogate.author
      editor = this@CodeSystemSurrogate.editor
      reviewer = this@CodeSystemSurrogate.reviewer
      endorser = this@CodeSystemSurrogate.endorser
      relatedArtifact = this@CodeSystemSurrogate.relatedArtifact
      caseSensitive =
        R5Boolean.of(
      ...
      content =
        Enumeration.of(
          this@CodeSystemSurrogate.content?.let {
            com.google.fhir.model.r5.CodeSystem.CodeSystemContentMode.fromCode(it)
          },
