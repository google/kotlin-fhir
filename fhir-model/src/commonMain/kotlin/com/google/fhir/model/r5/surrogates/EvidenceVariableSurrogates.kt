    ...
    public fun fromModel(
      ...
      with(model) {
        EvidenceVariableCharacteristicDefinitionByTypeAndValueSurrogate(
          ...
          type = this@with.type,
          method = this@with.method.takeUnless { it.isEmpty() },
...
internal data class EvidenceVariableCharacteristicTimeFromEventSurrogate(
  ...
  public fun toModel(): EvidenceVariable.Characteristic.TimeFromEvent =
    EvidenceVariable.Characteristic.TimeFromEvent(
      ...
      event =
        EvidenceVariable.Characteristic.TimeFromEvent.Event?.fromNullable(
...
internal data class EvidenceVariableCharacteristicSurrogate(
  ...
  public fun toModel(): EvidenceVariable.Characteristic =
    EvidenceVariable.Characteristic(
      ...
      instances =
        EvidenceVariable.Characteristic.Instances?.fromNullable(
      ...
      duration =
        EvidenceVariable.Characteristic.Duration?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        EvidenceVariableCharacteristicSurrogate(
          ...
          timeFromEvent = this@with.timeFromEvent.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class EvidenceVariableCategorySurrogate(
  ...
  public fun toModel(): EvidenceVariable.Category =
    EvidenceVariable.Category(
      ...
      `value` =
        EvidenceVariable.Category.Value?.fromNullable(
...
internal data class EvidenceVariableSurrogate(
  ...
  public fun toModel(): EvidenceVariable =
    EvidenceVariable(
      ...
      language =
        Code.ofNullable(
          this@EvidenceVariableSurrogate.language,
          this@EvidenceVariableSurrogate._language,
        ),
      ...
      url = Uri.ofNullable(this@EvidenceVariableSurrogate.url, this@EvidenceVariableSurrogate._url),
      ...
      versionAlgorithm =
        EvidenceVariable.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
      ...
      name =
        R5String.ofNullable(
          this@EvidenceVariableSurrogate.name,
          this@EvidenceVariableSurrogate._name,
        ),
      title =
        R5String.ofNullable(
          this@EvidenceVariableSurrogate.title,
          this@EvidenceVariableSurrogate._title,
        ),
      shortTitle =
        R5String.ofNullable(
