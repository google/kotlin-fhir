...
internal data class SupplyRequestParameterSurrogate(
  ...
  public fun toModel(): SupplyRequest.Parameter =
    SupplyRequest.Parameter(
      ...
      `value` =
        SupplyRequest.Parameter.Value?.fromNullable(
...
internal data class SupplyRequestSurrogate(
  ...
  public fun toModel(): SupplyRequest =
    SupplyRequest(
      ...
      language =
        Code.ofNullable(
          this@SupplyRequestSurrogate.language,
          this@SupplyRequestSurrogate._language,
        ),
      ...
      occurrence =
        SupplyRequest.Occurrence?.fromNullable(
          DateTime.ofNullable(
