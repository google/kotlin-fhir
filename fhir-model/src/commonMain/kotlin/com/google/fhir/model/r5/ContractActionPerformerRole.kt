 ...
 */
public enum class ContractActionPerformerRole(
  ...
  public companion object {
    public fun fromCode(code: String): ContractActionPerformerRole =
      when (code) {
        ...
        "claims-adjudicator" -> Claims_Adjudicator
          ...
          throw IllegalArgumentException("Unknown code $code for enum ContractActionPerformerRole")
      }
  }
}
