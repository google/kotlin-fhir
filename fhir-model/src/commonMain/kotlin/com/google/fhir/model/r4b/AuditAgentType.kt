 ...
 * FHIR agents, actors, and other role elements. The FHIR Actor participation type value set is
 * based on DICOM Audit Message, C402; ASTM Standard, E1762-95 [2013]; selected codes and derived
 * actor roles from HL7 RoleClass OID 2.16.840.1.113883.5.110; HL7 Role Code
 * 2.16.840.1.113883.5.111, including AgentRoleType; HL7 ParticipationType OID:
 ...
 */
public enum class AuditAgentType(
  ...
  public companion object {
    public fun fromCode(code: String): AuditAgentType =
      when (code) {
        "AMENDER" -> Amender
        "COAUTH" -> Coauth
        "CONT" -> Cont
        ...
        "110154" -> _110154
        "110155" -> _110155
        else -> throw IllegalArgumentException("Unknown code $code for enum AuditAgentType")
      }
  }
}
