...
internal data class ActivityDefinitionSurrogate(
  ...
  public fun toModel(): ActivityDefinition =
    ActivityDefinition().apply {
      ...
      title =
        R5String.of(this@ActivityDefinitionSurrogate.title, this@ActivityDefinitionSurrogate._title)
      subtitle =
        R5String.of(
      ...
      usage =
        Markdown.of(this@ActivityDefinitionSurrogate.usage, this@ActivityDefinitionSurrogate._usage)
      copyright =
        Markdown.of(
    ...
    public fun fromModel(model: ActivityDefinition): ActivityDefinitionSurrogate =
      with(model) {
        ActivityDefinitionSurrogate().apply {
          ...
          specimenRequirement =
            this@with.specimenRequirement?.map { it?.value }?.takeUnless { it.all { it == null } }
