    ...
    public fun fromModel(
      ...
      with(model) {
        IngredientSubstanceStrengthReferenceStrengthSurrogate(
          ...
          country = this@with.country.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class IngredientSubstanceStrengthSurrogate(
  ...
  public fun toModel(): Ingredient.Substance.Strength =
    Ingredient.Substance.Strength(
      ...
      presentation =
        Ingredient.Substance.Strength.Presentation?.fromNullable(
      ...
      concentration =
        Ingredient.Substance.Strength.Concentration?.fromNullable(
    ...
    public fun fromModel(
      ...
      with(model) {
        IngredientSubstanceStrengthSurrogate(
          ...
          _measurementPoint = this@with.measurementPoint?.toElement(),
          country = this@with.country.takeUnless { it.isEmpty() },
          referenceStrength = this@with.referenceStrength.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: Ingredient.Substance): IngredientSubstanceSurrogate =
      with(model) {
        IngredientSubstanceSurrogate(
          ...
          modifierExtension = this@with.modifierExtension.takeUnless { it.isEmpty() },
          code = this@with.code,
          strength = this@with.strength.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class IngredientSurrogate(
  ...
  public fun toModel(): Ingredient =
    Ingredient(
      ...
      implicitRules =
        Uri.ofNullable(
          this@IngredientSurrogate.implicitRules,
          this@IngredientSurrogate._implicitRules,
        ),
      language =
        Code.ofNullable(this@IngredientSurrogate.language, this@IngredientSurrogate._language),
      ...
      comment =
        Markdown.ofNullable(this@IngredientSurrogate.comment, this@IngredientSurrogate._comment),
    ...
    public fun fromModel(model: Ingredient): IngredientSurrogate =
      with(model) {
        IngredientSurrogate(
          ...
          `for` = this@with.`for`.takeUnless { it.isEmpty() },
          role = this@with.role,
          function = this@with.function.takeUnless { it.isEmpty() },
