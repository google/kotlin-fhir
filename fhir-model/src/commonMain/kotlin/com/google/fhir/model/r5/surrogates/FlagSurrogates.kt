...
internal data class FlagSurrogate(
  ...
  public fun toModel(): Flag =
    Flag(
      ...
      implicitRules =
        Uri.ofNullable(this@FlagSurrogate.implicitRules, this@FlagSurrogate._implicitRules),
      language = Code.ofNullable(this@FlagSurrogate.language, this@FlagSurrogate._language),
      ...
      status =
        Enumeration.of(
          com.google.fhir.model.r5.Flag.FlagStatus.fromCode(this@FlagSurrogate.status!!),
