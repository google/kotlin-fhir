    ...
    public fun fromModel(model: SubstancePolymer.MonomerSet): SubstancePolymerMonomerSetSurrogate =
      with(model) {
        SubstancePolymerMonomerSetSurrogate(
          ...
          startingMaterial = this@with.startingMaterial.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(
      ...
      with(model) {
        SubstancePolymerRepeatRepeatUnitSurrogate(
          ...
          amount = this@with.amount,
          degreeOfPolymerisation = this@with.degreeOfPolymerisation.takeUnless { it.isEmpty() },
          structuralRepresentation = this@with.structuralRepresentation.takeUnless { it.isEmpty() },
        )
      }
  }
}
    ...
    public fun fromModel(model: SubstancePolymer.Repeat): SubstancePolymerRepeatSurrogate =
      with(model) {
        SubstancePolymerRepeatSurrogate(
          ...
          repeatUnit = this@with.repeatUnit.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class SubstancePolymerSurrogate(
  ...
  public fun toModel(): SubstancePolymer =
    SubstancePolymer(
      ...
      language =
        Code.ofNullable(
          this@SubstancePolymerSurrogate.language,
          this@SubstancePolymerSurrogate._language,
        ),
    ...
    public fun fromModel(model: SubstancePolymer): SubstancePolymerSurrogate =
      with(model) {
        SubstancePolymerSurrogate(
          ...
          copolymerConnectivity = this@with.copolymerConnectivity.takeUnless { it.isEmpty() },
          modification =
            this@with.modification.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _modification =
            this@with.modification
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          monomerSet = this@with.monomerSet.takeUnless { it.isEmpty() },
          repeat = this@with.repeat.takeUnless { it.isEmpty() },
        )
      }
  }
}
