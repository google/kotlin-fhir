...
public data class Task(
  ...
  public var requestedPerformer: MutableList<CodeableReference> = mutableListOf(),
  /**
      ...
      public companion object {
        public fun from(
          ...
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Task.Input.Value"
          )
        }
    ...
    public sealed interface Value {
      ...
      public companion object {
        public fun from(
          ...
          if (MetaValue != null) return Meta(MetaValue)
          throw IllegalArgumentException(
            "Missing value for com.google.fhir.model.r5.Task.Output.Value"
          )
        }
