...
internal data class ImplementationGuideDefinitionPageSurrogate(
  ...
  public var generation: KotlinString?,
  ...
  public fun toModel(): ImplementationGuide.Definition.Page =
    ImplementationGuide.Definition.Page(
      ...
      source =
        ImplementationGuide.Definition.Page.Source?.fromNullable(
          Url.ofNullable(
      ...
      generation =
        Enumeration.of(
          com.google.fhir.model.r5.ImplementationGuide.GuidePageGeneration.fromCode(
    ...
    public fun fromModel(
      ...
      with(model) {
        ImplementationGuideDefinitionPageSurrogate(
          ...
          page = this@with.page.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class ImplementationGuideDefinitionTemplateSurrogate(
  ...
  public var source: KotlinString?,
    ...
    public fun fromModel(
      ...
      with(model) {
        ImplementationGuideManifestPageSurrogate(
          ...
          title = this@with.title?.value,
          _title = this@with.title?.toElement(),
          anchor = this@with.anchor.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _anchor =
            this@with.anchor
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
    ...
    public fun fromModel(
      ...
      with(model) {
        ImplementationGuideManifestSurrogate(
          ...
          resource = this@with.resource.takeUnless { it.isEmpty() },
          page = this@with.page.takeUnless { it.isEmpty() },
          image = this@with.image.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _image =
            this@with.image
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ?.map { it ?: Element() }
              ?.toMutableList(),
          other = this@with.other.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _other =
            this@with.other
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
...
internal data class ImplementationGuideSurrogate(
  ...
  public var packageId: KotlinString?,
  public var _packageId: Element? = null,
  ...
  public fun toModel(): ImplementationGuide =
    ImplementationGuide(
      ...
      identifier = this@ImplementationGuideSurrogate.identifier ?: mutableListOf(),
      version =
        R5String.ofNullable(
      ...
      versionAlgorithm =
        ImplementationGuide.VersionAlgorithm?.fromNullable(
          R5String.ofNullable(
    ...
    public fun fromModel(model: ImplementationGuide): ImplementationGuideSurrogate =
      with(model) {
        ImplementationGuideSurrogate(
          ...
          global = this@with.global.takeUnless { it.isEmpty() },
