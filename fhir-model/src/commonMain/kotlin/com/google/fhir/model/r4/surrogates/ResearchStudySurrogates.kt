...
internal data class ResearchStudySurrogate(
  ...
  public fun toModel(): ResearchStudy =
    ResearchStudy(
      ...
      title =
        R4String.ofNullable(this@ResearchStudySurrogate.title, this@ResearchStudySurrogate._title),
      protocol = this@ResearchStudySurrogate.protocol ?: mutableListOf(),
      partOf = this@ResearchStudySurrogate.partOf ?: mutableListOf(),
      status =
        Enumeration.of(
          com.google.fhir.model.r4.ResearchStudy.ResearchStudyStatus.fromCode(
