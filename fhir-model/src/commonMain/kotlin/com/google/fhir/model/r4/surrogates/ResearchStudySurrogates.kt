...
internal data class ResearchStudyArmSurrogate(
  ...
  public fun toModel(): ResearchStudy.Arm =
    ResearchStudy.Arm().apply {
      ...
      name = R4String.of(this@ResearchStudyArmSurrogate.name, this@ResearchStudyArmSurrogate._name)
      ...
      status =
        Enumeration.of(
          this@ResearchStudySurrogate.status?.let {
            com.google.fhir.model.r4.ResearchStudy.ResearchStudyStatus.fromCode(it)
          },
