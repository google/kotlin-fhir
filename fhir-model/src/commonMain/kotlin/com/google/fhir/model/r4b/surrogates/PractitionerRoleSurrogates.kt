      ...
      daysOfWeek =
        if (
          ...
          (this@PractitionerRoleAvailableTimeSurrogate.daysOfWeek
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let { com.google.fhir.model.r4b.PractitionerRole.DaysOfWeek.fromCode(it!!) },
                element,
              )
            }
            .toMutableList()
...
internal data class PractitionerRoleSurrogate(
  ...
  public fun toModel(): PractitionerRole =
    PractitionerRole(
      ...
      language =
        Code.ofNullable(
          this@PractitionerRoleSurrogate.language,
          this@PractitionerRoleSurrogate._language,
        ),
    ...
    public fun fromModel(model: PractitionerRole): PractitionerRoleSurrogate =
      with(model) {
        PractitionerRoleSurrogate(
          ...
          availableTime = this@with.availableTime.takeUnless { it.isEmpty() },
          notAvailable = this@with.notAvailable.takeUnless { it.isEmpty() },
