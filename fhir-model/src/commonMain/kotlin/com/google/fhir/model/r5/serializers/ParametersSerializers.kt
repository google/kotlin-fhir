...
import com.google.fhir.model.r5.surrogates.ParametersParameterSurrogate
import com.google.fhir.model.r5.surrogates.ParametersParameterValueSurrogate
import com.google.fhir.model.r5.surrogates.ParametersSurrogate
...
public object ParametersParameterSerializer : KSerializer<Parameters.Parameter> {
  ...
  override fun serialize(encoder: Encoder, `value`: Parameters.Parameter) {
    ...
    val surrogate = ParametersParameterSurrogate.fromModel(value)
    val oldJsonObject =
      if (resourceType.isNullOrBlank()) {
