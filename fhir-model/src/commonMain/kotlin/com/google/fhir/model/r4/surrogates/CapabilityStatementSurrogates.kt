...
internal data class CapabilityStatementImplementationSurrogate(
  ...
  public var extension: MutableList<Extension>? = null,
  public var modifierExtension: MutableList<Extension>? = null,
  public var description: KotlinString?,
    ...
    public fun fromModel(
      ...
      with(model) {
        CapabilityStatementRestSecuritySurrogate(
          ...
          service = this@with.service.takeUnless { it.isEmpty() },
          description = this@with.description?.value,
          _description = this@with.description?.toElement(),
        )
      }
...
internal data class CapabilityStatementRestResourceInteractionSurrogate(
  ...
  public fun toModel(): CapabilityStatement.Rest.Resource.Interaction =
    CapabilityStatement.Rest.Resource.Interaction(
      ...
      code =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.TypeRestfulInteraction.fromCode(
...
internal data class CapabilityStatementRestResourceSearchParamSurrogate(
  ...
  public fun toModel(): CapabilityStatement.Rest.Resource.SearchParam =
    CapabilityStatement.Rest.Resource.SearchParam(
      ...
      type =
        Enumeration.of(
          com.google.fhir.model.r4.SearchParamType.fromCode(
...
internal data class CapabilityStatementRestResourceOperationSurrogate(
  ...
  public var name: KotlinString?,
  public var _name: Element? = null,
  public var definition: KotlinString?,
  public var _definition: Element? = null,
  public var documentation: KotlinString? = null,
  public var _documentation: Element? = null,
) {
        ...
        if (
          ...
          (this@CapabilityStatementRestResourceSurrogate.referencePolicy
            ...
            .map { (value, element) ->
              Enumeration.of(
                value.let {
                  com.google.fhir.model.r4.CapabilityStatement.ReferenceHandlingPolicy.fromCode(
                    it!!
                  )
                },
                element,
    ...
    public fun fromModel(
      ...
      with(model) {
        CapabilityStatementRestResourceSurrogate(
          ...
          documentation = this@with.documentation?.value,
          _documentation = this@with.documentation?.toElement(),
          interaction = this@with.interaction.takeUnless { it.isEmpty() },
          ...
          _referencePolicy =
            this@with.referencePolicy
              ...
              ?.toMutableList(),
          searchInclude =
            this@with.searchInclude.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _searchInclude =
          ...
          _searchRevInclude =
            this@with.searchRevInclude
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          searchParam = this@with.searchParam.takeUnless { it.isEmpty() },
          operation = this@with.operation.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class CapabilityStatementRestInteractionSurrogate(
  ...
  public fun toModel(): CapabilityStatement.Rest.Interaction =
    CapabilityStatement.Rest.Interaction(
      ...
      code =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.SystemRestfulInteraction.fromCode(
...
internal data class CapabilityStatementRestSurrogate(
  ...
  public fun toModel(): CapabilityStatement.Rest =
    CapabilityStatement.Rest(
      ...
      mode =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.RestfulCapabilityMode.fromCode(
    ...
    public fun fromModel(model: CapabilityStatement.Rest): CapabilityStatementRestSurrogate =
      with(model) {
        CapabilityStatementRestSurrogate(
          ...
          resource = this@with.resource.takeUnless { it.isEmpty() },
          interaction = this@with.interaction.takeUnless { it.isEmpty() },
          searchParam = this@with.searchParam.takeUnless { it.isEmpty() },
          operation = this@with.operation.takeUnless { it.isEmpty() },
          compartment =
            this@with.compartment.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _compartment =
...
internal data class CapabilityStatementMessagingEndpointSurrogate(
  ...
  public var address: KotlinString?,
...
internal data class CapabilityStatementMessagingSupportedMessageSurrogate(
  ...
  public fun toModel(): CapabilityStatement.Messaging.SupportedMessage =
    CapabilityStatement.Messaging.SupportedMessage(
      ...
      mode =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.EventCapabilityMode.fromCode(
    ...
    public fun fromModel(
      ...
      with(model) {
        CapabilityStatementMessagingSurrogate(
          ...
          documentation = this@with.documentation?.value,
          _documentation = this@with.documentation?.toElement(),
          supportedMessage = this@with.supportedMessage.takeUnless { it.isEmpty() },
        )
      }
  }
}
...
internal data class CapabilityStatementDocumentSurrogate(
  ...
  public var documentation: KotlinString? = null,
  public var _documentation: Element? = null,
  public var profile: KotlinString?,
  public var _profile: Element? = null,
) {
  public fun toModel(): CapabilityStatement.Document =
    CapabilityStatement.Document(
      ...
      mode =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.DocumentMode.fromCode(
...
internal data class CapabilityStatementSurrogate(
  ...
  public var fhirVersion: KotlinString?,
  ...
  public fun toModel(): CapabilityStatement =
    CapabilityStatement(
      ...
      url =
        Uri.ofNullable(
          this@CapabilityStatementSurrogate.url,
          this@CapabilityStatementSurrogate._url,
        ),
      version =
        R4String.ofNullable(
      ...
      kind =
        Enumeration.of(
          com.google.fhir.model.r4.CapabilityStatement.CapabilityStatementKind.fromCode(
      ...
      fhirVersion =
        Enumeration.of(
          com.google.fhir.model.r4.FHIRVersion.fromCode(
    ...
    public fun fromModel(model: CapabilityStatement): CapabilityStatementSurrogate =
      with(model) {
        CapabilityStatementSurrogate(
          ...
          instantiates =
            this@with.instantiates.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _instantiates =
            this@with.instantiates
              ...
              ?.toMutableList(),
          imports =
            this@with.imports.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _imports =
            this@with.imports
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
          ...
          format = this@with.format.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _format =
            this@with.format
              .map { it.toElement() }
              .takeUnless { it.all { it == null } }
              ...
              ?.toMutableList(),
          patchFormat =
            this@with.patchFormat.map { it.value!! }.toMutableList().takeUnless { it.isEmpty() },
          _patchFormat =
          ...
          _implementationGuide =
            this@with.implementationGuide
              ...
              ?.map { it ?: Element() }
              ?.toMutableList(),
          rest = this@with.rest.takeUnless { it.isEmpty() },
          messaging = this@with.messaging.takeUnless { it.isEmpty() },
          document = this@with.document.takeUnless { it.isEmpty() },
        )
      }
  }
}
