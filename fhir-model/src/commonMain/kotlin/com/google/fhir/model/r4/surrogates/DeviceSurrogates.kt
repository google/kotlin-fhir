...
internal data class DeviceSurrogate(
  ...
  public fun toModel(): Device =
    Device(
      ...
      manufacturer =
        R4String.ofNullable(this@DeviceSurrogate.manufacturer, this@DeviceSurrogate._manufacturer),
      manufactureDate =
        DateTime.ofNullable(
      ...
      lotNumber =
        R4String.ofNullable(this@DeviceSurrogate.lotNumber, this@DeviceSurrogate._lotNumber),
      serialNumber =
        R4String.ofNullable(this@DeviceSurrogate.serialNumber, this@DeviceSurrogate._serialNumber),
      deviceName = this@DeviceSurrogate.deviceName ?: mutableListOf(),
      modelNumber =
        R4String.ofNullable(this@DeviceSurrogate.modelNumber, this@DeviceSurrogate._modelNumber),
      partNumber =
        R4String.ofNullable(this@DeviceSurrogate.partNumber, this@DeviceSurrogate._partNumber),
