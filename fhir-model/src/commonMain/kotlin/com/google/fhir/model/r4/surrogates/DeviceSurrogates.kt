...
internal data class DeviceDeviceNameSurrogate(
  ...
  public fun toModel(): Device.DeviceName =
    Device.DeviceName().apply {
      ...
      name = R4String.of(this@DeviceDeviceNameSurrogate.name, this@DeviceDeviceNameSurrogate._name)
      type =
        Enumeration.of(
          this@DeviceDeviceNameSurrogate.type?.let {
            com.google.fhir.model.r4.Device.DeviceNameType.fromCode(it)
          },
...
internal data class DeviceVersionSurrogate(
  ...
  public fun toModel(): Device.Version =
    Device.Version().apply {
      ...
      `value` = R4String.of(this@DeviceVersionSurrogate.`value`, this@DeviceVersionSurrogate._value)
    }
...
internal data class DeviceSurrogate(
  ...
  public fun toModel(): Device =
    Device().apply {
      ...
      modelNumber = R4String.of(this@DeviceSurrogate.modelNumber, this@DeviceSurrogate._modelNumber)
