...
@Serializable
internal class CitationRelatesToTargetSurrogate {
  ...
  public fun toModel(): Citation.RelatesTo.Target =
    ...
    ) ?: Citation.RelatesTo.Target.Null
...
internal data class CitationRelatesToSurrogate(
  ...
  public var target: Citation.RelatesTo.Target? = null,
) {
...
@Serializable
internal class CitationCitedArtifactRelatesToTargetSurrogate {
  public var targetUri: KotlinString? = null
  ...
  public fun toModel(): Citation.CitedArtifact.RelatesTo.Target =
    ...
    ) ?: Citation.CitedArtifact.RelatesTo.Target.Null
...
internal data class CitationCitedArtifactRelatesToSurrogate(
  ...
  public var relationshipType: CodeableConcept? = null,
  public var targetClassifier: List<CodeableConcept?>? = null,
  public var target: Citation.CitedArtifact.RelatesTo.Target? = null,
) {
