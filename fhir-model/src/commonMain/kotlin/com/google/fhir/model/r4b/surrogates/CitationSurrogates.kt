    ...
    public fun fromModel(model: Citation.RelatesTo): CitationRelatesToSurrogate =
      with(model) {
        CitationRelatesToSurrogate(
          ...
          targetClassifier = this@with.targetClassifier.takeUnless { it.isEmpty() },
    ...
    public fun fromModel(
      ...
      with(model) {
        CitationCitedArtifactContributorshipEntrySurrogate(
          ...
          identifier = this@with.identifier.takeUnless { it.isEmpty() },
          affiliationInfo = this@with.affiliationInfo.takeUnless { it.isEmpty() },
          address = this@with.address.takeUnless { it.isEmpty() },
...
internal data class CitationSurrogate(
  ...
  public fun toModel(): Citation =
    Citation(
      ...
      version =
        R4bString.ofNullable(this@CitationSurrogate.version, this@CitationSurrogate._version),
      name = R4bString.ofNullable(this@CitationSurrogate.name, this@CitationSurrogate._name),
      title = R4bString.ofNullable(this@CitationSurrogate.title, this@CitationSurrogate._title),
      status =
        Enumeration.of(
      ...
      publisher =
        R4bString.ofNullable(this@CitationSurrogate.publisher, this@CitationSurrogate._publisher),
