 ...
 */
internal fun Element.getValueSetUrl() = this.binding?.valueSet?.substringBeforeLast("|")
 ...
 * [com.google.fhir.codegen.ModelFileSpecGenerator] (e.g. `Patient`). For the surrogate class
 * generated by [com.google.fhir.codegen.SurrogateFileSpecGenerator] (e.g. `PatientSurrogate`), use
 * [getSurrogatePropertyNameTypeDefaultValueList].
 */
internal fun Element.getTypeName(className: ClassName): TypeName {
 ...
 */
internal fun Element.getContentReferenceType(packageName: String): TypeName? {
 ...
 * [com.google.fhir.codegen.SurrogateFileSpecGenerator] (e.g. `PatientSurrogate`). For the data
 * class generated by [com.google.fhir.codegen.ModelFileSpecGenerator] (e.g. `Patient`), use
 * [getTypeName].
 */
internal fun Element.getSurrogatePropertyNameTypeDefaultValueList(
 ...
 *
 * The surrogate class (see [com.google.fhir.codegen.SurrogateFileSpecGenerator])
 */
 ...
 */
internal fun Type.getTypeName(enclosingClassName: ClassName): ClassName {
  if (
    extension
...
internal fun Element.getDefaultValueInSurrogate(): String? {
